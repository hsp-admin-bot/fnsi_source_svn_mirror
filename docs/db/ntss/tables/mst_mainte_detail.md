...
- Source sheet: `mst_mainte_detail`
- Logical name: 日常・定期点検項目マスタ
- Physical name: `mst_mainte_detail`
- Prefix group: `master`
- User: `nkk5`
...
- Related table: [../tables/mst_mainte_detail_hst.md](../tables/mst_mainte_detail_hst.md)

## Related Config / Notes

- [../config/mst_mainte_detail.md](../config/mst_mainte_detail.md)
