...
- Logical name: 日常・定期点検項目グループマスタ
- Physical name: `mst_mainte_category`
- Prefix group: `master`
- User: `nkk5`
...
- Related table: [../tables/mst_mainte_category_hst.md](../tables/mst_mainte_category_hst.md)

## Related Config / Notes

- [../config/mst_mainte_category.md](../config/mst_mainte_category.md)
