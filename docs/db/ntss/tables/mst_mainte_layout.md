...
- Logical name: 日常・定期点検レイアウトマスタ
- Physical name: `mst_mainte_layout`
- Prefix group: `master`
- User: `nkk5`
...
- Related table: [../tables/mst_mainte_layout_hst.md](../tables/mst_mainte_layout_hst.md)

## Related Config / Notes

- [../config/mst_mainte_layout.md](../config/mst_mainte_layout.md)
...
|  | マシンタイプリスト | type_info | jsonb |  |  |  | @mst_mainte_layoutで参考<br>用途が日常点検用（layout_class カラムの値が '1'）のレコードでは不使用のためNULLとする |
