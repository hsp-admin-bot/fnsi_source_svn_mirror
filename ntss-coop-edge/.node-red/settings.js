 ...
 ******************************************************************************/
    ...
    nodesDir: '/home/ntss/.node-red/custom_nodes',
 ...
 ******************************************************************************/
    ...
    adminAuth: {
        ...
        users: [{
            username: "fnwsi",
            password: "$2b$12$XfXsxJGyEilqR7nCZ3q4OelwYDmMA18FFtBqNzKLm2yNmdPThEcZ.",
            permissions: "*"
        }]
    },
    ...
    /** up to node-red 3.0.2 20230203 piao **/
    //https: {
    //  key: require("fs").readFileSync('/home/ntss/.node-red/key.pem'),
    //  cert: require("fs").readFileSync('/home/ntss/.node-red/cert.pem')
    //},
