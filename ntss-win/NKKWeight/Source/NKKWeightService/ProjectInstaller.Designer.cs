namespace NKKWeightService
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.serviceInstaller.Description = "日機装株式会社製FNWSi 体重計サービス";
            this.serviceInstaller.DisplayName = "FNWSi 体重計サービス";
            this.serviceInstaller.ServiceName = "NKKWeightService";
