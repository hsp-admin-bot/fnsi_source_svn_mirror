...
namespace NKKWeightTool
{
    ...
    /// （NKSConverter.TaskbarAppIdentity と同一方針）
    /// </summary>
    internal static class TaskbarAppIdentity
    {
        internal const string TaskbarDisplayName = "体重計保守ツール";

        private const string ExplicitAppUserModelId = "NIKKISO.FNWSi.FNWSiScaleTool";
