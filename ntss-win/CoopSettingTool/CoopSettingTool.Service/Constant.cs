namespace CoopSettingTool.Service
{
    ...
    {
        public const string MANUAL = "Assets\\Help\\manual.pdf";
        public const string LOGIN_URL = "login";

        public const string GET_ALL_FACILITY = "mstInfo/mstFacility";

        public const string GET_NEWEST_MST_COOP_FACILITY_CTL_NO = "linkage_definition/coopFacility/newestCtlNo";
        public const string GET_MST_COOP_FACILITY = "linkage_definition/coopFacility";
