...
namespace FNSiViewSyncService
{
    ...
    /// </summary>
    public partial class FNSiViewSyncService : ServiceBase
    {
        /// <summary>
        /// サービス名称
        /// </summary>
        ...
        /// <summary>
        /// FNSiViewSyncLogicクラスオブジェクト
        /// </summary>
        private FNSiViewSyncLogic m_fvsl = null;

        public FNSiViewSyncService()
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            ...
            {
                // 各オブジェクト構築
                this.m_fvsl = new FNSiViewSyncLogic(AppDomain.CurrentDomain.BaseDirectory);
