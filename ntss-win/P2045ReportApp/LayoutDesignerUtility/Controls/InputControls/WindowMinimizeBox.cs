...
namespace LayoutDesignerUtilityLib.Controls
{
    ...
    /// 最小化ボタンクラス
    /// </summary>
    public class WindowMinimizeBox : NoFocusButton
    {
        #region メンバ定数定義

        private const String FONT_NAME = "segoe mdl2 assets";
        private const String CHROME_MINIMIZE = "E921";
        ...
        /// <summary>
        /// 最小化ボタンクラスの新しいインスタンスを初期化します。
        /// </summary>
        public WindowMinimizeBox()
        {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            Int32 wHexCharCode = Convert.ToInt32(CHROME_MINIMIZE, 16);  // 16進数文字列 -> 数値
