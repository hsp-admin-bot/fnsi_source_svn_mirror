...
namespace CoopEventCreateOrStopTool
{
    ...
    public partial class ProjectInstaller : System.Configuration.Install.Installer
    {
        ...
        private const String installerTitle = "CoopEventCreateTool";
        private const String paramenterTitle = "CoopEventCreateTooler";
        ...
        protected override void OnAfterInstall(IDictionary savedState)
        {
            ...
            ModifyInstallParameter configModifyDlg = new ModifyInstallParameter(paths);
            configModifyDlg.ShowDialog();
            // add 2022-10-31 bug #5536 インストーラの設定画面を全面にもってくる 孫 start
            try
            {
