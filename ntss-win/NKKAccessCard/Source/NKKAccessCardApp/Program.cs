    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            try
            {
                ...
                // NKKAccessCard構築
                NKKAccessCard nkkAccessCard = new NKKAccessCard(AppDomain.CurrentDomain.BaseDirectory);
                ...
                // 初期化処理
                if (nkkAccessCard.Init() == true)
                {
                    // 初期化成功

                    // 処理開始処理
                    if (nkkAccessCard.Start() == true)
                    {
                        // 初期化失敗
                        ...
                        Application.Run(new FormViewLog(nkkAccessCard.GetGUISocketPortNo()));
