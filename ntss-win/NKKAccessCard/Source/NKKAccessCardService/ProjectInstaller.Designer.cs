    ...
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
           ...
           // this.serviceProcessInstaller.AfterInstall += new System.Configuration.Install.InstallEventHandler(this.serviceProcessInstaller_AfterInstall);
            ...
            this.serviceInstaller.Description = "日機装株式会社製FNWSi カードサービス";
            this.serviceInstaller.DisplayName = "FNWSi カードサービス";
            this.serviceInstaller.ServiceName = "NKKAccessCardService";
