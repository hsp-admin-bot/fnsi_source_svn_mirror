...
<html>
	...
	<tr>
		<td>
			<div class="center"><h1>患者選択</h1></div>
		</td>
	</tr>
	<tr>
		<td>
			<form name="form1">
				<table class="border tbl-center paitient-list">
					<tr>
						<th><font>選択</font></th>
						<th><font>患者ID</font></th>
						<th><font>患者名</font></th>
						<th><font>フリガナ</font></th>
						<th><font>性別</font></th>
						<th><font>血液型</font></th>
						<th><font>年齢</font></th>
					</tr>
...
%>
					<tr>
						<td colspan="7" class="center">該当する患者がいません</td>
					</tr>
					<tr>
						<td colspan="7"><hr></td>
					</tr>
<%
	...
	%>
							...
							<td class="center"><input type="radio" name="pat_id" value="<%=strValue%>"></td>
