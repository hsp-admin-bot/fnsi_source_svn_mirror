...
namespace FNSiCSIService
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            //del 2021 - 08 - 12 .net framework3.5不支持 郑 start
             // this.serviceInstaller.DelayedAutoStart = true;
            //del 2021 - 08 - 12 .net framework3.5不支持 郑 end

            this.serviceInstaller.Description = "日機装株式会社製CSI連携サービス";
            this.serviceInstaller.DisplayName = "CSI連携サービス";
            this.serviceInstaller.ServiceName = "FNSiCSIService";
