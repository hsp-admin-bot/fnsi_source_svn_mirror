package jp.co.nikkiso.ntss.certificate_management.aspect;
...
public class LogAspector {
  ...
  @Pointcut(value = "execution (* jp.co.nikkiso.ntss.certificate_management.service..*.*(..))")
  ...
  public void doBeforeService(JoinPoint joinPoint) {
    try {
      ...
      logService.log(LogLevel.ERROR, eventLogMessage, "", "CERTIFICATE_MANAGEMENT", null);
    }
  }
  ...
  private void outputLog(String className, String methodName, JoinPoint joinPoint, OUTPUT_KBN outputKbn, String errMessage) {
    ...
    logService.log(level, eventLogMessage, "", "CERTIFICATE_MANAGEMENT", null);
  }
