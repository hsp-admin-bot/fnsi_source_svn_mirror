...
public class LogMessage {
  ...
  public static final String ERROR_INSERT_MNT_FIND_MACHINE = "見つかった新規装置の保存に失敗しました。";
  public static final String WARN_INSERT_MNT_FIND_MACHINE = "見つかった新規装置が正常に記録できませんでした。";
}
