...
@RestController
@RequestMapping("/api/comsv_checklist/mst")

public class ComsvMstCheckListResource {
   ...
   */
  @Autowired
  private ComsvMasterService comsvMstCheckListService;
  ...
  public ResponseEntity<?> getComsvMstCheckList(
    ...
    if (!Objects.equals(facility_cd, "")) {
      List<ComsvMstCheckList> res = comsvMstCheckListService.fetchCheckList(facility_cd);
