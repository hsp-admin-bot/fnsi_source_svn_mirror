package jp.co.nikkiso.ntss.device_edge.dao.value;

public class MntMotionRecordStaticValues {

  // インスタンス生成阻止
  private MntMotionRecordStaticValues() {
  };
