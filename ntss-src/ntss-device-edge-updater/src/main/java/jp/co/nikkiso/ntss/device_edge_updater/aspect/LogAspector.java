package jp.co.nikkiso.ntss.device_edge_updater.aspect;
...
@Aspect
@Component("LogAspectorDeviceEdgeUpdater")
...
// #9698 アプリケーションログの内容修正 20260328 add yangxuewang start
  @Pointcut(value = "within(@org.springframework.web.bind.annotation.RestController *) && within(jp.co.nikkiso.ntss.device_edge_updater.web.rest..*)")
  ...
  private void saveLog(ProceedingJoinPoint joinPoint, Object result, long costTime, Exception exception) {
    EventLogMessage eventLogMessage = aspectorLogEventLogMessage(joinPoint,result,costTime,exception,"ntss-device-edge-updater");
    LogLevel level;
    if(exception!=null){
...
// #9698 アプリケーションログの内容修正 20260328 add yangxuewang end
  @Pointcut(value = "execution (* jp.co.nikkiso.ntss.device_edge_updater.service..*.*(..))")
...
// #9698 アプリケーションログの内容修正 20260327 add yangxuewang start
  ...
  public Object cutDaoPoint(ProceedingJoinPoint pjp) throws Throwable {
    ...
    try {
      ...
      map.put("LogAspectorDeviceEdgeUpdater","SQL-LOG");
