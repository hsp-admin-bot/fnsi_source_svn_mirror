...
public class AsyncConfiguration {
    ...
    public Executor doSomethingExecutor() {
        ...
        executor.setThreadNamePrefix("do-notification-");// modify zhangrx 20230330 : something --> notification
        // バッファキューが一杯になった場合の拒否ポリシー：呼び出し側のスレッド（通常はメインスレッド）で処理される
        executor.setRejectedExecutionHandler(new ThreadPoolExecutor.CallerRunsPolicy());// modify zhangrx 20230330 : DiscardPolicy --> CallerRunsPolicy
        executor.initialize();
        return executor;
    }
}
