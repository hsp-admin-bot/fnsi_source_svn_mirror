...
@Aspect
@Component("LogAspectorDataGathering")
...
// #9698 アプリケーションログの内容修正 20260328 add yangxuewang start
  @Pointcut(value = "within(@org.springframework.web.bind.annotation.RestController *) && within(jp.co.nikkiso.ntss.data_gathering.resource..*)")
  ...
  private void saveLog(ProceedingJoinPoint joinPoint, Object result, long costTime, Exception exception) {
    EventLogMessage eventLogMessage = aspectorLogEventLogMessage(joinPoint,result,costTime,exception,"ntss-data-gathering");
    LogLevel level;
    if(exception!=null){
...
// #9698 アプリケーションログの内容修正 20260328 add yangxuewang end
  ...
  @Pointcut(value = "execution (* jp.co.nikkiso.ntss.data_gathering.service..*.*(..))")
...
// #9698 アプリケーションログの内容修正 20260327 add yangxuewang start
  ...
  public Object cutDaoPoint(ProceedingJoinPoint pjp) throws Throwable {
    ...
    try {
      ...
      map.put("LogAspectorDataGathering","SQL-LOG");
