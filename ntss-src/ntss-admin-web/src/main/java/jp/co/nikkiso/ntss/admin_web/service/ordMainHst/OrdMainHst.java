...
//  private String rstVitalInfo;
   ...
   * BVMSファイルのパス
   */
  @DynamoDBAttribute(attributeName="bvms_path")
  @Field("bvms_path")
   ...
   * 最新版確定日時
   */
  @DynamoDBAttribute(attributeName="cur_edition_date")
   ...
   * 装置モード
   */
  @DynamoDBAttribute(attributeName="ind_device_mode")
   ...
   * DW指示者情报
   */
  @DynamoDBAttribute(attributeName="ind_dw_user_info")
   ...
   * 実績：装置モード
   */
  @DynamoDBAttribute(attributeName="rst_device_mode")
   ...
   * 初版確定日時
   */
  @DynamoDBAttribute(attributeName="rst_edition_date")
   ...
   * 最終更新指示者ID
   */
  @DynamoDBAttribute(attributeName="up_ind_user_id")
   ...
   * 最終更新者ID
   */
  @DynamoDBAttribute(attributeName="up_user_id")
  @Field("up_user_id")
