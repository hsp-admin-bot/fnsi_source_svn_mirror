...
@Component
public class HDordMainTreatment implements OrdMainTreatmentStrategy, InitializingBean {
  @Autowired
  ...
  public void update(Integer treatmentCd, OrdMainOnly ord, List<Long> ordNoList,
    ...
    ordMainDao.updateByTreatmentCdOnlyForHD( treatmentCd,ord,ordNoList,indUserId,userId);
  }
