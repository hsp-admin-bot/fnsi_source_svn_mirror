...
@Component
public class OHFordMainTreatment implements OrdMainTreatmentStrategy, InitializingBean {
  @Autowired
  ...
  public void update(Integer treatmentCd, OrdMainOnly ord, List<Long> ordNoList,
    ...
    ordMainDao.updateByTreatmentCdOnlyForOHF(treatmentCd,ord,ordNoList,indUserId,userId);
  }
