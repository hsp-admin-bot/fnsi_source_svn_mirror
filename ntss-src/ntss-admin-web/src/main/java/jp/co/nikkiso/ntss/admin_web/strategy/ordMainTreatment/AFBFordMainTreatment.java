...
@Component
public class AFBFordMainTreatment implements OrdMainTreatmentStrategy, InitializingBean {
  @Autowired
...
//      jsonNodes.set(IND_COND_INFO_19, root);
      ...
      ordMainDao.updateByTreatmentCdOnlyForAFBF(treatmentCd,ord,ordNoList,indUserId,userId);
    }catch (Exception e) {
