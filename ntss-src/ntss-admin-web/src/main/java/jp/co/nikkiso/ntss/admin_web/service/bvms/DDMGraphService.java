...
@Service
public class DDMGraphService extends AbstractBVMSService<BVMSFilterDTO, DDMGraphDTO> {
  ...
  // #9700 イベントログに出るべきではないもの、判読不可能なログがある 20260402 add yangxuewang end
    ...
    @Override
    public DDMGraphDTO getGraph(Long ordNo, BVMSFilterDTO inputDTO) throws NotExistException {
    ...
    @Override
    public DDMGraphDTO getGraphByUploadFile(Long ordNo, MultipartFile file, BVMSFilterDTO filter) {
...
//      e.printStackTrace();
    ...
    private DDMGraphDTO getGraph(Long ordNo, BVMSGraphDTO rawDataDTO, BVMSFilterDTO filter) {
        DDMGraphDTO graph = new DDMGraphDTO();
        ...
        DDMGraphDTO filterDDMGrapDTO = apdapterService.adaptDDMGrapDTO(rawDataDTO, filter);
        return filterDDMGrapDTO;
    }
