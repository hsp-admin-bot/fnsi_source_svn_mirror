package jp.co.nikkiso.ntss.admin_web.service.journal;
...
public class JournalCreatePayloadServiceImpl implements JournalCreatePayloadService {
  ...
  public List<JournalCreateRequestPayload> createJournalPayload(String facilityCd,
    ...
    eventLogMessage.setLogMessage("createJournalPayload:start");
    logService.log(LogLevel.DEBUG, eventLogMessage, "", SERVICE_NAME.FNSI, null);

    eventLogMessage.setLogMessage("createJournalPayload:actionMode:"+actionMode);
    logService.log(LogLevel.DEBUG, eventLogMessage, "", SERVICE_NAME.FNSI, null);
    ...
    if(resultAllChangedDataInfoList != null){
      ...
      Set<String> tablesToProcess = new HashSet<>(Arrays.asList(
        "ord_main", "pat_exam_main", "pat_rad_main", "ord_prescription"
        ...
        for (Object value : values) {
          ...
          switch (tablePhysicalName){
            case "ord_main":
              ...
              String opeCd = OPECDENUM.getOpeIdByCrudTablenameOption(tablePhysicalName, crud, action);
              ...
              eventLogMessage.setLogMessage("createJournalPayload:opeCd:"+opeCd);
              logService.log(LogLevel.DEBUG, eventLogMessage, "", SERVICE_NAME.FNSI, null);
            ...
            case "ord_prescription":
              ...
              journalCreateRequestPayload.setUserId(updId);
              journalCreateRequestPayload.setOpeCd(JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption(tablePhysicalName, crud, option));
            ...
            case "ord_main":
              ...
              if (keyList == null || !keyList.contains(ordMain.getOrdNo())) {
                ...
                journalCreateRequestPayload = this.makeJournalCreateRequestPayload(ordMain.getFacilityCd(), crud, patId, hospPatId, updId,
                  JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption(tablePhysicalName, crud, action),
        ...
        if(patExamMainList != null && !patExamMainList.isEmpty()){
          for(PatExamMain patExamMain : patExamMainList){
            ...
            JournalCreateRequestPayload journalCreateRequestPayload = this.makeJournalCreateRequestPayload(journalEventLinkByPat.getFacilityCd(), "D", journalEventLinkByPat.getPatId(), journalEventLinkByPat.getHospPatId(), updId,
              JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption("pat_exam_main", "D",  option + "_D"),
              patExamMain.getExamMainCd(), sdf.format(patExamMain.getRegExamDate()));
        ...
        if(patExamMainListCOrD != null && !patExamMainListCOrD.isEmpty()){
          for(PatExamMain patExamMain : patExamMainListCOrD){
            ...
            JournalCreateRequestPayload journalCreateRequestPayload = this.makeJournalCreateRequestPayload(journalEventLinkByPat.getFacilityCd(), "U", journalEventLinkByPat.getPatId(), journalEventLinkByPat.getHospPatId(), updId,
              JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption("pat_exam_main", "U",  option + "_U"),
              patExamMain.getExamMainCd(), sdf.format(patExamMain.getRegExamDate()));
            journalCreateRequestPayloadList.add(journalCreateRequestPayload);
          }
        }
...
//        patRadMainList = patRadMainDao.selectPatRadMainByDateListAndExcludeKeyList(journalEventLinkByPat.getFacilityCd(),journalEventLinkByPat.getPatId(), toBeDEventTreatDateList, journalEventLinkByPat.getToBeCEventExcludeRadKeyList());
        ...
        if(patRadMainList != null && !patRadMainList.isEmpty()){
          for(PatRadMain patRadMain : patRadMainList){
            option = actionMode + "_LINKED";
            JournalCreateRequestPayload journalCreateRequestPayload = this.makeJournalCreateRequestPayload(journalEventLinkByPat.getFacilityCd(), "D", journalEventLinkByPat.getPatId(), journalEventLinkByPat.getHospPatId(), updId,
              JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption("pat_rad_main", "D", option + "_D"),
              patRadMain.getRadResultCd(), sdf.format(patRadMain.getRegRadDate()));
            journalCreateRequestPayloadList.add(journalCreateRequestPayload);
          }
        }
        ...
        if(patRadMainListCOrU != null && !patRadMainListCOrU.isEmpty()){
          for(PatRadMain patRadMain : patRadMainListCOrU){
            option = actionMode + "_LINKED";
            JournalCreateRequestPayload journalCreateRequestPayload = this.makeJournalCreateRequestPayload(journalEventLinkByPat.getFacilityCd(), "U", journalEventLinkByPat.getPatId(), journalEventLinkByPat.getHospPatId(), updId,
              JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption("pat_rad_main", "U", option + "_U"),
              patRadMain.getRadResultCd(), sdf.format(patRadMain.getRegRadDate()));
            journalCreateRequestPayloadList.add(journalCreateRequestPayload);
          }
        }
      ...
      if(toBeCEventTreatDateList !=null && !toBeCEventTreatDateList.isEmpty()){
        ...
        if(patExamMainList != null && !patExamMainList.isEmpty()){
          for(PatExamMain patExamMain : patExamMainList){
            ...
            JournalCreateRequestPayload journalCreateRequestPayload = this.makeJournalCreateRequestPayload(journalEventLinkByPat.getFacilityCd(), "C", journalEventLinkByPat.getPatId(), journalEventLinkByPat.getHospPatId(), updId,
              JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption("pat_exam_main", "C", option + "_C"),
              patExamMain.getExamMainCd(), sdf.format(patExamMain.getRegExamDate()));
            journalCreateRequestPayloadList.add(journalCreateRequestPayload);
          }
        }
        ...
        if(patRadMainList != null && !patRadMainList.isEmpty()){
          for(PatRadMain patRadMain : patRadMainList){
            option = actionMode + "_LINKED";
            JournalCreateRequestPayload journalCreateRequestPayload = this.makeJournalCreateRequestPayload(journalEventLinkByPat.getFacilityCd(), "C", journalEventLinkByPat.getPatId(), journalEventLinkByPat.getHospPatId(), updId,
              JournalCreatePayloadServiceImpl.OPECDENUM.getOpeIdByCrudTablenameOption("pat_rad_main", "C", option + "_C"),
              patRadMain.getRadResultCd(), sdf.format(patRadMain.getRegRadDate()));
            journalCreateRequestPayloadList.add(journalCreateRequestPayload);
          }
        }
...
//      }
    ...
    EventLogMessage eventLogMessage = new EventLogMessage();
    eventLogMessage.setLogMessage("createJournalPayload:ret:"+ret);
    logService.log(LogLevel.DEBUG, eventLogMessage, "", SERVICE_NAME.FNSI, null);
    return ret;
  }
  ...
  public  boolean chenckIndCondInfoChange(String key, JSONObject beforeIndCondInfo, JSONObject afterIndCondInfo) {
  ...
  public enum OPECDENUM {
    ...
    IND_DIAL_004203_ORD_MAIN_U( "004203", "ord_main","U", "PAT_VIEWER_TREATMENT_KURNONE"), // 患者経過総合ビューア・治療方法編集・クール未設定
    ...
    IND_DIAL_004210_ORD_MAIN_U_1( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY1_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_2( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY2_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_3( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY3_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_4( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY4_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_5( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY5_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_6( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY6_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_7( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY7_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_8( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY8_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_9( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY9_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_10( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY10_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_11( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY11_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_12( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY12_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_13( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY13_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_14( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY14_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_15( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY15_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_16( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY16_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_17( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY17_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_18( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY18_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_19( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY19_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_20( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY20_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_21( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY21_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_22( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY22_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_23( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY23_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_24( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY24_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_25( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY25_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_26( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY26_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_27( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY27_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_28( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY28_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_29( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY29_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_30( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY30_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_31( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY31_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_32( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY32_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_33( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY33_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_34( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY34_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_35( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY35_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_36( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY36_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_37( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY37_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    IND_DIAL_004210_ORD_MAIN_U_38( "004210", "ord_main","U", "PAT_VIEWER_TREAT_ALL_COND_KEY38_KURNONE"), // 患者経過総合ビューア・治療条件・クール未登録
    // 患者経過総合ビューア・治療条件・治療時間編集
    IND_DIAL_004011_ORD_MAIN_U( "004011", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY1"), // 患者経過総合ビューア・治療時間編集・クール未登録以外
    IND_DIAL_004211_ORD_MAIN_U( "004211", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY1_KURNONE"), // 患者経過総合ビューア・治療時間編集・クール未登録

    // 患者経過総合ビューア・治療条件・VA編集
    IND_DIAL_004012_ORD_MAIN_U( "004012", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY2"), // 患者経過総合ビューア・VA編集・クール未登録以外
    IND_DIAL_004212_ORD_MAIN_U( "004212", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY2_KURNONE"), // 患者経過総合ビューア・VA編集・クール未登録

    // 患者経過総合ビューア・治療条件・身体情報
    IND_DIAL_004013_ORD_MAIN_U( "004013", "ord_main","U", "PAT_VIEWER_TREAT_CONDITION_DW"), // 患者経過総合ビューア・身体情報・クール未登録以外
    IND_DIAL_004213_ORD_MAIN_U( "004213", "ord_main","U", "PAT_VIEWER_TREAT_CONDITION_DW_KURNONE"), // 患者経過総合ビューア・身体情報・クール未登録
    ...
    IND_DIAL_004214_ORD_MAIN_U_3( "004214", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY3_KURNONE"), // 患者経過総合ビューア・目標体重・クール未登録
    IND_DIAL_004214_ORD_MAIN_U_4( "004214", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY4_KURNONE"), // 患者経過総合ビューア・除水量制限・クール未登録
    IND_DIAL_004213_ORD_MAIN_U_DW( "004213", "ord_main","U", "PAT_VIEWER_TREAT_COND_DW_KURNONE"), // 患者経過総合ビューア・DW・クール未登録
    ...
    IND_DIAL_004215_ORD_MAIN_U_5( "004215", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY5_KURNONE"), // 患者経過総合ビューア・ダイアライザ・クール未登録
    IND_DIAL_004215_ORD_MAIN_U_6( "004215", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY6_KURNONE"), // 患者経過総合ビューア・吸着カラム・クール未登録
    ...
    IND_DIAL_004216_ORD_MAIN_U_7( "004216", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY7_KURNONE"), // 患者経過総合ビューア・1次膜・クール未登録
    IND_DIAL_004216_ORD_MAIN_U_8( "004216", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY8_KURNONE"), // 患者経過総合ビューア・2次膜・クール未登録
    ...
    IND_DIAL_004217_ORD_MAIN_U_9( "004217", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY9_KURNONE"), // 患者経過総合ビューア・穿刺針(A針)・クール未登録
    IND_DIAL_004217_ORD_MAIN_U_10( "004217", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY10_KURNONE"), // 患者経過総合ビューア・穿刺針(V針)・クール未登録
    IND_DIAL_004217_ORD_MAIN_U_11( "004217", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY11_KURNONE"), // 患者経過総合ビューア・穿刺針(SN)・クール未登録
    IND_DIAL_004217_ORD_MAIN_U_12( "004217", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY12_KURNONE"), // 患者経過総合ビューア・シングルニードル使用・クール未登録
    ...
    IND_DIAL_004218_ORD_MAIN_U( "004218", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY13_KURNONE"), // 患者経過総合ビューア・血液回路編集・クール未登録

    // 患者経過総合ビューア・治療条件・血流量編集
    IND_DIAL_004019_ORD_MAIN_U( "004019", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY14"), // 患者経過総合ビューア・血流量編集・クール未登録以外
    IND_DIAL_004219_ORD_MAIN_U( "004219", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY14_KURNONE"), // 患者経過総合ビューア・血流量編集・クール未登録
    ...
    IND_DIAL_004220_ORD_MAIN_U_15( "004220", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY15_KURNONE"), // 患者経過総合ビューア・透析液・クール未登録
    IND_DIAL_004220_ORD_MAIN_U_16( "004220", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY16_KURNONE"), // 患者経過総合ビューア・透析液流量・クール未登録
    IND_DIAL_004220_ORD_MAIN_U_17( "004220", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY17_KURNONE"), // 患者経過総合ビューア・透析液量・クール未登録
    IND_DIAL_004220_ORD_MAIN_U_18( "004220", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY18_KURNONE"), // 患者経過総合ビューア・透析液温度・クール未登録
    ...
    IND_DIAL_004221_ORD_MAIN_U_19( "004221", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY19_KURNONE"), // 患者経過総合ビューア・補液・クール未登録
    IND_DIAL_004221_ORD_MAIN_U_20( "004221", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY20_KURNONE"), // 患者経過総合ビューア・補液量・クール未登録
    IND_DIAL_004221_ORD_MAIN_U_21( "004221", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY21_KURNONE"), // 患者経過総合ビューア・補液選択・クール未登録
    IND_DIAL_004221_ORD_MAIN_U_22( "004221", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY22_KURNONE"), // 患者経過総合ビューア・補液使用数・クール未登録
    IND_DIAL_004221_ORD_MAIN_U_23( "004221", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY23_KURNONE"), // 患者経過総合ビューア・補液温度・クール未登録
    IND_DIAL_004221_ORD_MAIN_U_24( "004221", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY24_KURNONE"), // 患者経過総合ビューア・補液速度・クール未登録
    ...
    IND_DIAL_004022_ORD_MAIN_U_34( "004022", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY34"), // 患者経過総合ビューア・IPワンショットスタート・クール未登録以外
    ...
    IND_DIAL_004222_ORD_MAIN_U_25( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY25_KURNONE"), // 患者経過総合ビューア・抗凝固剤・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_26( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY26_KURNONE"), // 患者経過総合ビューア・抗凝固剤ワンショット量・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_27( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY27_KURNONE"), // 患者経過総合ビューア・抗凝固剤持続速度・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_28( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY28_KURNONE"), // 患者経過総合ビューア・抗凝固剤持続総量・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_29( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY29_KURNONE"), // 患者経過総合ビューア・IP使用選択・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_30( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY30_KURNONE"), // 患者経過総合ビューア・IPスタート・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_31( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY31_KURNONE"), // 患者経過総合ビューア・IPワンショット量・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_32( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY32_KURNONE"), // 患者経過総合ビューア・IP速度・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_33( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY33_KURNONE"), // 患者経過総合ビューア・IP速度最大値・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_34( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY34_KURNONE"), // 患者経過総合ビューア・IPワンショットスタート・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_35( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY35_KURNONE"), // 患者経過総合ビューア・IP電源自動切り・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_36( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY36_KURNONE"), // 患者経過総合ビューア・IP電源自動切り時間・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_37( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY37_KURNONE"), // 患者経過総合ビューア・IP電源OKモニタ切り・クール未登録
    IND_DIAL_004222_ORD_MAIN_U_38( "004222", "ord_main","U", "PAT_VIEWER_TREAT_COND_KEY38_KURNONE"), // 患者経過総合ビューア・IP電源OKモニタ切り時間・クール未登録
    ...
    IND_DIAL_004113_ORD_MAIN_U( "004113", "ord_main","U", "PAT_VIEWER_MEDI_ADD_KURNONE"), // 患者経過総合ビューア・投与薬剤編集・クール未登録
    IND_DIAL_004114_ORD_MAIN_U( "004114", "ord_main","U", "PAT_VIEWER_MEDI_UPD_KURNONE"), // 患者経過総合ビューア・投与薬剤編集・クール未登録
    IND_DIAL_004115_ORD_MAIN_U( "004115", "ord_main","U", "PAT_VIEWER_MEDI_DEL_KURNONE"), // 患者経過総合ビューア・投与薬剤編集・クール未登録
    ...
    IND_DIAL_004226_ORD_MAIN_U( "004226", "ord_main","U", "PAT_VIEWER_EQUIP_ADD_KURNONE"), // 患者経過総合ビューア・医療材料編集・クール未登録
    IND_DIAL_004227_ORD_MAIN_U( "004227", "ord_main","U", "PAT_VIEWER_EQUIP_UPD_KURNONE"), // 患者経過総合ビューア・医療材料編集・クール未登録
    IND_DIAL_004228_ORD_MAIN_U( "004228", "ord_main","U", "PAT_VIEWER_EQUIP_DEL_KURNONE"), // 患者経過総合ビューア・医療材料編集・クール未登録
    ...
    IND_DIAL_004229_ORD_MAIN_U_ADD( "004229", "ord_main","U", "PAT_VIEWER_COMMENT_ADD_KURNONE"), // 患者経過総合ビューア・指示コメント・クール未登録
    IND_DIAL_004229_ORD_MAIN_U_UPD( "004229", "ord_main","U", "PAT_VIEWER_COMMENT_UPD_KURNONE"), // 患者経過総合ビューア・指示コメント・クール未登録
    IND_DIAL_004229_ORD_MAIN_U_DEL( "004229", "ord_main","U", "PAT_VIEWER_COMMENT_DEL_KURNONE"), // 患者経過総合ビューア・指示コメント・クール未登録
    ...
    PHY_ORD_031103_PAT_EXAM_MAIN_D("031103", "pat_exam_main", "D", "PHY_PAT_INFO"), // 死亡情報受信・患者の死亡に伴い送信済み未来日の予定の削除を送信
