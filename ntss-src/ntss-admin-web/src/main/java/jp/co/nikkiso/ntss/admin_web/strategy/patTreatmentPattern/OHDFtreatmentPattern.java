...
@Component
public class OHDFtreatmentPattern implements PatTreatmentPatternStategy, InitializingBean {
  @Autowired
  PatTreatmentPatternDao patTreatmentPatternDao;

  @Override
  public void update(OrdMainOnly ord, String facilityCd, Integer code) {
    patTreatmentPatternDao.updatePatTreatmentPatternByPatIdsOHDF(ord,facilityCd,code);
  }
