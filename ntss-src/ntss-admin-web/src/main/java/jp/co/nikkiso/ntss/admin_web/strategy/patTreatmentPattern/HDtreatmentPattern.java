...
@Component
public class HDtreatmentPattern implements PatTreatmentPatternStategy, InitializingBean {
  @Autowired
  PatTreatmentPatternDao patTreatmentPatternDao;

  @Override
  public void update(OrdMainOnly ord, String facilityCd, Integer code) {
    patTreatmentPatternDao.updatePatTreatmentPatternByPatIdsHD(ord,facilityCd,code);
  }
