...
@Component
public class HFtreatmentPattern implements PatTreatmentPatternStategy, InitializingBean {
  @Autowired
...
//      jsonNodes.set(IND_COND_INFO_19, root);
      ...
      patTreatmentPatternDao.updatePatTreatmentPatternByPatIdsHF(ord,facilityCd,code);
    } catch (Exception e) {
