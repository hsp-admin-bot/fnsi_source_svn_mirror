 ...
 */
@Data
public class RstMediInfoDto {

  /* modify by chamaojia 2024-01-31 [10196] Data type change --start */
  /**
   * 識別番号.
   */
  @JsonProperty("no")
  private Long no;
  /* modify by chamaojia 2024-01-31 [10196] Data type change --end */
  /**
   * 薬剤分類コード
   */
  ...
  /* modify by chamaojia 2024-01-31 [10196] The database has deleted the content --start */
//  /**
//   * 指示者コード(利用者マスタ.利用者ID)
//   */
...
//  private String updUserFirstName;
  /* modify by chamaojia 2024-01-31 [10196] The database has deleted the content --end */
  /**
   * 登録区分
   */
   ...
   * 投与実施者コード
   */
  @JsonProperty("effect_user_id")
  private Long effectUserId;
  /* modify by chamaojia 2024-01-31 [10196] The database has deleted the content --start */
//  /**
//   * 投与実施者更新日時
//   */
//  @JsonProperty("effect_user_up_date")
//  private Timestamp effectUserUpDate;
  /* modify by chamaojia 2024-01-31 [10196] The database has deleted the content --end */
  /* modify by chamaojia 2024-01-31 [10196] The content does not exist in the database --start */
  // #9733 チェックリスト画面で投与薬剤の実施変更に失敗する。Start
//  /**
//   * 投与実施フラグ, ※0：未実施、1：実施済み
//   */
//  @JsonProperty("reg_effect_flg")
//  // mod #7475 コンバートしたord_mainにデータが正常な形でコンバートされていない dou start
//  //private String regEffectFlg;
//  private Integer regEffectFlg;
//  // mod #7475 コンバートしたord_mainにデータが正常な形でコンバートされていない dou end
//  /**
//   * 投与実施日時, ※ISO8601形式
//   */
//  @JsonProperty("reg_effect_date")
//  private Timestamp regEffectDate;
//  /**
//   * 投与実施者コード
//   */
//  @JsonProperty("reg_effect_user_id")
//  private Long regEffectUserId;
//  /**
//   * 投与実施者更新日時
//   */
//  @JsonProperty("reg_effect_user_up_date")
//  private Timestamp regEffectUserUpDate;
  // #9733 チェックリスト画面で投与薬剤の実施変更に失敗する。End
  /* modify by chamaojia 2024-01-31 [10196] The content does not exist in the database --start */
  /**
   * 投与実施者名_姓
   */
  @JsonProperty("effect_user_last_name")
  private String effectUserLastName;
  /**
   * 投与実施者名_名
   */
  @JsonProperty("effect_user_first_name")
...
//  private Boolean isNew;
  // #9733 チェックリスト画面で投与薬剤の実施変更に失敗する。End
  /* modify by chamaojia 2024-01-31 [10196] The content does not exist in the database --end */
}
