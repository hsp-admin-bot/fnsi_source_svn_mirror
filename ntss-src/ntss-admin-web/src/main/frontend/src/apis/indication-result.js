 ...
 * @param {Record<string, unknown>} [condition] 検索条件（治療開始日と治療終了日）
 */
 ...
 * @param {Record<string, unknown>} condition 検索条件（患者ID、施設コード、治療開始日、治療終了日）
 */
...
/**
 * 検査セットIDで、チェック項目数取得
 * @param {string|number} condition 検査セットID（URL パス用）
 */
