 ...
 * 心電図モーダル画面用のモデルクラス
 */
export class ElectrocardiogramModal {
  constructor(treatment, isStart, defaultDate) {
    ...
    // 経過時間
    this.overTime = treatment ? treatment.overTime : null;
   ...
   */
  get isStart() {
    return this._isStart || (this.treatment && this.treatment.isElectrocardiogramStart) || false;
  }
