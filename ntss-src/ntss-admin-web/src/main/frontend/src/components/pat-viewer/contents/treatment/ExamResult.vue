...
<template>
  <div>
    <base-content :disp-data-list="examResultDataList" :is-chart-rst="true" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...mapActions("pat-viewer", ["convertExamResultInfo"]),
