...
export default {
  ...
  watch: {
    ...
    windowWidth() {
      this.syncCardListLayoutForSidebar();
    },
    isMenuBarShowing() {
      this.syncCardListLayoutForSidebar();
    }
  ...
  methods: {
    ...
    syncCardListLayoutForSidebar() {
      const style = this.cardListStyle;
      this.setCardListStyle({
        width: style.width,
    ...
    //   } else {
    //     this.direction = "left";
    //     document.getElementById("menu-btn").style.marginLeft = "-12px";
