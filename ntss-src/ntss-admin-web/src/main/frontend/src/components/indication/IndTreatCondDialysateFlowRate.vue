...
<template>
  ...
  <!-- <v-ons-row> -->
    <v-ons-row :class="getIsUseFlagDialysateFlowRate ? 'cell-disabled' : ''">
    <!-- mod 9664補液及び透析液仕様修正します yangqingzhe end -->
    <v-ons-col class="action-condition-column">透析液流量</v-ons-col>
    <v-ons-col class="action-condition-data-column">
      ...
      <!-- <custom-input-number
        ...
        :min-value="100"
        :max-value="700"
        :disabled="isDisabled || getIsUseFlagDialysateFlowRate"
        class="action-condition-input ntss-custom-input-cond"
        style="width: 50px"
        @change="changeButton()"
      /> -->
      ...
      <!--   style="width: 50px" -->
      <!-- /> -->
      <!-- mod #10897 透析液流量の数値IFが表示されない dengshen start -->
      ...
      <!-- <custom-input-number
        ...
        :min-value="100"
        :max-value="700"
        :disabled="isDisabled || getIsUseFlagDialysateFlowRate || !getItemAuthorized('Indication', 'default_authority')"
        class="action-condition-input ntss-custom-input-cond"
        style="width: 50px"
      /> -->
      ...
      <!-- mod #10897 透析液流量の数値IFが表示されない dengshen end -->
...
export default {
  ...
  computed: {
    ...mapGetters("pat-viewer-treat-cond", {
      ...
      // add 8204 周安寧 start
      getIsUseFlagDialysateFlowRate: "getIsUseFlagDialysateFlowRate"
      // add 8204 周安寧 end
    })
  },
 methods: {
