...
<template>
  ...
  <!-- <v-ons-row> -->
    <v-ons-row :class="getIsUseFlagIpMonitorOffTiming ? 'cell-disabled' : ''">
  <!-- mod 9664補液及び透析液仕様修正します yangqingzhe end -->
    ...
    <v-ons-col class="action-condition-data-column">
      ...
      <!--<custom-input-number
        ...
        :min-value="0.0"
        :max-value="120"
        :disabled="isAntiCoagulantDisabled || !isIpUse || !isIpMonitorOff"
      ...
      <!-- <custom-input-number
        ...
        :min-value="0.0"
        :max-value="120"
        :disabled="isAntiCoagulantDisabled || !isIpUse || !isIpMonitorOff || getIsUseFlagIpMonitorOffTiming"
        class="action-condition-input ntss-custom-input-cond"
        style="width: 50px"
        @change="changeButton()"
      /> -->
      ...
      <!-- <custom-input-number
        ...
        :disabled="isAntiCoagulantDisabled ||
         !isIpUse ||
         !isIpMonitorOff ||
         getIsUseFlagIpMonitorOffTiming ||
...
export default {
  ...
  computed: {
    ...mapGetters("pat-viewer-treat-cond", {
      ...
      isIpUse: "isIpUse",
      isIpMonitorOff: "isIpMonitorOff",
      // add 8204 周安寧 start
      getIsUseFlagIpMonitorOffTiming: "getIsUseFlagIpMonitorOffTiming"
      // add 8204 周安寧 end
    })
  },
