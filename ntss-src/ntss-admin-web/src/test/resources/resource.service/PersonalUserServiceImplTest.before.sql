...
VALUES
  (
    ...
    , '0001'
    , 0
    , personal_info_encrypt('last_name_1')
    , personal_info_encrypt('first_name_1')
  ...
  ,(
    ...
    , '0001'
    , 0
    , personal_info_encrypt('last_name_2')
    , personal_info_encrypt('first_name_2')
    , personal_info_encrypt('email_address1_2')
    , personal_info_encrypt('email_address2_2')
    , personal_info_encrypt('anything good')
    , '0'
  )
  ,(
    ...
    , '0001'
    , 0
    , personal_info_encrypt('last_name_3')
    , personal_info_encrypt('first_name_3')
