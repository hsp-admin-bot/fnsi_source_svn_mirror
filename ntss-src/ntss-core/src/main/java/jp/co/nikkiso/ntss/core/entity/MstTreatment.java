...
import jp.co.nikkiso.ntss.core.entity.entityListener.MstTreatmentEntityListener;
 ...
 * 治療方法セットマスタ情報クラス
 */
@Entity(listener = MstTreatmentEntityListener.class, naming = NamingType.SNAKE_LOWER_CASE)
