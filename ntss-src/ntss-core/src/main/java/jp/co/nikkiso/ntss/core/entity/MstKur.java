...
import jp.co.nikkiso.ntss.core.entity.entityListener.MstKurEntityListener;
 ...
 * クールクラス
 */
@Entity(listener = MstKurEntityListener.class, naming = NamingType.SNAKE_LOWER_CASE)
@Table(name = "mst_kur")
@Getter
@Setter
