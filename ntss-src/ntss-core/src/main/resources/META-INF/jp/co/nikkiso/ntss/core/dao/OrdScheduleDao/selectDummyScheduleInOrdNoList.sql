WITH RECURSIVE
  pat_data AS (
    SELECT DISTINCT
      ...
      COALESCE(/*indTreatStartTime*/'10:31'::time, null) as treat_start_time
    FROM ord_main
...
select ord_no as key_no, ind_treatment_cd, calendar_date as treat_date, kur_cd, pat_id, /*bedCd*/10 as bed_cd from recursive_pat_data order by calendar_date, kur_cd, treat_week
