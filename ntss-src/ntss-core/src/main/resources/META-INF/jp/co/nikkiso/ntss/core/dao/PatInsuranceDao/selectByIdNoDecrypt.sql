SELECT
  ...
  check_date,
  json_build_object(
    'insu_pat_name', (insu_info::json->>'insu_pat_name')::text,
		'insu_no', (insu_info::json->>'insu_no')::text,
		'insu_kbn', (insu_info::json->>'insu_kbn')::text,
		'insu_pat_mark', (insu_info::json->>'insu_pat_mark')::text,
		'insu_pat_no', (insu_info::json->>'insu_pat_no')::text,
  ...
  json_build_object(
    'insu_pub_name', (insu_pub_info::json->>'insu_pub_name')::text,
		'insu_pub_no', (insu_pub_info::json->>'insu_pub_no')::text,
		'insu_pub_pat_no', (insu_pub_info::json->>'insu_pub_pat_no')::text,
		'passbook_no', (insu_pub_info::json->>'passbook_no')::text
 	) as insu_pub_info,
  json_build_object(
