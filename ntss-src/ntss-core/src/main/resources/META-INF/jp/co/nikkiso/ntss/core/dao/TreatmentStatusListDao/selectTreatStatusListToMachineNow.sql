...
select
    ...
    D.kur_start_time as kur_start_time
from
    ord_main A
    inner join mnt_machine_state mms on
    (A.ord_no = mms.ord_no)
...
where
  ...
  and
-- modify by chamaojia 2024-10-24 [9312] determination of adding 【functionCode】 condition --start
/*%if functionCode == "1" */
    A.rst_dialysis_state in ('1', '2', '3', '4', '5')
/*%elseif functionCode == "2" */
    A.rst_dialysis_state in ('1', '2', '3')
/*%end */
-- modify by chamaojia 2024-10-24 [9312] determination of adding 【functionCode】 condition --end
