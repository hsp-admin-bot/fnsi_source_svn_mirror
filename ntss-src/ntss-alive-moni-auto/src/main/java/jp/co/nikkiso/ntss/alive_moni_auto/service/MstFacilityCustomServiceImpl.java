...
import jp.co.nikkiso.ntss.alive_moni_auto.dao.MstFacilityCustomDao;
...
public class MstFacilityCustomServiceImpl implements MstFacilityCustomService {
  ...
  public List<MstFacilityCustom> findAll() {
    ...
    try {
      ...
      logService.log(LogLevel.ERROR, eventLogMessage, null, SERVICE_NAME.REMS,"MstFacilityCustomDao/selectAll", true);
    }
