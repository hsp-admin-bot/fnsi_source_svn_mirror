...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h200','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h200','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="" len="0" col="pat_exam_main.exam_status" value="const:S"/>
<item name="" len="0" col="pat_exam_main.cop_order_no1" value="const:123123" />
<item name="" len="0" col="pat_exam_main.reg_exam_date" value="const:2020-01-31" />
<item name="" len="0" col="pat_exam_main.reg_order_class" value="const:T" />
<occ len="0" repeat="2">
<item name="" len="0" col="pat_exam_main.exam_result_info.disp_order" value="const:1" />
<item name="" len="0" col="pat_exam_main.exam_result_info.exam_item_cd" value="const:111" />
<item name="" len="0" col="pat_exam_main.exam_result_info.exam_result" value="const:8" />
<item name="" len="0" col="pat_exam_main.exam_result_info.exam_check" value="const:H" />
<item name="" len="0" col="pat_exam_main.exam_result_info.exam_comment" value="const:8888" />
<item name="" len="0" col="pat_exam_main.exam_result_info.exam_free_comment" value="const:異常なし" />
<item name="" len="0" col="pat_exam_main.exam_result_info.result_date" value="const:20200228" />
<item name="" len="0" col="pat_exam_main.exam_result_info.exam_item_name" value="const:血圧" />
<item name="" len="0" col="pat_exam_main.exam_result_info.data_type" value="const:XML" />
<item name="" len="0" col="pat_exam_main.exam_result_info.unit" value="const:mmHg" />
<item name="" len="0" col="pat_exam_main.exam_result_info.normal_value_upper" value="const:160" />
<item name="" len="0" col="pat_exam_main.exam_result_info.normal_value_lower" value="const:70" />
<item name="" len="0" col="pat_exam_main.exam_result_info.exam_class" value="const:5" />
</occ>
  ...
  <item name="伝票情報.入外区分" len="1" type="string"/>
  <item name="伝票情報.診療科コード" len="3" col="" type="string"/>
  <item name="伝票情報.診療科名称" len="32" type="string"/>
  <item name="伝票情報.病棟コード" len="3" col="" type="string"/>
  <item name="伝票情報.病棟名称" len="32" type="string"/>
  <item name="伝票情報.オーダ発行利用者番号" len="8" type="string"/>
  <item name="伝票情報.オーダ発行利用者名" len="20" type="string"/>
