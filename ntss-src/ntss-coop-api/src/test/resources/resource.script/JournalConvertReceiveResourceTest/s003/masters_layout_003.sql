...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h003','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h003','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="患者情報.患者番号" len="0" col="pat_personal_main.hosp_pat_id" type="string" value="const:1111111113"/>
<item len="0" col="pat_personal_main.is_del" value="const:1" />
