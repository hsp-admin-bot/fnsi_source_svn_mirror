DELETE FROM ntss.mst_coop_layout WHERE facility_cd = 'F_h700';
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h700','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h700','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
  ...
  <item name="エラーコード" len="5" type="string"/>
  <item name="予備" len="12" type="string"/>
  <item name="姓" len="0" type="string" value="const:　田中 " col="pat_personal_main.pat_last_name"/>
  <item name="名" len="0" type="string" value="const: 学 " col="pat_personal_main.pat_first_name"/>
  <item name="カナ姓" len="0" type="string" value="const:　タナカ " col="pat_personal_main.pat_last_name_kana"/>
  <item name="カナ名" len="0" type="string" value="const: マナブ " col="pat_personal_main.pat_first_name_kana"/>
  <item name="英字姓" len="0" type="string" value="const:　tanaka " col="pat_personal_main.pat_last_name_alpha"/>
  <item name="英字名" len="0" type="string" value="const: manabu " col="pat_personal_main.pat_first_name_alpha"/>
