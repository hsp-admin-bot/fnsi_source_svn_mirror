...
DELETE FROM ntss.mst_dialysis_difficulty
WHERE facility_cd = 'F_h700';
...
values ('F_h700',NULL,'おかむらいいん','VAB004',NULL,'1','0','2020/01/16 9:06:09','2020/01/16 9:06:09');

DELETE FROM ntss.mst_disease
WHERE facility_cd = 'F_h700';
...
is_del,
reg_date,
up_date) values ('F_h700',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'0009770089','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
facility_cd,
fn_disease_cd,
disease_name,
...
is_del,
reg_date,
up_date) values ('F_h700',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'0001100011','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
facility_cd,
fn_disease_cd,
disease_name,
...
is_del,
reg_date,
up_date) values ('F_h700',NULL,'モユモユ','モユ',NULL,NULL,NULL,NULL,NULL,'VB199999','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');

DELETE FROM ntss.mst_device_set_info_default
WHERE facility_cd = 'F_h700';

DELETE FROM ntss.mst_facility
WHERE facility_cd = 'F_h700';

INSERT INTO ntss.mst_facility VALUES ('F_h700','ジャーナル-テーブル登録テストデータ',NULL,'01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

INSERT INTO ntss.mst_device_set_info_default VALUES ('F_h700',
'{"device": "setting"}',
