...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h620','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h620','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="原疾患コード" len="0" type="string" value="const:0001100011" col="pat_personal_main.primary_disease_cd"/>
  ...
  <item name="保険組No" len="0" value="const:001" col="pat_insurance.INS_SET_NO"/>
  <item name="本人/家族" len="0" value="const:1" col="pat_insurance.PER_FAM_CLASS"/>
  <item name="続柄" len="0" value="const:本人" col="pat_insurance.RELATION"/>
  <item name="保険者番号" len="0" value="const:3" col="pat_insurance.INS_NO"/>
  <item name="被保険者証・記号" len="0" value="const:あいうえお" col="pat_insurance.INS_PAT_MARK"/>
  <item name="被保険者証・番号" len="0" value="const:１２３４５" col="pat_insurance.INS_PAT_NO"/>
  <item name="第1公費負担者番号" len="0" value="const:51000000" col="pat_insurance.INS_PUB_NO_1"/>
  <item name="第1公費受給者番号" len="0" value="const:12345678" col="pat_insurance.INS_PUB_PAT_NO_1"/>
  <item name="第2公費負担者番号" len="0" value="const:84000000" col="pat_insurance.INS_PUB_NO_2"/>
  <item name="第2公費受給者番号" len="0" value="const:12345678" col="pat_insurance.INS_PUB_PAT_NO_2"/>
  <item name="保険名称" len="0" value="const:自費" col="pat_insurance.INS_SET_NAME"/>
