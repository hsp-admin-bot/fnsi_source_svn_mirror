insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h601','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<occ len="0" repeat="5">
  ...
  <item name="INS_NO" col="pat_insurance.INS_NO" len="8" />
  <item name="KOHI_1" col="pat_insurance.KOHI_1" len="0" value="const:00000000" />
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h601','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
