...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB06','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB06','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="pat_uniqueテストデータ" len="0" col="pat_unique.medical_hst_info.disease_cd" value="const:1234" />

<item name="pat_uniqueテストデータ" len="0" col="pat_unique.physical_info.exam_date" value="const:2019-12-20" />

<item name="pat_uniqueテストデータ" len="0" col="pat_unique.is_del" value="const:1" />
