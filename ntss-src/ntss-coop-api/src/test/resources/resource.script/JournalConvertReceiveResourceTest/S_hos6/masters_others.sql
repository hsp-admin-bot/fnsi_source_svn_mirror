...
WHERE facility_cd = 'S_hos6';

DELETE FROM mst_facility
WHERE facility_cd = 'S_hos6';

INSERT INTO mst_facility VALUES ('S_hos6','ジャーナル-テーブル登録テストデータ',NULL,'01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

INSERT INTO mst_device_set_info_default VALUES ('S_hos6',
'{"device": "setting"}',
