...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB07','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB07','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="pat_insuranceテストデータ" len="0" col="pat_insurance.is_del" value="const:1" />
