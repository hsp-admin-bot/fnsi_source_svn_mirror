...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h610','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h610','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="ダミー:保険情報" len="0" type="string" value="const:24689" col="pat_insurance.insu_set_info.insu_cd" />
  ...
  <item name="保険コード01" len="0" value="const:ABCD" col="pat_insurance.INS_CD_01"/>
  <item name="保険コード02" len="0" value="const:0123" col="pat_insurance.INS_CD_02"/>
  <item name="保険コード03" len="0" value="const:PQRS" col="pat_insurance.INS_CD_03"/>
  <item name="保険コード04" len="0" value="const:9873" col="pat_insurance.INS_CD_04"/>
  <item name="保険コード05" len="0" value="const:MNOP" col="pat_insurance.INS_CD_05"/>
