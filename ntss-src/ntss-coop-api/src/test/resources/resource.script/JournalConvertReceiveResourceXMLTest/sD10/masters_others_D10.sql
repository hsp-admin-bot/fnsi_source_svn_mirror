...
values ('F_hD10',NULL,'おかむらいいん','VAB004',NULL,'1','0','2020/01/16 9:06:09','2020/01/16 9:06:09');
...
is_del,
reg_date,
up_date) values ('F_hD10',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'C2019','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
facility_cd,
fn_disease_cd,
disease_name,
...
is_del,
reg_date,
up_date) values ('F_hD10',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'0001100011','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
facility_cd,
fn_disease_cd,
disease_name,
...
is_del,
reg_date,
up_date) values ('F_hD10',NULL,'モユモユ','モユ',NULL,NULL,NULL,NULL,NULL,'1','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
facility_cd,
fn_disease_cd,
disease_name,
...
is_del,
reg_date,
up_date) values ('F_hD10',NULL,'糖尿病腎症','糖腎',NULL,NULL,NULL,NULL,NULL,'1991','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
...
INSERT INTO mst_facility VALUES ('F_hD10','ジャーナル-テーブル登録テストデータ',NULL,'01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

INSERT INTO mst_device_set_info_default VALUES ('F_hD10',
'{"device": "setting"}',
...
201, 'F_hD10', '本人', 1, 1, 0, '2020-04-08', '2020-04-08'
);
INSERT INTO mst_relationship (
relationship_cd
, facility_cd
...
205, 'F_hD10', '兄弟姉妹', 5, 1, 0, '2020-04-08', '2020-04-08'
);
...
2100, 'F_hD10', NULL, '急性気管支炎', NULL, 'C2019', 1, 0, '2020-04-09', '2020-04-09'
);
...
22800, 'F_hD10', 1180, '鶏卵', NULL, '872', NULL, 1, 0, '2020-04-09', '2020-04-09'
);
