...
values ('F_hC51',NULL,'おかむらいいん','VAB004',NULL,'1','0','2020/01/16 9:06:09','2020/01/16 9:06:09');
...
is_del,
reg_date,
up_date) values (30511,'F_hC51',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'0009770089','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
disease_cd,
facility_cd,
fn_disease_cd,
...
is_del,
reg_date,
up_date) values (30512,'F_hC51',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'0001100011','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
disease_cd,
facility_cd,
fn_disease_cd,
...
is_del,
reg_date,
up_date) values (30513,'F_hC51',NULL,'モユモユ','モユ',NULL,NULL,NULL,NULL,NULL,'VB199999','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
...
INSERT INTO mst_facility VALUES ('F_hC51','ジャーナル-テーブル登録テストデータ',NULL,'01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

INSERT INTO mst_device_set_info_default VALUES ('F_hC51',
'{"device": "setting"}',
...
13101, 'F_hC51', 1180, '桃', NULL, 1, NULL, 1, 0, '2020-04-09', '2020-04-09'
);
...
1311, 'F_hC51', NULL, '急性上気道炎', NULL, 112, 1, 0, '2020-04-09', '2020-04-09'
);
...
131001, 'F_hC51', '橈骨ボルト', NULL, 201, 1, 0, '2020-04-09', '2020-04-09'
);
