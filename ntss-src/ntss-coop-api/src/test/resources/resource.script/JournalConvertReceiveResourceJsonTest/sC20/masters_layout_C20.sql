...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC20','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC20','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="ダミーpat_main" len="0" col="pat_exam_main.cop_order_no1" value="const:10" />
<item name="ダミーpat_main" len="0" col="pat_exam_main.reg_exam_date" value="const:2020-04-10" />
<item name="ダミーpat_main" len="0" col="pat_exam_main.reg_order_class" value="const:1" />
<occ repeat="1">
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.disp_order" value="const:100" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_item_cd" value="const:11" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_result" value="const:120" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_check" value="const:N" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_comment" value="const:001" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_free_comment" value="const:正常" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_result_date" value="const:2020-04-10" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_item_name" value="const:最高血圧" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.data_type" value="const:01" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.unit" value="const:mmHg" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.normal_value_upper" value="const:140" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.normal_value_lower" value="const:80" />
  <item name="ダミーpat_main" len="0" col="pat_exam_main.exam_result_info.exam_class" value="const:111" />
</occ>
