...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC30','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC30','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="ダミーpat_main" len="0" col="pat_coop_detail.save_1.key_1" value="const:1" />
<occ repeat="1">
  <item name="ダミーpat_main" len="0" col="pat_coop_detail.save_2.key_1" value="const:2" />
</occ>
<occ repeat="2">
  <item name="ダミーpat_main" len="0" col="pat_coop_detail.save_3.key_2" value="const:3" />
</occ>
<occ repeat="3">
  <item name="ダミーpat_main" len="0" col="pat_coop_detail.save_8.key_2" value="const:8" />
</occ>
