...
, reg_date
, up_date
) VALUES (10000110,'XML011','ini_dial','R','ini_dial_meisai','int','富士通想定透析初回申込-申込詳細','For test','1','
...
, reg_date
, up_date
) VALUES (10000111,'XML011','ini_dial','R','ini_dial_meisai','ext','富士通想定透析初回申込-申込詳細','For test','1','
<MEDI_INFO CTL_NO="col:pat_coop_detail.save_4.ctl_no">
  <MEDICINE_CD>col:pat_coop_detail.save_4.medicine_cd</MEDICINE_CD>
  <MEDICINE_NAME>col:pat_coop_detail.save_4.medicine_name</MEDICINE_NAME>
  <MEDI_CLASS_NAME>col:pat_coop_detail.save_4.medi_class_name</MEDI_CLASS_NAME>
...
, reg_date
, up_date
) VALUES (10000112,'XML011','ini_dial','R','ini_dial_meisai','other','富士通想定透析初回申込-申込詳細','For test','1','
<!--コメント-->
<MEDI_INFO CTL_NO="col:pat_coop_detail.save_4.ctl_no">
  <MEDICINE_CD>col:pat_coop_detail.save_4.medicine_cd</MEDICINE_CD>
  <MEDICINE_NAME>col:pat_coop_detail.save_4.medicine_name</MEDICINE_NAME>
