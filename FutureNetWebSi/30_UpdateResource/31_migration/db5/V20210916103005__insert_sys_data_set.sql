UPDATE "sys_data_set" SET "memo" = '富士通の患者プロファイル' WHERE "sql_cd" > 1100 and "sql_cd" < 2100;
UPDATE "sys_data_set" SET "memo" = '富士通の検査結果' WHERE "sql_cd" > 2100 and "sql_cd" < 3100;
UPDATE "sys_data_set" SET "memo" = '富士通の初回申し込み' WHERE "sql_cd" > 3100 and "sql_cd" < 4100;
UPDATE "sys_data_set" SET "memo" = 'CSIの患者プロファイル' WHERE "sql_cd" > 4100 and "sql_cd" < 5100;
delete from "sys_data_set" where "sql_cd" >=5101 and "sql_cd"<=5302;
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (5101, 'SELECT
...
WHERE
    ...
    AND reg_order_class = @regOrderClass', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'CSIの検査結果', '2020-05-25 18:21:40.841', '2020-05-25 18:21:46.247', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (5102, 'INSERT INTO pat_exam_main (
...
VALUES
  ...
  )', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'CSIの検査結果', '2020-05-25 18:21:40.841', '2020-05-25 18:21:46.247', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (5103, 'UPDATE pat_exam_main 
...
WHERE
    ...
    AND exam_main_cd = @examMainCd', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'CSIの検査結果', '2020-05-25 18:21:40.841', '2020-05-25 18:21:46.247', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (5201, 'UPDATE pat_exam_main 
...
WHERE
  ...
  AND exam_main_cd = @examMainCd', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'CSIの検査結果', '2020-05-25 18:21:40.841', '2020-05-25 18:21:46.247', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (5301, 'UPDATE pat_exam_main 
...
WHERE
  ...
  AND exam_main_cd = @examMainCd', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'CSIの検査結果', '2020-05-25 18:21:40.841', '2020-05-25 18:21:46.247', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (5302, 'UPDATE pat_exam_main 
