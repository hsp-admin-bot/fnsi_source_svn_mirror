DELETE from sys_data_set where sql_cd = -495;
...
ORDER BY all_cost.e01 ', 2, '[{}]', '1', '{"applications": [4]}', NULL, '日機装)実績）薬剤繰り返し部(※このSQLを修正した場合、「-496」を修正してください。)', '2020-05-22 12:43:46', current_timestamp
, NULL);
