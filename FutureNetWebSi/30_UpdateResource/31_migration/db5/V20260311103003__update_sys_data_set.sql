...
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103017;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103014;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103013;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103008;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103007;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103006;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103005;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103004;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103003;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103001;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1100020;
DELETE FROM ntss.sys_data_set WHERE sql_cd=-1100010;
...
WHERE (1 = 1
    ...
    OR @dumpResult::TEXT = ''''
-- SQL: -1103017 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績(削除電文用)', current_timestamp, current_timestamp, '[{"sql_cd": -1103016, "field_name": "content_json", "replace_var": "@contentJson"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);
INSERT INTO ntss.sys_data_set (sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES(-1103014, '-- SQL: -1103014 begin
WITH RECURSIVE coop_ini_info AS (
--連携設定より取得
SELECT
...
@time AS time
-- SQL: -1103008 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_処置項目', current_timestamp, current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);
...
@folderName AS folder_name,
@time AS time
-- SQL: -1103007 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_処置単位', current_timestamp, current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);
...
@folderName AS folder_name,
@time AS time
-- SQL: -1103006 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_処置ヘッダー', current_timestamp, current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);
...
INSERT INTO ntss.sys_data_set (sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES(-1103003, '-- SQL: -1103003 begin
WITH RECURSIVE coop_ini_info AS (
--連携設定より取得
SELECT
  COALESCE(NULLIF(info ->> ''value'', ''''), info ->> ''default_v'') AS value,
...
-- SQL: -1103003 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_オーダーインデックス', current_timestamp, current_timestamp, '[{"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}, {"sql_cd": -1102004, "field_name": "pat_personal_info", "replace_var": "@patPersonalInfo"}]'::jsonb);
...
-- SQL: -1103001 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(送信用)セコムの透析実績連携', current_timestamp, current_timestamp, '[{"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}, {"sql_cd": -1102004, "field_name": "pat_personal_info", "replace_var": "@patPersonalInfo"}]'::jsonb);
INSERT INTO ntss.sys_data_set (sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES(-1100020, '-- SQL: -1100020 begin
WITH base AS (
  SELECT
    (@time::timestamptz) AS ts
)
SELECT
  TO_CHAR(ts, ''YYYY-MM-DD'') AS occurrence_date,
  TO_CHAR(ts, ''HH24:MI:SS'') AS seq_no
FROM base;', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'Secom連携_汎用 発生日/SEQ番号 フォーマット用', current_timestamp, current_timestamp, NULL);
INSERT INTO ntss.sys_data_set (sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES(-1100010, '-- SQL:-1100010
select
  CASE @crud
    when ''del'' then
  		CASE @dumpResult
...
@fileName AS file_name,
@folderName AS folder_name,
@time AS time', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(送信用)セコムのrootからdetail、recordを特定するSQL(カルテ用)', current_timestamp, current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);