 ...
 select COALESCE(
                   ...
                   (SELECT COALESCE
                    ...
                    FROM exchange,
                         ...
                         ord2,
                         ord3), 0)
           as count', db_class = 2, detail = '[]', can_repeat = '0', use_application = '{"applications": []}', report_class = '{"classes": []}', memo = 'データリスト', reg_date = '2020-07-31 18:29:49.000', up_date = '2020-07-31 18:29:49.000', pre_sql_info = null WHERE sql_cd = -11043;
UPDATE ntss.sys_data_set SET sql = 'WITH exchange AS ( SELECT unit_converted_amount, unit_converted_amount_second, is_exchange FROM mst_medicine WHERE medicine_cd = @id AND is_del = ''0'' AND facility_cd = @facilityCd
 ),
ord1 AS (
		SELECT COUNT
...
SELECT COALESCE(
                   ...
                   (SELECT COALESCE
                    ...
                    from exchange,
                         ord1,
                         ord2)
           , 0) as count', db_class = 2, detail = '[]', can_repeat = '0', use_application = '{"applications": []}', report_class = '{"classes": []}', memo = 'データリスト', reg_date = '2020-07-31 18:29:49.000', up_date = '2020-07-31 18:29:49.000', pre_sql_info = null WHERE sql_cd = -11045;
