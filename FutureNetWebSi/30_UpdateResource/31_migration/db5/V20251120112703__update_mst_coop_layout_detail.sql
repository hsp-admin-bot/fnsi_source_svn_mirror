...
', '{"dataset": [{"key0": "-307137.key0", "ctlNo": "-307137.ctl_no", "ordNo": "-307137.ord_no", "patId": "-307137.pat_id", "sqlCode": -307073, "facilityCd": "-307137.facility_cd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'MED');