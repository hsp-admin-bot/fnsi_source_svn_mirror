DELETE FROM sys_data_set WHERE sql_cd IN (-1107056,-1107055);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-1107056, 'WITH content_raw AS (
...
target_ord_no AS (
    ...
    WHERE 
        ...
        AND COALESCE(mst_treatment.treatment_name,''未登録'') = (
            CASE 
                WHEN ((log_info_with_dow.treatment_method is null or log_info_with_dow.treatment_method = ''すべて'') 
                ...
                ELSE 
                    CASE 
                        ...
                        ELSE log_info_with_dow.treatment_method 
                    END
            END
        )
            ...
            CASE 
                ...
                ELSE 
                    CASE 
                        ...
                        ELSE COALESCE(NULLIF(log_info_with_dow.treatment_course, ''''), ''未登録'') 
                    END
            END
        )
)
