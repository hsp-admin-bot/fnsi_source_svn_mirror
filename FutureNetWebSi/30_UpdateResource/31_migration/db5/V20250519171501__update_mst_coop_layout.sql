...
VALUES(-11060100, 'MEDI', 'accept', '', 'S', 'cre', 'csv', 'セコム連携_再来受付連携', 'Secom', '(仮)再来受付連携', '1', '<root name="再来受付">
  <item name="更新モード" value="const:0"/>
  <item name="予約担当者ユーザID" value="dataset:-1100003.disp_user_id"/>
...
', '{"dataset": [{"key0": "key0", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1104001, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, '2022-01-13 08:11:32.235', '2022-01-13 08:11:32.235', 'Secom');

INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-11060101, 'MEDI', 'accept', '', 'S', 'upd', 'csv', 'セコム連携_再来受付連携', 'Secom', '(仮)再来受付連携', '1', '<root name="再来受付">
  <item name="更新モード" value="const:0"/>
  <item name="予約担当者ユーザID" value="dataset:-1100003.disp_user_id"/>
  <item name="診察券番号・患者ID" value="dataset:-1100006.hosp_pat_id"/>
  <item name="予約予定日時" value="dataset:-1104001.appointment_date"/>
...
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-11060102, 'MEDI', 'accept', '', 'S', 'del', 'csv', 'セコム連携_再来受付連携', 'Secom', '(仮)再来受付連携', '1', '<root name="再来受付">
  <item name="更新モード" value="const:0"/>
  <item name="予約担当者ユーザID" value="dataset:-1100003.disp_user_id"/>
  <item name="診察券番号・患者ID" value="dataset:-1100006.hosp_pat_id"/>
  <item name="予約予定日時" value="dataset:-1104001.appointment_date"/>
