...
;', "detail" = (
  select jsonb_agg (
    case when tmp.de->>'field_name' = 'event_start_date' then tmp.de || json_build_object('data_code', 'event_start_date')::jsonb
         else tmp.de
    end 
  )
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 84
  ) tmp
...
;', "detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 85
  ) tmp
...
;',"detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 87
  ) tmp
...
;',"detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 88
  ) tmp
...
;', "detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 89
  ) tmp
...
;', "detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 90
  ) tmp
...
;', "detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 91
  ) tmp
...
;', "detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 92
  ) tmp
...
;', "detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 93
  ) tmp
...
;', "detail" = (
  ...
  from (
    select jsonb_array_elements(detail) as de from sys_data_set where sql_cd = 94
  ) tmp
