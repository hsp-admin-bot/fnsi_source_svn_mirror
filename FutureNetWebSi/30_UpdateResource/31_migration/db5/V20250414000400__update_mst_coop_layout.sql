...
SET coop_ext_setting = $json$
	...
	"dataset": {
		...
		},
		{
			...
			"@patContactInfo.ctlNo": "$journal.pat_personal_main.pat_contact_info.ctl_no",
		...
		"sqlGroup6": [{
			...
			"ctl_no": "1",
			"sqlCode": -603001,
			"@lastName": "$journal.detail.pat_personal_main.other_contact_info.name",
			"@relationCd": "$journal.detail.pat_personal_main.other_contact_info.relation_cd",
			"updateResult": "{@otherContactInfoFlg:'', @otherContactInfoValue:'other_contact_info', @otherContactInfo.ctlNo:'', @otherContactInfo.dispOrder:'', @otherContactInfo.isKeyPerson:'', @otherContactInfo.patId:'', @otherContactInfo.lastName:'', @otherContactInfo.firstName:'', @otherContactInfo.lastNmKana:'', @otherContactInfo.firstNmKana:'', @otherContactInfo.relationCd:'', @otherContactInfo.relationName:'', @otherContactInfo.zipCd:'', @otherContactInfo.address:'', @otherContactInfo.eMail:'', @otherContactInfo.workName:'', @otherContactInfo.workTel:'', @otherContactInfo.tel1:'', @otherContactInfo.tel2:'', @otherContactInfo.fax:'', @otherContactInfo.memo1:'', @otherContactInfo.memo2:'', @vendorContactInfoFlg:'', @vendorContactInfoValue:'vendor_contact_info', @vendorContactInfo.ctlNo:'', @vendorContactInfo.dispOrder:'', @vendorContactInfo.companyName:'', @vendorContactInfo.zipCd:'', @vendorContactInfo.address:'', @vendorContactInfo.companyTel:'', @vendorContactInfo.fax:'', @vendorContactInfo.workerLastName:'', @vendorContactInfo.workerFirstName:'', @vendorContactInfo.workerTel:'', @vendorContactInfo.workerEMail:'', @vendorContactInfo.memo1:'', @vendorContactInfo.memo2:''}",
			"@contactCtlNo": "$journal.detail.pat_personal_main.other_contact_info.ctl_no"
		},
		{
			"crud": "U",
			"kind": "0",
			"@tel1": "$journal.detail.pat_personal_main.other_contact_info.tel1",
			"judge": "",
			"table": "pat_personal_main",
			"@zipCd": "$journal.detail.pat_personal_main.other_contact_info.zip_cd",
			"ctl_no": "2",
			"sqlCode": -603204,
			"@address": "$journal.detail.pat_personal_main.other_contact_info.address",
			"@lastName": "$journal.detail.pat_personal_main.other_contact_info.name",
			"@relationCd": "$journal.detail.pat_personal_main.other_contact_info.relation_cd"
		}],
		"sqlGroup7": [{
			...
			"ctl_no": "1",
			"sqlCode": -603001,
			"@lastName": "$journal.detail.pat_personal_main.vendor_contact_info.name",
			"@relationCd": "$journal.detail.pat_personal_main.vendor_contact_info.relation_cd",
			"updateResult": "{@otherContactInfoFlg:'', @otherContactInfoValue:'other_contact_info', @otherContactInfo.ctlNo:'', @otherContactInfo.dispOrder:'', @otherContactInfo.isKeyPerson:'', @otherContactInfo.patId:'', @otherContactInfo.lastName:'', @otherContactInfo.firstName:'', @otherContactInfo.lastNmKana:'', @otherContactInfo.firstNmKana:'', @otherContactInfo.relationCd:'', @otherContactInfo.relationName:'', @otherContactInfo.zipCd:'', @otherContactInfo.address:'', @otherContactInfo.eMail:'', @otherContactInfo.workName:'', @otherContactInfo.workTel:'', @otherContactInfo.tel1:'', @otherContactInfo.tel2:'', @otherContactInfo.fax:'', @otherContactInfo.memo1:'', @otherContactInfo.memo2:'', @vendorContactInfoFlg:'', @vendorContactInfoValue:'vendor_contact_info', @vendorContactInfo.ctlNo:'', @vendorContactInfo.dispOrder:'', @vendorContactInfo.companyName:'', @vendorContactInfo.zipCd:'', @vendorContactInfo.address:'', @vendorContactInfo.companyTel:'', @vendorContactInfo.fax:'', @vendorContactInfo.workerLastName:'', @vendorContactInfo.workerFirstName:'', @vendorContactInfo.workerTel:'', @vendorContactInfo.workerEMail:'', @vendorContactInfo.memo1:'', @vendorContactInfo.memo2:''}",
			"@contactCtlNo": "$journal.detail.pat_personal_main.vendor_contact_info.ctl_no"
		},
		{
			"crud": "U",
			"kind": "0",
			"@tel1": "$journal.detail.pat_personal_main.vendor_contact_info.tel1",
			"judge": "",
			"table": "pat_personal_main",
			"@zipCd": "$journal.detail.pat_personal_main.vendor_contact_info.zip_cd",
			"ctl_no": "2",
			"sqlCode": -603204,
			"@address": "$journal.detail.pat_personal_main.vendor_contact_info.address",
			"@lastName": "$journal.detail.pat_personal_main.vendor_contact_info.name",
			"@relationCd": "$journal.detail.pat_personal_main.vendor_contact_info.relation_cd"
		}],
		"sqlGroup8": [{
		...
		"sqlGroup11": [{
			...
			"ctl_no": "1",
			"sqlCode": 1201,
			"updateResult": "{@nextCtlNo4:'next_ctl_no_4', @infectInfoFlg:'', @infectInfoValue:'infect_info', @infectInfo.ctlNo:'', @infectInfo.infectionCd:'', @infectInfo.infect:'', @infectInfo.examDate:'', @infectInfo.upDate:''}"
		},
		{
		...
		},
		{
			...
			"ctl_no": "3",
			"sqlCode": 4202,
			"@infectInfo.infect": "$journal.detail.pat_main.infect_info.infect",
			"@infectInfo.infectionCd": "$journal.detail.pat_main.infect_info.infection_cd"
		}],
		"sqlGroup12": [{
	...
	"CoopIniConvUtil": {
		"$journal.detail.pat_main.infect_info.infect": "CONV_INFECTION_TO_FNW",
