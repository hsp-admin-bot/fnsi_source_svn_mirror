delete from "mst_coop_layout" where "ctl_no" in (-1100001,-1100002);
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1100002, 'nkknkk', 'exam_ord', '', 'S', 'upd', 'text', '日機装標準', 'nikkiso', '検査依頼(※電文フォーマットはMedicomと一致しています。直接にMedicomのフォーマットを使います。)', '1', '<root name="検査依頼">
...
</root>', '{"dataset": [{"patId": "patId", "sqlCode": -300001}, {"patId": "patId", "sqlCode": -452}, {"ordNo": "ordNo", "sqlCode": -453}, {"ordNo": "ordNo", "sqlCode": -454}, {"ordNo": "ordNo", "sqlCode": -24}, {"ordNo": "ordNo", "sqlCode": -23}, {"ordNo": "ordNo", "sqlCode": -31}], "dumpFileName": {"ctlNo": "ctlNo", "patId": "patId", "sqlCode": -99995}}', '1', '0', 4, '2020-05-13 14:59:24.07', '2020-05-13 14:59:30.009');
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1100001, 'nkknkk', 'exam_ord', '', 'S', 'cre', 'text', '日機装標準', 'nikkiso', '検査依頼(※電文フォーマットはMedicomと一致しています。直接にMedicomのフォーマットを使います。)', '1', '<root name="検査依頼">
    <item  name="レコード区分" len="2" value="const:O1"/>
    <item  name="検査機関コード" len="6" value="const:000000"/>
    <item  name="依頼者KEY（日付）" len="6" value="$SYSDATE" subMode="R"/>
    <item  name="依頼者KEY（受付番号）" len="4" value="$JOURNAL.accept_no" padding_format="zero" padding_position="left"/>
    ...
    <item  name="改行" len="1" value="$CR"/>
    <occ  name="明細.検査項目" len="0" detail="検査項目" sqlCode="-453"/>
</root>', '{"dataset": [{"patId": "patId", "sqlCode": -300001}, {"patId": "patId", "sqlCode": -452}, {"ordNo": "ordNo", "sqlCode": -453}, {"ordNo": "ordNo", "sqlCode": -454}, {"ordNo": "ordNo", "sqlCode": -24}, {"ordNo": "ordNo", "sqlCode": -23}, {"ordNo": "ordNo", "sqlCode": -31}], "dumpFileName": {"ctlNo": "ctlNo", "patId": "patId", "sqlCode": -99995}}', '1', '0', 4, '2020-05-13 14:59:20.666', '2020-05-13 14:59:27.002');
