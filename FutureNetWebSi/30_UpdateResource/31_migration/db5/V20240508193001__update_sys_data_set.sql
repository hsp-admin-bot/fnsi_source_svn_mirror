DELETE FROM ntss.sys_data_set WHERE sql_cd IN (-195);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-195, 'WITH default_user_no AS (
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '富士通）透析予約：共通部と伝票情報の利用者番号取得', '2022-02-28 14:34:34.866', CURRENT_TIMESTAMP, NULL);
