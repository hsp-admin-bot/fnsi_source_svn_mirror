...
-- 予定
  ...
  from
    mst_mainte_layout
  where
    facility_cd = (select distinct facility_cd from machine_tbl)
  and
    layout_class = ''1''
  and
    is_disp = ''1''
  ...
  where
    mmd.facility_cd = (select distinct facility_cd from machine_tbl)
  and
    mmd.is_disp = ''1''
  and
    mmd.is_del = ''0''
