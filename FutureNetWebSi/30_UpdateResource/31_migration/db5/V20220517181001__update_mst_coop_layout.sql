...
INSERT INTO "ntss"."mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1040001, 'nkknkk', 'ind_dial', '', 'S', 'del', 'text', '日機装標準', 'nikkiso', '透析予約', '1', '<root name="日機装標準(透析予約)" multi="true:CRLF">
    ...
    <item  name="透析実施時間" len="3" value="dataset:-13.dialysis_time_m"/>
...
</root>', '{"dataset": [{"patId": "patId", "sqlCode": -400001}, {"ordNo": "ordNo", "sqlCode": -13}, {"ordNo": "ordNo", "sqlCode": -18}, {"ordNo": "ordNo", "sqlCode": -19}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -99992}, "CoopIniConvUtil": {"-400001.in_out_class": "CONV_INOUT_TO_KARTE"}}', '1', '0', -1, '2022-04-29 06:41:38.06', current_timestamp);
