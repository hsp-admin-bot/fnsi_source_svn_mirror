DELETE FROM "ntss"."sys_data_set" where sql_cd in (84,85,86,87,88,89,90,91,92,93,94,219);
...
--   ,pe_basicinfo.up_date
  ...
  ,picked_input_params[10]->>''field_name'' as data10_field_name
  ,case when picked_result_params[1]->>''result_value'' is null or picked_result_params[1]->>''result_value'' = '''' then picked_input_params[1]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 1 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[1]->>''result_value'' end)
end as data1
  ,case when picked_result_params[2]->>''result_value'' is null or picked_result_params[2]->>''result_value'' = '''' then picked_input_params[2]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 2 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[2]->>''result_value'' end)
end as data2
...
else (case when  (picked_input_params [ 3 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[3]->>''result_value'' end)
end as data3
 ,case when picked_result_params[4]->>''result_value'' is null or picked_result_params[4]->>''result_value'' = '''' then picked_input_params[4]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 4 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[4]->>''result_value'' end)
end as data4
,case when picked_result_params[5]->>''result_value'' is null or picked_result_params[5]->>''result_value'' = '''' then picked_input_params[5]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 5 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[5]->>''result_value'' end)
end as data5
,case when picked_result_params[6]->>''result_value'' is null or picked_result_params[6]->>''result_value'' = '''' then picked_input_params[6]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 6 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[6]->>''result_value'' end)
end as data6
...
(case when  (picked_input_params [ 7 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[7]->>''result_value'' end)
end as data7
 ,case when picked_result_params[8]->>''result_value'' is null or picked_result_params[8]->>''result_value'' = '''' then picked_input_params[8]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 8 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[8]->>''result_value'' end)
end as data8
,case when picked_result_params[9]->>''result_value'' is null or picked_result_params[9]->>''result_value'' = '''' then picked_input_params[9]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 9 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[9]->>''result_value'' end)
end as data9
,case when picked_result_params[10]->>''result_value'' is null or picked_result_params[10]->>''result_value'' = '''' then picked_input_params[10]->''item_json''->>''default_value''
else (case when  (picked_input_params [ 10 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then unescape_html(regexp_replace(substring(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'') from 1 for length(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) - 2), ''<[^>]*>'', '''', ''g'')) else picked_result_params[10]->>''result_value'' end)
end as data10
from
  pe_array_agg
  inner join pe_basicinfo on pe_array_agg.pat_event_cd = pe_basicinfo.pat_event_cd
...
from
  ...
  inner join pe_basicinfo on pe_array_agg.pat_event_cd = pe_basicinfo.pat_event_cd
ORDER BY event_start_date, reg_date
;', 2, '[{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_field_name","data_name":"データ1 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_field_name","data_name":"データ2 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_field_name","data_name":"データ3 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_field_name","data_name":"データ4 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_field_name","data_name":"データ5 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_field_name","data_name":"データ6 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_field_name","data_name":"データ7 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_field_name","data_name":"データ8 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_field_name","data_name":"データ9 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_field_name","data_name":"データ10 フィールド名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_field_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic1_name","data_name":"データ1 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic1_file_name","data_name":"データ1 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic1_file_path","data_name":"データ1 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic2_name","data_name":"データ1 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic2_file_name","data_name":"データ1 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic2_file_path","data_name":"データ1 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic3_name","data_name":"データ1 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic3_file_name","data_name":"データ1 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic3_file_path","data_name":"データ1 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic4_name","data_name":"データ1 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic4_file_name","data_name":"データ1 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic4_file_path","data_name":"データ1 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic5_name","data_name":"データ1 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic5_file_name","data_name":"データ1 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic5_file_path","data_name":"データ1 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic6_name","data_name":"データ1 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic6_file_name","data_name":"データ1 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic6_file_path","data_name":"データ1 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic7_name","data_name":"データ1 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic7_file_name","data_name":"データ1 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic7_file_path","data_name":"データ1 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic8_name","data_name":"データ1 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic8_file_name","data_name":"データ1 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic8_file_path","data_name":"データ1 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data1_pic9_name","data_name":"データ1 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data1_pic9_file_name","data_name":"データ1 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data1_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data1_pic9_file_path","data_name":"データ1 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data1_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic1_name","data_name":"データ2 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic1_file_name","data_name":"データ2 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic1_file_path","data_name":"データ2 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic2_name","data_name":"データ2 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic2_file_name","data_name":"データ2 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic2_file_path","data_name":"データ2 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic3_name","data_name":"データ2 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic3_file_name","data_name":"データ2 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic3_file_path","data_name":"データ2 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic4_name","data_name":"データ2 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic4_file_name","data_name":"データ2 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic4_file_path","data_name":"データ2 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic5_name","data_name":"データ2 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic5_file_name","data_name":"データ2 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic5_file_path","data_name":"データ2 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic6_name","data_name":"データ2 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic6_file_name","data_name":"データ2 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic6_file_path","data_name":"データ2 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic7_name","data_name":"データ2 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic7_file_name","data_name":"データ2 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic7_file_path","data_name":"データ2 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic8_name","data_name":"データ2 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic8_file_name","data_name":"データ2 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic8_file_path","data_name":"データ2 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data2_pic9_name","data_name":"データ2 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data2_pic9_file_name","data_name":"データ2 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data2_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data2_pic9_file_path","data_name":"データ2 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data2_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic1_name","data_name":"データ3 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic1_file_name","data_name":"データ3 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic1_file_path","data_name":"データ3 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic2_name","data_name":"データ3 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic2_file_name","data_name":"データ3 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic2_file_path","data_name":"データ3 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic3_name","data_name":"データ3 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic3_file_name","data_name":"データ3 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic3_file_path","data_name":"データ3 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic4_name","data_name":"データ3 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic4_file_name","data_name":"データ3 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic4_file_path","data_name":"データ3 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic5_name","data_name":"データ3 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic5_file_name","data_name":"データ3 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic5_file_path","data_name":"データ3 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic6_name","data_name":"データ3 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic6_file_name","data_name":"データ3 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic6_file_path","data_name":"データ3 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic7_name","data_name":"データ3 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic7_file_name","data_name":"データ3 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic7_file_path","data_name":"データ3 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic8_name","data_name":"データ3 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic8_file_name","data_name":"データ3 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic8_file_path","data_name":"データ3 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data3_pic9_name","data_name":"データ3 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data3_pic9_file_name","data_name":"データ3 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data3_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data3_pic9_file_path","data_name":"データ3 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data3_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic1_name","data_name":"データ4 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic1_file_name","data_name":"データ4 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic1_file_path","data_name":"データ4 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic2_name","data_name":"データ4 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic2_file_name","data_name":"データ4 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic2_file_path","data_name":"データ4 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic3_name","data_name":"データ4 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic3_file_name","data_name":"データ4 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic3_file_path","data_name":"データ4 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic4_name","data_name":"データ4 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic4_file_name","data_name":"データ4 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic4_file_path","data_name":"データ4 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic5_name","data_name":"データ4 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic5_file_name","data_name":"データ4 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic5_file_path","data_name":"データ4 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic6_name","data_name":"データ4 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic6_file_name","data_name":"データ4 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic6_file_path","data_name":"データ4 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic7_name","data_name":"データ4 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic7_file_name","data_name":"データ4 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic7_file_path","data_name":"データ4 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic8_name","data_name":"データ4 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic8_file_name","data_name":"データ4 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic8_file_path","data_name":"データ4 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data4_pic9_name","data_name":"データ4 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data4_pic9_file_name","data_name":"データ4 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data4_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data4_pic9_file_path","data_name":"データ4 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data4_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic1_name","data_name":"データ5 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic1_file_name","data_name":"データ5 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic1_file_path","data_name":"データ5 画像1 イメージ","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic2_name","data_name":"データ5 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic2_file_name","data_name":"データ5 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic2_file_path","data_name":"データ5 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic3_name","data_name":"データ5 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic3_file_name","data_name":"データ5 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic3_file_path","data_name":"データ5 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic4_name","data_name":"データ5 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic4_file_name","data_name":"データ5 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic4_file_path","data_name":"データ5 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic5_name","data_name":"データ5 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic5_file_name","data_name":"データ5 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic5_file_path","data_name":"データ5 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic6_name","data_name":"データ5 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic6_file_name","data_name":"データ5 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic6_file_path","data_name":"データ5 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic7_name","data_name":"データ5 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic7_file_name","data_name":"データ5 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic7_file_path","data_name":"データ5 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic8_name","data_name":"データ5 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic8_file_name","data_name":"データ5 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic8_file_path","data_name":"データ5 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data5_pic9_name","data_name":"データ5 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data5_pic9_file_name","data_name":"データ5 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data5_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data5_pic9_file_path","data_name":"データ5 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data5_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic1_name","data_name":"データ6 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic1_file_name","data_name":"データ6 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic1_file_path","data_name":"データ6 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic2_name","data_name":"データ6 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic2_file_name","data_name":"データ6 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic2_file_path","data_name":"データ6 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic3_name","data_name":"データ6 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic3_file_name","data_name":"データ6 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic3_file_path","data_name":"データ6 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic4_name","data_name":"データ6 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic4_file_name","data_name":"データ6 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic4_file_path","data_name":"データ6 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic5_name","data_name":"データ6 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic5_file_name","data_name":"データ6 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic5_file_path","data_name":"データ6 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic6_name","data_name":"データ6 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic6_file_name","data_name":"データ6 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic6_file_path","data_name":"データ6 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic7_name","data_name":"データ6 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic7_file_name","data_name":"データ6 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic7_file_path","data_name":"データ6 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic8_name","data_name":"データ6 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic8_file_name","data_name":"データ6 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic8_file_path","data_name":"データ6 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data6_pic9_name","data_name":"データ6 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data6_pic9_file_name","data_name":"データ6 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data6_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data6_pic9_file_path","data_name":"データ6 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data6_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic1_name","data_name":"データ7 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic1_file_name","data_name":"データ7 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic1_file_path","data_name":"データ7 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic2_name","data_name":"データ7 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic2_file_name","data_name":"データ7 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic2_file_path","data_name":"データ7 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic3_name","data_name":"データ7 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic3_file_name","data_name":"データ7 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic3_file_path","data_name":"データ7 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic4_name","data_name":"データ7 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic4_file_name","data_name":"データ7 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic4_file_path","data_name":"データ7 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic5_name","data_name":"データ7 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic5_file_name","data_name":"データ7 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic5_file_path","data_name":"データ7 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic6_name","data_name":"データ7 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic6_file_name","data_name":"データ7 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic6_file_path","data_name":"データ7 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic7_name","data_name":"データ7 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic7_file_name","data_name":"データ7 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic7_file_path","data_name":"データ7 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic8_name","data_name":"データ7 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic8_file_name","data_name":"データ7 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic8_file_path","data_name":"データ7 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data7_pic9_name","data_name":"データ7 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data7_pic9_file_name","data_name":"データ7 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data7_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data7_pic9_file_path","data_name":"データ7 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data7_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic1_name","data_name":"データ8 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic1_file_name","data_name":"データ8 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic1_file_path","data_name":"データ8 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic2_name","data_name":"データ8 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic2_file_name","data_name":"データ8 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic2_file_path","data_name":"データ8 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic3_name","data_name":"データ8 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic3_file_name","data_name":"データ8 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic3_file_path","data_name":"データ8 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic4_name","data_name":"データ8 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic4_file_name","data_name":"データ8 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic4_file_path","data_name":"データ8 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic5_name","data_name":"データ8 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic5_file_name","data_name":"データ8 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic5_file_path","data_name":"データ8 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic6_name","data_name":"データ8 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic6_file_name","data_name":"データ8 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic6_file_path","data_name":"データ8 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic7_name","data_name":"データ8 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic7_file_name","data_name":"データ8 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic7_file_path","data_name":"データ8 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic8_name","data_name":"データ8 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic8_file_name","data_name":"データ8 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic8_file_path","data_name":"データ8 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data8_pic9_name","data_name":"データ8 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data8_pic9_file_name","data_name":"データ8 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data8_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data8_pic9_file_path","data_name":"データ8 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data8_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic1_name","data_name":"データ9 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic1_file_name","data_name":"データ9 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic1_file_path","data_name":"データ9 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic2_name","data_name":"データ9 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic2_file_name","data_name":"データ9 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic2_file_path","data_name":"データ9 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic3_name","data_name":"データ9 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic3_file_name","data_name":"データ9 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic3_file_path","data_name":"データ9 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic4_name","data_name":"データ9 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic4_file_name","data_name":"データ9 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic4_file_path","data_name":"データ9 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic5_name","data_name":"データ9 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic5_file_name","data_name":"データ9 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic5_file_path","data_name":"データ9 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic6_name","data_name":"データ9 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic6_file_name","data_name":"データ9 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic6_file_path","data_name":"データ9 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic7_name","data_name":"データ9 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic7_file_name","data_name":"データ9 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic7_file_path","data_name":"データ9 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic8_name","data_name":"データ9 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic8_file_name","data_name":"データ9 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic8_file_path","data_name":"データ9 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data9_pic9_name","data_name":"データ9 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data9_pic9_file_name","data_name":"データ9 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data9_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data9_pic9_file_path","data_name":"データ9 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data9_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic1_name","data_name":"データ10 画像1 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic1_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic1_file_name","data_name":"データ10 画像1 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic1_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic1_file_path","data_name":"データ10 画像1 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic1_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic2_name","data_name":"データ10 画像2 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic2_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic2_file_name","data_name":"データ10 画像2 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic2_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic2_file_path","data_name":"データ10 画像2 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic2_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic3_name","data_name":"データ10 画像3 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic3_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic3_file_name","data_name":"データ10 画像3 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic3_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic3_file_path","data_name":"データ10 画像3 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic3_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic4_name","data_name":"データ10 画像4 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic4_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic4_file_name","data_name":"データ10 画像4 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic4_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic4_file_path","data_name":"データ10 画像4 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic4_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic5_name","data_name":"データ10 画像5 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic5_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic5_file_name","data_name":"データ10 画像5 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic5_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic5_file_path","data_name":"データ10 画像5 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic5_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic6_name","data_name":"データ10 画像6 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic6_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic6_file_name","data_name":"データ10 画像6 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic6_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic6_file_path","data_name":"データ10 画像6 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic6_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic7_name","data_name":"データ10 画像7 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic7_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic7_file_name","data_name":"データ10 画像7 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic7_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic7_file_path","data_name":"データ10 画像7 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic7_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic8_name","data_name":"データ10 画像8 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic8_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic8_file_name","data_name":"データ10 画像8 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic8_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic8_file_path","data_name":"データ10 画像8 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic8_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"レポート関連画像","can_calc":"0","data_code":"data10_pic9_name","data_name":"データ10 画像9 名前","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic9_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"report.png","can_calc":"0","data_code":"data10_pic9_file_name","data_name":"データ10 画像9 ファイル名","data_type":"string","conv_table":[],"data_class":"画像","field_name":"data10_pic9_file_name","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"},{"preview":"placeholder.jpg","can_calc":"0","is_image":"true","data_code":"data10_pic9_file_path","data_name":"データ10 画像9 イメージ","data_type":"byte[]","conv_table":[],"data_class":"画像","field_name":"data10_pic9_file_path","disp_format":"","filter_type":"Category","data_category":"患者イベント","facility_table":"","facility_filter_type":"0"}]', '1', '{"applications": [1]}', '{"classes": [1, 2, 3, 9, 11]}', '患者イベント 画像　@patId @facilityCd @fromDate @toDate使用', '2021-08-26 00:00:22', CURRENT_TIMESTAMP, NULL);
...
from
  ...
  inner join pe_basicinfo on pe_array_agg.pat_event_cd = pe_basicinfo.pat_event_cd
ORDER BY event_start_date, reg_date  
;', 2, '[{"preview": "実施日付", "can_calc": "0", "data_code": "data1_field_name", "data_name": "データ1 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data1_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data2_field_name", "data_name": "データ2 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data2_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data3_field_name", "data_name": "データ3 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data3_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data4_field_name", "data_name": "データ4 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data4_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data5_field_name", "data_name": "データ5 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data5_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data6_field_name", "data_name": "データ6 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data6_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data7_field_name", "data_name": "データ7 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data7_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data8_field_name", "data_name": "データ8 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data8_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data9_field_name", "data_name": "データ9 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data9_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "実施日付", "can_calc": "0", "data_code": "data10_field_name", "data_name": "データ10 フィールド名", "data_type": "string", "conv_table": [], "data_class": "日付", "field_name": "data10_field_name", "disp_format": "", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data1", "data_name": "データ1", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data1", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data2", "data_name": "データ2", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data2", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data3", "data_name": "データ3", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data3", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data4", "data_name": "データ4", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data4", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data5", "data_name": "データ5", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data5", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data6", "data_name": "データ6", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data6", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data7", "data_name": "データ7", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data7", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data8", "data_name": "データ8", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data8", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data9", "data_name": "データ9", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data9", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2025/08/19", "can_calc": "0", "data_code": "data10", "data_name": "データ10", "data_type": "DateTime", "conv_table": [], "data_class": "日付", "field_name": "data10", "disp_format": "yyyy/mm/dd", "filter_type": "Category", "data_category": "患者イベント", "facility_table": "", "facility_filter_type": "0"}]', '1', '{"applications": [1]}', '{"classes": [1, 2, 3, 9, 10, 11]}', '患者イベント 日付　@patId @facilityCd @fromDate @toDate使用', '2021-08-26 13:50:14', CURRENT_TIMESTAMP, NULL);
