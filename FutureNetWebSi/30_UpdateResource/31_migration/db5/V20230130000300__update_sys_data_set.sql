DELETE FROM "ntss"."sys_data_set" WHERE sql_cd IN (-103);
...
SELECT data_middle_all.detail_id, data_middle_all.e01, data_middle_all.e02, data_middle_all.e03, data_middle_all.e04, data_middle_all.e05, data_middle_all.e06, data_middle_all.e07, data_middle_all.e08, data_middle_all.e09,sortTag1,sortTag2, 
CASE WHEN (SELECT medicine_type_yakuzai FROM data_middle) :: TEXT = ''2'' THEN NULL ELSE (
CASE WHEN TRIM(data_middle_all.e01) = TRIM((SELECT yakuzai FROM data_middle) :: TEXT) THEN NULL ELSE mmd.medicine_cd END) END AS medicine_cd,
 CASE WHEN (SELECT medicine_type_yakuzai FROM data_middle) :: TEXT = ''2'' THEN NULL ELSE (
CASE WHEN TRIM(data_middle_all.e01) = TRIM((SELECT yakuzai FROM data_middle) :: TEXT) THEN NULL ELSE mmq.equipment_cd END) END AS equipment_cd, 
mmd.class_cd as mdclass_cd ,mmq.class_cd as mqclass_cd
...
select detail_id, e01,e02,e03,data_all.e04,e05,e06,e07,e08,e09,sortTag1,sortTag2,''治剤''::text as  aa
             from data_all 
						 LEFT JOIN  medi_data ON (e01 != medi_data.item_cd_s AND data_all.e04 != medi_data.e04)
						 where 
						 medicine_cd is not null
             and e09<(SELECT value FROM dialyis_item_sort WHERE key2 = ''ITEM_MEASURE_MEDICINE'')
union 
select detail_id, e01,e02,e03,data_all.e04,e05,e06,e07,e08,e09,sortTag1,sortTag2,''治剤''::text as  aa
             from data_all
						 LEFT JOIN  medi_data ON (e01 != medi_data.item_cd_s AND data_all.e04 != medi_data.e04)
						 where medicine_cd is not null
             and e09>=(((SELECT value FROM dialyis_item_sort WHERE key2 = ''ITEM_MEASURE_MEDICINE'')::INTEGER +1 )::text)
union 
select detail_id, e01,e02,e03,data_all.e04,e05,e06,e07,e08,e09,sortTag1,sortTag2,''治材''::text as  aa
             from data_all
						 LEFT JOIN equip_data ON(e01 != equip_data.item_cd_s AND data_all.e04 != equip_data.e04)
						 where equipment_cd is not null
             and e09<>(SELECT value FROM dialyis_item_sort WHERE key2 = ''ITEM_EQUIP'')
             and e09<(SELECT value FROM dialyis_item_sort WHERE key2 = ''ITEM_MEASURE_MEDICINE'')
union
select detail_id, e01,e02,e03,data_all.e04,e05,e06,e07,e08,e09,sortTag1,sortTag2,''治材''::text as  aa
...
, equip_middle_order as(
 SELECT ROW_NUMBER () OVER () AS no2, *
FROM ( SELECT detail_id, e01, e02, e03, e04, e05, e06, e07, e08, e09, sortTag1,sortTag2, aa
 ...
 ORDER BY 
     ...
     CASE WHEN (SELECT ora FROM do_order_data_equip_from WHERE no2 = 3) = 0 THEN login_ord
          ...
          WHEN (SELECT ora FROM do_order_data_equip_from WHERE no2 = 3) = 2 THEN equip_cd END) AS mid_d)
, equip_order as(--医療材料の最終版
SELECT detail_id, e01, e02, e03, e04, e05, e06, e07, e08, 
CASE WHEN length(no2 :: TEXT) = 1 THEN e09 || ''-0'' || no2 ELSE e09 || ''-'' || no2 END AS e09, sortTag1,sortTag2, aa
FROM equip_middle_order
)
