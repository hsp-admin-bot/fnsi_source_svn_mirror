...
VALUES ( 
  ...
  , CASE ''@isDie'' WHEN ''1'' THEN ''11'' ELSE NULL END
...
)', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの患者プロファイル_患者基本情報の新規', '2025-06-19 10:46:04.398', CURRENT_TIMESTAMP, '[{"sql_cd": 1002, "field_name": "pat_memo_info", "replace_var": "@patMemoInfo"}, {"sql_cd": 1004, "field_name": "addition_info", "replace_var": "@additioninfo"}, {"sql_cd": -100001, "field_name": "is_die", "replace_var": "@isDie"}]'::jsonb);
INSERT INTO sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
WHERE is_del = ''0''
  AND pat_id = @patId', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの患者プロファイル_患者基本情報の修正', '2025-06-19 10:46:04.398', CURRENT_TIMESTAMP, '[{"sql_cd": -100001, "field_name": "in_out_class", "replace_var": "@ppmInOutClass"}, {"sql_cd": -100001, "field_name": "is_die", "replace_var": "@isDie"}]'::jsonb);