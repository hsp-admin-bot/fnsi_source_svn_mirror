...
select
  ...
  ,case when  picked_result_params[1]->>''result_value'' is null or picked_result_params[1]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data1
  ,case when  picked_result_params[2]->>''result_value'' is null or picked_result_params[2]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data2
  ,case when  picked_result_params[3]->>''result_value'' is null or picked_result_params[3]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data3
  ,case when  picked_result_params[4]->>''result_value'' is null or picked_result_params[4]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data4
  ,case when  picked_result_params[5]->>''result_value'' is null or picked_result_params[5]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data5
  ,case when  picked_result_params[6]->>''result_value'' is null or picked_result_params[6]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data6
  ,case when  picked_result_params[7]->>''result_value'' is null or picked_result_params[7]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data7
  ,case when  picked_result_params[8]->>''result_value'' is null or picked_result_params[8]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data8
  ,case when  picked_result_params[9]->>''result_value'' is null or picked_result_params[9]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data9
  ,case when  picked_result_params[10]->>''result_value'' is null or picked_result_params[10]->>''result_value'' = '''' then '''' else (unescape_html(regexp_replace(substring(unescape_html(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2), ''<[^>]*>'', '''', ''g''))) end as data10
from
  pe_array_agg
...
else (case when  POSITION(''</p'' IN picked_result_params[1]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[1]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data1
...
else (case when  POSITION(''</p'' IN picked_result_params[2]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[2]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data2
...
else (case when  POSITION(''</p'' IN picked_result_params[3]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[3]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data3
...
else (case when  POSITION(''</p'' IN picked_result_params[4]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[4]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data4
...
else (case when  POSITION(''</p'' IN picked_result_params[5]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[5]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data5
...
else (case when  POSITION(''</p'' IN picked_result_params[6]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[6]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data6
 ,unescape_html(regexp_replace(case when picked_result_params[7]->>''result_value'' is null or picked_result_params[7]->>''result_value'' = '''' then picked_input_params[7]->''item_json''->>''default_value''
else 
(case when  POSITION(''</p'' IN picked_result_params[7]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[7]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data7
...
else (case when  POSITION(''</p'' IN picked_result_params[8]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[8]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data8
...
else (case when  POSITION(''</p'' IN picked_result_params[9]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[9]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data9
...
else (case when  POSITION(''</p'' IN picked_result_params[10]->>''result_value'') > 0 then substring(unescape_html(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g'')) from 1 for length(unescape_html(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', ''#b'', ''g''))) - 2) else picked_result_params[10]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data10
from
  pe_array_agg
  inner join pe_basicinfo on pe_array_agg.pat_event_cd = pe_basicinfo.pat_event_cd
