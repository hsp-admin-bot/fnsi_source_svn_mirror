INSERT INTO "ntss"."sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (202, 'SELECT COUNT(om.treat_date) AS dialysis_conunt
...
, ''YYYYMMDD'') AND to_char(cast(@fromDate as timestamp)::timestamp + ''7 day'', ''YYYYMMDD'' )
ORDER BY treat_week DESC)  om

 GROUP BY om.pat_id', 2, '[{"preview": "5", "can_calc": "0", "data_code": "dialysis_conunt", "data_name": "透析パターン回数", "data_type": "decimal", "conv_table": [], "data_class": "透析パターン", "field_name": "dialysis_conunt", "disp_format": "0", "data_category": "指示", "facility_table": "", "facility_filter_type": "0"}, {"preview": "月", "can_calc": "0", "data_code": "treat_week", "data_name": "透析パターン曜日", "data_type": "string", "conv_table": [], "data_class": "透析パターン", "field_name": "treat_week", "disp_format": "", "data_category": "指示", "facility_table": "", "facility_filter_type": "0"}]', '0', '{"applications": [1]}', '{"classes": [1, 2, 9]}', '指示：透析パターン', '2021-12-16 17:10:00', '2021-12-16 16:10:00', NULL);
