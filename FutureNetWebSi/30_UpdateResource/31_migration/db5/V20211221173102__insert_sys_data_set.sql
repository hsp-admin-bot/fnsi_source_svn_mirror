delete from "sys_data_set" where "sql_cd" in (-207,-208,-209,-1003);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-207, 'WITH pre_dat AS ( 
  SELECT
    ord.ord_no
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_kur AS mkr ON mkr.kur_cd = ord.ind_kur_cd AND mkr.is_del = ''0''
  WHERE
    ord.ord_no = @ordNo
) 
SELECT
...
FROM
  ...
  LEFT OUTER JOIN mst_bed AS mbd ON mbd.bed_cd = ord.ind_bed_cd AND mbd.is_del = ''0''
  LEFT OUTER JOIN mst_treatment AS mtt ON mtt.treatment_cd = ord.ind_treatment_cd AND mtt.is_del = ''0''
WHERE
  ord.ord_no = @ordNo', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'NECiS)透析予約の透析指示情報を取得する', '2021-12-20 09:00:00', '2021-12-20 09:00:00', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-208, 'WITH department_source_info AS ( 
...
, DepartmentStaffInfoSrc AS ( 
  ...
  FROM
    ...
    LEFT OUTER JOIN mst_course AS course ON course.course_cd ::TEXT = pat.medical_care_info ->> ''main_course_cd'' AND course.is_del = ''0'' 
...
FROM
  DepartmentStaffInfoNoDefault AS info', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'NECiS)透析予約の(依頼科コード、依頼医コード)を取得する', '2021-12-20 09:00:00', '2021-12-20 09:00:00', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-209, 'WITH ini_data AS ( 
  SELECT
...
, dialysis_detail AS ( 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_va AS mva ON mva.va_cd = TO_NUMBER(NULLIF(ord.ind_cond_info -> ''2'' ->> ''value'', ''0''), ''FM999999999999'') AND mva.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo
  -- (5) ダイアライザ
  UNION 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_dialyzer AS mdr ON mdr.dialyzer_cd = TO_NUMBER(ord.ind_cond_info -> ''5'' ->> ''value'', ''FM999999999999'') AND mdr.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  -- (6) 抗凝固剤(単体薬剤時)
  UNION 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_medicine AS med25 ON med25.medicine_cd = TO_NUMBER(ord.ind_cond_info -> ''25'' ->> ''value'', ''FM999999999999'') AND med25.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_medicine_mix AS mmx ON mmx.medicine_mix_cd = TO_NUMBER(ord.ind_cond_info -> ''25'' ->> ''value'', ''FM999999999999'') AND mmx.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ...
    LEFT OUTER JOIN mst_medicine AS mmd ON mmd.medicine_cd = TO_NUMBER(medi ->> ''cd'', ''FM999999999999'') AND mmd.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_medicine AS med15 ON med15.medicine_cd = TO_NUMBER(ord.ind_cond_info -> ''15'' ->> ''value'', ''FM999999999999'') AND med15.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_medicine AS med19 ON med19.medicine_cd = TO_NUMBER( ord.ind_cond_info -> ''19'' ->> ''value'', ''FM999999999999'') AND med19.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    CROSS JOIN LATERAL json_array_elements(ord.ind_medi_info ::json) medi 
    LEFT OUTER JOIN mst_medicine_mix AS mmx ON mmx.medicine_mix_cd = TO_NUMBER(medi ->> ''cd'', ''FM999999999999'') AND mmx.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_medicine_mix AS mmmx ON mmmx.medicine_mix_cd = TO_NUMBER( ord.ind_cond_info -> ''15'' ->> ''value'', ''FM999999999999'') AND mmmx.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_medicine_mix AS mmmmx ON mmmmx.medicine_mix_cd = TO_NUMBER( ord.ind_cond_info -> ''19'' ->> ''value'', ''FM999999999999'') AND mmmmx.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_equipment AS meq ON meq.equipment_cd = TO_NUMBER( ord.ind_cond_info -> ''9'' ->> ''value'', ''FM999999999999'') AND meq.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_equipment AS meq ON meq.equipment_cd = TO_NUMBER( ord.ind_cond_info -> ''10'' ->> ''value'', ''FM999999999999'') AND meq.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_equipment AS meq ON meq.equipment_cd = TO_NUMBER( ord.ind_cond_info -> ''11'' ->> ''value'', ''FM999999999999'') AND meq.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ...
    LEFT OUTER JOIN mst_equipment AS meq ON meq.equipment_cd = TO_NUMBER(equip ->> ''cd'', ''FM999999999999'') AND meq.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_equipment AS meq ON meq.equipment_cd = TO_NUMBER( ord.ind_cond_info -> ''6'' ->> ''value'', ''FM999999999999'') AND meq.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_equipment AS meq ON meq.equipment_cd = TO_NUMBER( ord.ind_cond_info -> ''7'' ->> ''value'', ''FM999999999999'') AND meq.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
  ...
  FROM
    ord_main AS ord 
    LEFT OUTER JOIN mst_equipment AS meq ON meq.equipment_cd = TO_NUMBER( ord.ind_cond_info -> ''8'' ->> ''value'', ''FM999999999999'') AND meq.is_del = ''0'' 
  WHERE
    ord.ord_no = @ordNo 
...
FROM
  dialysis_detail 
ORDER BY
  function_id ASC, item_code ASC', 2, '[{}]', '0', '{"applications": [4]}', NULL, 'NECiS)透析予約の透析指示明細を取得する', '2021-12-20 09:00:00', '2021-12-20 09:00:00', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-1003, 'WITH send_range_info AS ( 
  SELECT
    CASE TRIM(ini_info ->> ''value'') 
      WHEN '''' THEN TRIM(ini_info ->> ''default_v'') 
      WHEN ''NULL'' THEN TRIM(ini_info ->> ''default_v'') 
...
, update_terminal_info AS ( 
  SELECT
    CASE TRIM(ini_info ->> ''value'') 
      WHEN '''' THEN TRIM(ini_info ->> ''default_v'') 
      WHEN ''NULL'' THEN TRIM(ini_info ->> ''default_v'') 
      ELSE TRIM(ini_info ->> ''value'') 
      END AS update_terminal 
  FROM
    mst_coop_ini AS ini 
    CROSS JOIN LATERAL json_array_elements(ini.coop_ini_info ::json) AS ini_info 
  WHERE
    ...
    AND ini.facility_cd = @facilityCd
    AND TRIM(ini_info ->> ''key1'') = ''NECIS_SCHE_DIAL'' 
    AND TRIM(ini_info ->> ''key2'') = ''UPDATE_TERMINAL''
)
SELECT
  ...
  , (SELECT update_terminal FROM update_terminal_info) AS update_terminal
', 2, '[{}]', '0', '{"applications": [4]}', NULL, '(送信用)NEC-iS(MegaOakiS)の連携設定内容を取得する', '2021-12-20 09:00:00', '2021-12-20 09:00:00', NULL);
