...
WHERE sql_cd IN (-1103001);

DELETE FROM ntss.sys_data_set
WHERE sql_cd IN (-1103003);
...
-- SQL: -1103001 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(送信用)セコムの透析実績連携', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 
'[
    {
        "sql_cd": -1100016,
    ...
    {
        "sql_cd": -1102004,
        "field_name": "pat_personal_info",
        "replace_var": "@patPersonalInfo"
    }
]'::jsonb);
...
-- SQL: -1103003 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_オーダーインデックス', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 
'[
    {
        "sql_cd": -1100016,
        "field_name": "dump_result",
