delete FROM "sys_data_set" WHERE sql_cd IN (-307016,-307017,-307018,-307019,-307020,-307021,-307022,-307023,-307024,-307025,-307026,-307027);
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	...
	where
        ...
        and ord_medi_info ->> ''procedure_name'' = ''静注''
	...
	where
		ord_no = @ordNo
		and ord_main.is_del = ''0''
        and ord_treatment_info ->> ''procedure_name'' = ''静注''
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	...
	where
		...
		and ord_main.is_del = ''0''
		and ord_medi_info ->> ''effect_flg'' = ''1''
        and ord_medi_info ->> ''procedure_name'' = ''筋注''
		and ord_medi_info ->> ''medicine_type'' = ''1''
		and (ord_medi_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
	...
	where
		ord_no = @ordNo
		and ord_main.is_del = ''0''
        and ord_treatment_info ->> ''procedure_name'' = ''筋注''
		and ord_treatment_info ->> ''medicine_type'' = ''1''
		and (ord_treatment_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	...
	where
		...
		and ord_main.is_del = ''0''
		and ord_medi_info ->> ''effect_flg'' = ''1''
        and ord_medi_info ->> ''procedure_name'' = ''皮内注''
		and ord_medi_info ->> ''medicine_type'' = ''1''
		and (ord_medi_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
	...
	where
		ord_no = @ordNo
		and ord_main.is_del = ''0''
        and ord_treatment_info ->> ''procedure_name'' = ''皮内注''
		and ord_treatment_info ->> ''medicine_type'' = ''1''
		and (ord_treatment_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	...
	where
		...
		and ord_main.is_del = ''0''
		and ord_medi_info ->> ''effect_flg'' = ''1''
        and ord_medi_info ->> ''procedure_name'' = ''皮下注''
		and ord_medi_info ->> ''medicine_type'' = ''1''
		and (ord_medi_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
	...
	where
		ord_no = @ordNo
		and ord_main.is_del = ''0''
        and ord_treatment_info ->> ''procedure_name'' = ''皮下注''
		and ord_treatment_info ->> ''medicine_type'' = ''1''
		and (ord_treatment_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	...
	where
		...
		and ord_main.is_del = ''0''
		and ord_medi_info ->> ''effect_flg'' = ''1''
        and ord_medi_info ->> ''procedure_name'' = ''点滴''
		and ord_medi_info ->> ''medicine_type'' = ''1''
		and (ord_medi_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
	...
	where
		ord_no = @ordNo
		and ord_main.is_del = ''0''
        and ord_treatment_info ->> ''procedure_name'' = ''点滴''
		and ord_treatment_info ->> ''medicine_type'' = ''1''
		and (ord_treatment_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	...
	where
		...
		and ord_main.is_del = ''0''
		and ord_medi_info ->> ''effect_flg'' = ''1''
        and ord_medi_info ->> ''procedure_name'' = ''特注''
		and ord_medi_info ->> ''medicine_type'' = ''1''
		and (ord_medi_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
	...
	where
		ord_no = @ordNo
		and ord_main.is_del = ''0''
        and ord_treatment_info ->> ''procedure_name'' = ''特注''
		and ord_treatment_info ->> ''medicine_type'' = ''1''
		and (ord_treatment_info ->> ''amount'') :: numeric > 0
	UNION
	ALL
    ...
    --調整薬剤の抗凝固剤
	select
		t.idx as registration_order,
		mmxd ->> ''cd'' as medicine_cd,
		CASE
			mmxd ->> ''solvent''
			WHEN ''0'' THEN round(
				((ord_main.rst_cond_info->''26''->>''value'') :: NUMERIC + (ord_main.rst_cond_info->''28''->>''value'') :: NUMERIC)* (mmxd ->> ''amount'') :: NUMERIC,
				2
			)
			WHEN ''1'' THEN round((mmxd ->> ''amount'') :: NUMERIC, 2)
		END as amount,
		mst_medicine.class_cd as class_cd,
		''2'' as medicine_type,
        ''1'' as timing_cd,
	...
	from
		ord_main
		LEFT JOIN mst_medicine_mix on ord_main.rst_cond_info->''25''->>''value'' = mst_medicine_mix.medicine_mix_cd :: text
		cross JOIN LATERAL json_array_elements(mst_medicine_mix.mix_info :: json) WITH ORDINALITY AS t(mmxd, idx)
		LEFT JOIN mst_medicine on mmxd ->> ''cd'' = mst_medicine.medicine_cd :: text
		LEFT JOIN mst_medicine_class on mst_medicine.class_cd = mst_medicine_class.class_cd
	where
		ord_no = @ordNo
		and ord_main.is_del = ''0''
		and ord_main.rst_cond_info->''25''->>''medicine_type'' = ''2''
		and (ord_main.rst_cond_info->''26''->>''value'') :: numeric > 0
		and mst_medicine_class.class_name not in(''抗凝固剤'')
 )
 , medicine_in_hospital_cd_no as (
	--薬剤マスタの参照する連携コード
	select
