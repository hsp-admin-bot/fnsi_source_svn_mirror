...
VALUES(-2450, 'WITH
  ...
  ntss_db5_pm_dsi AS (
    ...
    FROM
      ntss_db5_pm
      JOIN json_each_text(ntss_db5_pm.device_set_info :: JSON) AS keysandvalue ON TRUE
      JOIN json_each_text((keysandvalue.VALUE :: JSON #>> ''{dev,B}'') :: JSON) AS value_3 ON TRUE
    WHERE
      ntss_db5_pm.device_set_info IS NOT NULL
      AND ntss_db5_pm.device_set_info <> ''[]''
      AND value_3.KEY IS NOT NULL
    ...
    FROM
      ntss_db5_pm
      JOIN json_each_text(ntss_db5_pm.device_set_info :: JSON) AS keysandvalue ON TRUE
      JOIN json_each_text((keysandvalue.VALUE :: JSON #>> ''{pat,A}'') :: JSON) AS value_3 ON TRUE
    WHERE
      ntss_db5_pm.device_set_info IS NOT NULL
      AND ntss_db5_pm.device_set_info <> ''[]''
      AND value_3.KEY IS NOT NULL
    ...
    FROM
      ntss_db5_pm
      JOIN json_each_text(ntss_db5_pm.device_set_info :: JSON) AS keysandvalue ON TRUE
      JOIN json_each_text((keysandvalue.VALUE :: JSON #>> ''{pat,B}'') :: JSON) AS value_3 ON TRUE
    WHERE
      ntss_db5_pm.device_set_info IS NOT NULL
      AND ntss_db5_pm.device_set_info <> ''[]''
      AND value_3.KEY IS NOT NULL
  ...
  yellow_idsi AS (
    ...
    FROM
      ntss_db5_ptp_week
      JOIN json_each_text(ntss_db5_ptp_week.ind_device_set_info :: JSON) AS keysandvalue ON TRUE
      JOIN json_each_text((keysandvalue.VALUE :: JSON #>> ''{dev,A}'') :: JSON) AS value_3 ON TRUE
    WHERE
    ...
    FROM
      ind_ord_main
      JOIN json_each_text(ind_ord_main.ind_device_set_info :: JSON) AS keysandvalue ON TRUE
      JOIN json_each_text((keysandvalue.VALUE :: JSON #>> ''{dev,A}'') :: JSON) AS value_3 ON TRUE
    WHERE
  ...
  ntss_db5_pu_physical AS (
    ...
    FROM
      ...
      CROSS JOIN LATERAL json_array_elements(ntss_db5_pu.physical_info :: json) AS physical_info_json
  ),
  ind_cond_info AS (
    SELECT
