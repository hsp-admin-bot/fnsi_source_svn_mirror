...
WHERE ctl_no IN (-6020001, -6020002, -6020003,-6050002,-6050003);
  ...
  <dump>
    <rootNode>
      ...
      <PAT_BASIC_INFO>
        ...
        <!-- 医師1 -->
        <DOCTOR_CD1>auth_id:-436.staff_cd1</DOCTOR_CD1>
        <!-- 医師2 -->
        <DOCTOR_CD2>auth_id:-436.staff_cd2</DOCTOR_CD2>
        <MST_PAT_GROUP>
          <!-- 科コード -->
