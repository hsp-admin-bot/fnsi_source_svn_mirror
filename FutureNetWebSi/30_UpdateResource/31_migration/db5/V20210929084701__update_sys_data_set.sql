...
SET sql = 'with machine_tbl as (
  ...
  where
    mmr.event_reg_date between date_trunc(''day'', ''2021-02-01 00:00:00'' ::timestamp ) and date_trunc(''day'', ''2021-04-01 00:00:00'' ::timestamp) + ''1 days - 1 milliseconds''
  and
    mmr.data_type = 4
