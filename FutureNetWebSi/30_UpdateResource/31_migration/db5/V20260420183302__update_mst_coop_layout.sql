...
WHERE ctl_no IN (-6020001, -6020002, -6020003, -6030001, -6030002, -6050001, -6050002, -6050003);
  ...
  <dump>
    <rootNode>
      ...
      <PAT_BASIC_INFO>
        ...
        <!-- 医師1 -->
        <DOCTOR_CD1>auth_id:-604199.staff_cd1</DOCTOR_CD1>
        <!-- 医師2 -->
        <DOCTOR_CD2>auth_id:-604199.staff_cd2</DOCTOR_CD2>
        <MST_PAT_GROUP>
          <!-- 科コード -->
...
', '{"dataset": [{"patId": "patId", "sqlCode": -200001}, {"key0": "key0", "ordNo": "ordNo", "patId": "patId", "sqlCode": -436, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -437}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -438}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -439}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -440}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -441}, {"ordNo": "ordNo", "sqlCode": -604104}, {"ordNo": "ordNo", "sqlCode": -604108}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -604153}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -604157}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -604161}, {"ctlNo": "ctlNo", "ordNo": "ordNo", "sqlCode": -604901}, {"sqlCode": -610903, "facilityCd": "facilityCd"}, {"key0": "key0", "sqlCode": -610004, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -610905, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -604199, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'CSI');
INSERT INTO mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"patId": "patId", "sqlCode": -200001}, {"key0": "key0", "ordNo": "ordNo", "patId": "patId", "sqlCode": -436, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -437}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -438}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -439}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -440}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -441}, {"ordNo": "ordNo", "sqlCode": -604104}, {"ordNo": "ordNo", "sqlCode": -604108}, {"ctlNo": "ctlNo", "sqlCode": -604165}, {"ctlNo": "ctlNo", "ordNo": "ordNo", "sqlCode": -604901}, {"sqlCode": -610903, "facilityCd": "facilityCd"}, {"key0": "key0", "sqlCode": -610004, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -610905, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -604199, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'CSI');
INSERT INTO mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
  ...
  <dump>
    <rootNode>
      ...
      <RST_DIALYSIS_HST>
        ...
        <!--透析実績履歴・透析時間-->
        <DIALYSIS_TIME>dataset:-444.dialysis_time</DIALYSIS_TIME>
        <!--透析実績履歴・病棟コード-->
      ...
      <RST_DIALYSIS_EDITION>
        <!--透析実績版番管理.版確定者-->
        <DECIDER>auth_id:-610901.user_id</DECIDER>
        <!--スタッフマスタ:版確定者-->
        <!--MST_STAFF STAFF_CD="D100"-->
        <MST_STAFF>
          <STAFF_CD>auth_id:-610901.user_id</STAFF_CD>
          <!-- スタッフマスタ.職種コード-->
          <JOB_CLASS_CD>dataset:-607003.is_doctor</JOB_CLASS_CD>
        </MST_STAFF>
      </RST_DIALYSIS_EDITION>
      <RST_RECEIPT_MEMO_HST _sqlCode="-448" NAME="dataset:-448.detail_id" >
        <!-- 4.透析困難コメント:主たる透析困難コメントフラグ-->
        <!-- 透析困難コメント -->
        <DIVISION>0</DIVISION>
        <ADD_FLG>dataset:-448.is_dial_diff</ADD_FLG>
<MAIN_DIAL_DIFF>dataset:-448.is_main</MAIN_DIAL_DIFF>
        <ITEM_NAME>dataset:-448.dialysis_difficulty_name</ITEM_NAME>
      </RST_RECEIPT_MEMO_HST>
      <!-- 
      <RST_DIALYSIS_COND_HST _sqlCode="-604180" CTL_NO="008" NAME="加算">
        <CTL_NO>008</CTL_NO>
        <VALUE>dataset:-604180.ad_in_hospital_cd</VALUE>
        <MST_TREAT_ITEM>
          <IN_HOSPITAL_CD/>
          <TREAT_ITEM_NAME/>
        </MST_TREAT_ITEM>
        ...
        <MST_DIALYZER>
          <IN_HOSPITAL_CD>dataset:-604180.ad_in_hospital_cd</IN_HOSPITAL_CD>
        </MST_DIALYZER>
        <MST_EQUIPMENT>
          <IN_HOSPITAL_CD/>
        </MST_EQUIPMENT>
      ...
      <EXAM_FREE_DATA_DETAIL>#karte_content#</EXAM_FREE_DATA_DETAIL>
      <SYS_COOP_EXEC_DATA>
        <A00001>
          <SYS_STAFF_AUTH>
            <ACL>dataset:-604901.acl</ACL>
...
', '{"dataset": [{"patId": "patId", "sqlCode": -200001}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -442}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -443}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -610001}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -610003}, {"key0": "key0", "sqlCode": -610004, "facilityCd": "facilityCd"}, {"ctlNo": "ctlNo", "sqlCode": -610902}, {"sqlCode": -610903, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -610904}, {"patId": "patId", "sqlCode": -610905, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -604199, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'CSI');
INSERT INTO mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"patId": "patId", "sqlCode": -200001}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -442}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -443}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -610001}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -610003}, {"ctlNo": "ctlNo", "sqlCode": -610901}, {"ctlNo": "ctlNo", "sqlCode": -610902}, {"sqlCode": -610903, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -610904}, {"key0": "key0", "sqlCode": -610004, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -610905, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -604199, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'CSI');