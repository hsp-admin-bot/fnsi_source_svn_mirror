delete from "mst_coop_layout" where "ctl_no" in (-2080011,-2080010,-2080009,-2080008,-2080007,-2080006,-2080005,-2080004,-2080003,-2080002,-2080001);
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2080011, 'F_hosp', 'rep_dial', 'tar', 'S', 'upd', 'xml', 'xml', 'fujitsu', 'report', '1', '<rootNode>
...
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2080010, 'F_hosp', 'rep_dial', 'tar', 'S', 'cre', 'xml', 'xml', 'fujitsu', 'report', '1', '<rootNode>
  <PATIENT UPDATE_DATETIME="dataset:-100001.up_date">
    <DISP_PATID>dataset:-100001.hosp_pat_id</DISP_PATID>
    <PATID>$JOURNAL.pat_id</PATID>
    <NAME>dataset:-100001.pat_name</NAME>
...
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2080007, 'F_hosp', 'rep_dial', 'xml', 'S', 'upd', 'xml', 'xml', 'fujitsu', 'report', '1', '<rootNode>
  <PATIENT UPDATE_DATETIME="dataset:-100001.up_date">
    <DISP_PATID>dataset:-100001.hosp_pat_id</DISP_PATID>
    <PATID>$JOURNAL.pat_id</PATID>
    <NAME>dataset:-100001.pat_name</NAME>
...
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2080006, 'F_hosp', 'rep_dial', 'xml', 'S', 'cre', 'xml', 'xml', 'fujitsu', 'report', '1', '<rootNode>
  <PATIENT UPDATE_DATETIME="dataset:-100001.up_date">
    <DISP_PATID>dataset:-100001.hosp_pat_id</DISP_PATID>
    <PATID>$JOURNAL.pat_id</PATID>
    <NAME>dataset:-100001.pat_name</NAME>
...
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2080005, 'F_hosp', 'rep_dial', 'pdf', 'S', 'upd', 'pdf', 'pdf', 'fujitsu', 'report', '1', NULL, NULL, '1', '0', 4, '2020-05-25 18:26:36.811', CURRENT_TIMESTAMP);
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2080004, 'F_hosp', 'rep_dial', 'pdf', 'S', 'cre', 'pdf', 'pdf', 'fujitsu', 'report', '1', NULL, NULL, '1', '0', 4, '2020-05-25 18:26:36.811', CURRENT_TIMESTAMP);
...
</root>', '{"dataset": [{"ordNo": "ordNo", "sqlCode": -55, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -100001}, {"patId": "patId", "sqlCode": -11}, {"ordNo": "ordNo", "sqlCode": -22}, {"ordNo": "ordNo", "sqlCode": -104}]}', '1', '0', 4, '2025-01-02 18:26:36.811', CURRENT_TIMESTAMP);
...
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2080001, 'F_hosp', 'rep_dial', '', 'S', 'cre', 'text', 'fujitsu', 'fujitsu', 'report', '1', '<root name="透析レポート">
    ...
    <item  name="レポート情報" len="29" value="const:&quot; width=&quot;100%25&quot; height=&quot;100%25&quot;&gt;"/>
    <item  name="終端" len="1" value="$CR"/>
</root>', '{"dataset": [{"ordNo": "ordNo", "sqlCode": -55, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -100001}, {"patId": "patId", "sqlCode": -11}, {"ordNo": "ordNo", "sqlCode": -22}, {"ordNo": "ordNo", "sqlCode": -104}]}', '1', '0', 4, '2020-05-25 18:26:36.811', CURRENT_TIMESTAMP);
