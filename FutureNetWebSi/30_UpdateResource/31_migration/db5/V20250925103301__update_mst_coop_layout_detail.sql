...
WHERE ctl_no=-1111000008 AND coop_cd_detail='karte_ord_all';
DELETE FROM ntss.mst_coop_layout_detail
WHERE ctl_no=-1117000000;
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-1117000000, 'Secom', 'karte_ord', 'S', 'karte_ord_all', '01', 'セコム連携_指示変更履歴', 'セコム連携_指示変更履歴', '1', '<root name="指示変更履歴_カルテ記録ファイル" useSharedSysdate="true">
