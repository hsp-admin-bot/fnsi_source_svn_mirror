...
-- コメント修正
COMMENT ON COLUMN "mst_medicine_set"."in_hospital_cd_1" IS E'院内コード1';
COMMENT ON COLUMN "mst_medicine_set"."in_hospital_cd_2" IS E'院内コード2';