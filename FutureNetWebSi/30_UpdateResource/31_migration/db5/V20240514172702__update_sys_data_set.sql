...
SELECT
	...
	from
	    ...
	    LEFT JOIN (
	        ...
	        AND union_tmp.facilitycd = ntss_db5_mst_sel.facility_cd;', 3, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者病歴情報　@facilityCd使用 {"Mergekey": ["patid"]}', '2021-02-26 17:51:54.726', CURRENT_TIMESTAMP, NULL);
