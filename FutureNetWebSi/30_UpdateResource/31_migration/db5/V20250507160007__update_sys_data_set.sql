DELETE FROM "ntss"."sys_data_set" where sql_cd in (10,11,243);
...
SELECT * from result_all as res @orderBy	', 2, '[]', '1', '{"applications": [1]}', '{"classes": [6]}', '配布リスト(物品)（SQL11降順）', '2025-03-19 18:29:56.853', '2025-05-14 19:05:16.813', NULL);
