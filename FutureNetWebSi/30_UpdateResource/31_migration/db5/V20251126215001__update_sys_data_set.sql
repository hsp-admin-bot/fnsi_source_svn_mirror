...
WHERE
  ...
  OR
  (
    0 <= (COALESCE(NULLIF(@indCondInfo.039.value, '''')::NUMERIC, 0) / 100)
    AND 300 >= (COALESCE(NULLIF(@indCondInfo.039.value, '''')::NUMERIC, 0) / 100)
  );
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(DW)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500092, '
SELECT
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(目標体重)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500093, 'WITH ssi_order_recv_info AS ( 
  SELECT
    info->>''key2'' AS key2
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(除水量制限)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500094, '
SELECT
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(血流量)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500095, '
SELECT
...
WHERE
  ...
  OR
  (
    0 <= (COALESCE(NULLIF(@indCondInfo.026.value, '''')::NUMERIC, 0) / 100)
    AND 9999999 >= (COALESCE(NULLIF(@indCondInfo.026.value, '''')::NUMERIC, 0) / 100)
  );
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(抗凝固剤ワンショット量)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500096, '
SELECT
...
WHERE
  ...
  OR
  (
    0 <= (COALESCE(NULLIF(@indCondInfo.027.value, '''')::NUMERIC, 0) / 100)
    AND 9999999 >= (COALESCE(NULLIF(@indCondInfo.027.value, '''')::NUMERIC, 0) / 100)
  );
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(抗凝固剤持続総量)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(IPワンショット量)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
WHERE
  ...
  ;
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(IP速度)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500099, '
SELECT
...
WHERE
  ...
  OR
  (
    0 <= (COALESCE(NULLIF(@indCondInfo.017.value, '''')::NUMERIC, 0) / 100)
    AND 700 >= (COALESCE(NULLIF(@indCondInfo.017.value, '''')::NUMERIC, 0) / 100)
  );
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(透析液流量)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500100, '
SELECT
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(透析液温度)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500101, '
SELECT
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(補液使用数)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(補液速度)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(IP電源OKモニタ切り時間)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
WHERE
  ...
  );', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(開始日時)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500106, '
SELECT
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(投薬オーダ情報の数量)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500107, '
SELECT
...
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)SSIの入力値チェック(医材オーダ情報の数量)', '2025-11-24 16:11:44.360', '2025-11-24 16:11:44.360', NULL);
