delete from  "sys_data_set" where "sql_cd" in (1202,1203,1206,1207);
...
', '2022-01-28 18:21:40', CURRENT_TIMESTAMP, '[{"sql_cd": 1002, "field_name": "pat_memo_info", "replace_var": "@patMemoInfo"}, {"sql_cd": 1003, "field_name": "infect_info", "replace_var": "@infectInfo"}, {"sql_cd": 1004, "field_name": "addition_info", "replace_var": "@additioninfo"}]');
...
', '2022-01-28 18:21:40', CURRENT_TIMESTAMP, NULL);
