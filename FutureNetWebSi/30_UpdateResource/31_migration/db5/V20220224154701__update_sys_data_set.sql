delete from "sys_data_set" where "sql_cd" in (-11);
INSERT INTO "ntss"."sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-11, 'WITH default_bed_code_conv AS (
  -- ベッド の連携設定で切り替え 
  SELECT
    0 AS order_no
...
--mbd.bed_cd as bed_cd,--ベッドコード
  ...
  --COALESCE(mbd.in_hospital_cd_1, '''') AS bed_cd,
