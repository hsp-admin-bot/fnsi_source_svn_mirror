...
', '{"dataset": [], "dumpFileName": {"ctlNo": "ctlNo", "patId": "patId", "sqlCode": -99995}}'::jsonb, '1', '0', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'F_SX');
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'F_SX');
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
<!--  <item name="改行" len="1" value="$CR"/> -->
<!--  <occ name="明細.検査項目" len="0" detail="検査項目" sqlCode="-453"/> -->
</root>', '{"dataset": [], "dumpFileName": {"ctlNo": "ctlNo", "patId": "patId", "sqlCode": -99995}}'::jsonb, '1', '0', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'F_SX');
