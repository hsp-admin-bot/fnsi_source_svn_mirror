...
, b.rst_start_date
, b.rst_end_date            
order by b.ord_no, d.data_type desc, b.treat_date,  f.bio_moni_ctl_no', 2, '[]', '1', '{"applications": [1]}', '{"classes": [3]}', '治療状況リスト(「？？？？」患者)', '2024-04-26 14:31:38', CURRENT_TIMESTAMP, NULL);
