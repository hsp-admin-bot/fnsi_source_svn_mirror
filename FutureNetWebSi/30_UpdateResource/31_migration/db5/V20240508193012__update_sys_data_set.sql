DELETE FROM ntss.sys_data_set WHERE sql_cd IN (9120);
...
WHERE
  ...
  AND pat_id = @patId 
  AND facility_cd = ''@facilityCd'' ', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)NEC治療情報「指示情報」の削除', '2021-11-23 12:12:12.000', CURRENT_TIMESTAMP, NULL);