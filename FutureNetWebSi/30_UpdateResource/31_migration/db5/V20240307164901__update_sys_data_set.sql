...
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (-109, e'with ord_maincopy_do as (SELECT ord_no,
                                null as del_date,
                                pat_id,
                                fn_pat_id,
                                treat_date,
...
where Alldoctor.staff_cd is not null
	...
	', 2, '[]', '0', '{"applications": [4]}', '{"classes": []}', '(受信用)日機装)連携設定:医師コード', '2022-06-09 17:05:03.000', CURRENT_TIMESTAMP, null);
