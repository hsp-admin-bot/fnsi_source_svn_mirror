...
', '{"dataset": [{"ordNo": "-317121.ordNo", "sqlCode": -317125, "facilityCd": "-317121.facilityCd", "pat_event_cd": "-317121.pat_event_cd"}]}'::jsonb, '1', '0', 5843, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'MED');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"ordNo": "-317122.ordNo", "sqlCode": -317126, "facilityCd": "-317122.facilityCd", "pat_event_cd": "-317122.pat_event_cd"}]}'::jsonb, '1', '0', 5843, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'MED');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"ordNo": "-317123.ordNo", "sqlCode": -317127, "facilityCd": "-317123.facilityCd", "pat_event_cd": "-317123.pat_event_cd"}]}'::jsonb, '1', '0', 5843, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'MED');
