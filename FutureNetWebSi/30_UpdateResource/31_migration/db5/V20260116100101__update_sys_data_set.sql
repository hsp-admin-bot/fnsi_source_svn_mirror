      ...
      SELECT
          ...
          AND dz.is_disp = ''1''
                ...
                WHERE
                    ...
                    AND eqi ->> ''equip_type'' = ''1'' UNION ALL--医材
                SELECT
                    CASE WHEN @dataTypeOrder = ''0'' THEN 2
           WHEN @dataTypeOrder = ''1'' THEN 3
           WHEN @dataTypeOrder = ''2'' THEN 1
           ...
           ELSE 1  END AS disp_order,
                ...
                WHERE
                    ...
                    AND eqi ->> ''equip_type'' = ''0'' UNION ALL--抗凝固剤(調製薬剤)
            SELECT
...
SELECT * ,res.pat_id as pat_Id1 ,res.pat_id as pat_Id2 ,res.pat_id as pat_Id3 FROM result_all as res @orderBy            ', 2, '[]'::jsonb, '1', '{"applications": [1]}'::jsonb, '{"classes": [8]}'::jsonb, 'ラベル（降順）', '2024-03-20 08:56:21.000', CURRENT_TIMESTAMP, NULL);