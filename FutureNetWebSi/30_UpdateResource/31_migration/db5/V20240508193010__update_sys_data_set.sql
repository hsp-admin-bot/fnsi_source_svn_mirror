DELETE FROM ntss.sys_data_set WHERE sql_cd IN (9114);
...
WHERE
  ...
  AND treat_date = @treatDate', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)NECの治療情報(SELECT)', '2021-11-23 12:12:12.000', CURRENT_TIMESTAMP, NULL);
