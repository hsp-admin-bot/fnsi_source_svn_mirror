...
WHERE ctl_no IN(-607000001,-607000002,-607000003,-607000004)
;
...
', '{"dataset": [{"ctlNo": "-604174.ctl_no", "ordNo": "-604174.ord_no", "sqlCode": -604167}, {"ctlNo": "-604174.ctl_no", "ordNo": "-604174.ord_no", "sqlCode": -604175}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"amount": "-604175.amount", "sqlCode": -604176, "medicineCd": "-604175.medicine_cd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"ctlNo": "-604177.ctl_no", "ordNo": "-604177.ord_no", "sqlCode": -604168}, {"ctlNo": "-604174.ctl_no", "ordNo": "-604174.ord_no", "sqlCode": -604178}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"amount": "-604178.amount", "sqlCode": -604179, "medicineCd": "-604178.medicine_cd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '');
