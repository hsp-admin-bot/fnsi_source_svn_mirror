...
INSERT INTO "ntss"."sys_data_set" ("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (262, 'with machine_tbl AS (
	SELECT
		mm.*,
		mmt.machine_type
	FROM
...
, water_survey_point_tb AS (
	...
	LEFT JOIN machine_tbl AS mt ON mwsp.machine_no = mt.machine_no
