 ...
 , pat_last_name_kana = 
  ...
  , pat_contact_info = CASE ''@patContactInfoFlg'' 
    ...
    ELSE json_build_object( 
      ...
      , ''tel2''
      , NULLIF(COALESCE(''@patContactInfo.tel2'', trim(both ''"'' from personal_info_decrypt(pat_contact_info ->> ''tel2''))), '''')
      , ''fax''
      , NULLIF(COALESCE(''@patContactInfo.fax'', trim(both ''"'' from personal_info_decrypt(pat_contact_info ->> ''fax''))), '''')
      , ''e_mail''
