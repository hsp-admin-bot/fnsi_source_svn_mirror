delete from "mst_coop_layout" where "ctl_no" in (-6020001,-6020002,-6020003,-6030001,-6030002,-6030003,-6050001,-6050002,-6050003);
        ...
        <rootNode>
            ...
            <PAT_EXAMIN_SCHEDULE>
                ...
                <MST_STAFF STAFF_CD="dataset:-442.ind_user_id">
                    <!-- 職種コード -->
                    <JOB_CLASS_CD>job_cd:-442.ind_user_id</JOB_CLASS_CD>
                </MST_STAFF>
                <!-- 検査区分 -->
