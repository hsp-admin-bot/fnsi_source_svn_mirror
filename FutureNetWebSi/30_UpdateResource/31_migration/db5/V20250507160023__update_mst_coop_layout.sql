...
VALUES(-1010012, 'nkknkk', 'rep_dial', 'xml', 'S', 'del', 'xml', '日機装 透析レポート(xml)', '日機装', 'テスト用report', '1', '<rootNode>
...
', '{"dataset": [{"patId": "patId", "sqlCode": -400001}, {"ordNo": "ordNo", "sqlCode": -400019}]}'::jsonb, '1', '0', -1, '2022-07-04 12:22:10.543', now(), 'NKK');
