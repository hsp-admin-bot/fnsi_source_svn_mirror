delete from mst_coop_layout where ctl_no = -1040003;
INSERT INTO "ntss"."mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1040003, 'nkknkk', 'ind_dial', '', 'S', 'del', 'text', '日機装標準', 'nikkiso', '透析予約', '1', '<root name="日機装標準(透析予約)" multi="true:CRLF">
    ...
    <item  name="担当医" len="10" value="dataset:-131.ind_name10"/>
...
</root>', '{"dataset": [{"patId": "patId", "sqlCode": -400001}, {"ordNo": "ordNo", "sqlCode": -131}, {"ordNo": "ordNo", "sqlCode": -181, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -191}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -99992}, "CoopIniConvUtil": {"-400001.in_out_class": "CONV_INOUT_TO_KARTE"}}', '1', '0', -4, '2020-04-10 17:01:04.743', CURRENT_TIMESTAMP);
