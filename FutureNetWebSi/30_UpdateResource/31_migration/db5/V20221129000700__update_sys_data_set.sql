DELETE FROM ntss.sys_data_set where sql_cd in (-24,-662,-663,-44,-26);
INSERT INTO "ntss"."sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-24, 'with rst_kur_cd as (
...
then ''Satur'' 
 when 7 =(select reg_exam_date from weekend)		
then ''Sun'' 
END ) as aaa))::json->>''disp_user_id'' as staff_cd from mst_kur mst where  mst.kur_cd = (select rst_kur_cd from rst_kur_cd)),
