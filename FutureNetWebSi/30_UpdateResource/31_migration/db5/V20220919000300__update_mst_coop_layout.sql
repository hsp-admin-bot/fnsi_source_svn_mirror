DELETE FROM "ntss"."mst_coop_layout" WHERE ctl_no in (-1070004, -1070005, -1070006);
INSERT INTO "ntss"."mst_coop_layout" ("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1070004, 'nkknkk', 'rst_dial', '', 'S', 'cre', 'text', '日機装拡張', 'nikkiso', '透析実績(拡張)', '1', '<root name="日機装拡張(透析実績)" multi="true:CRLF">
    <item  name="処理日時" len="14" value="dataset:-515.sys_date"/>
    <item  name="処理区分" len="1" value="dataset:-516.type_cd"/>
    ...
    <item  name="透析番号" len="12" value="dataset:-518.coop_ord_no" padding_format="zero" padding_position="left"/>
...
INSERT INTO "ntss"."mst_coop_layout" ("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1070006, 'nkknkk', 'rst_dial', '', 'S', 'del', 'text', '日機装拡張', 'nikkiso', '透析実績(拡張)', '1', '<root name="日機装拡張(透析実績)" multi="true:CRLF">
    <item  name="処理日時" len="14" value="dataset:-515.sys_date"/>
    <item  name="処理区分" len="1" value="dataset:-517.type_cd"/>
    <item  name="指示診療No" len="10" value="dataset:-108.ord_no"/>
