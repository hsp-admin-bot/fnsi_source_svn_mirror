DELETE FROM "ntss"."sys_data_set" WHERE sql_cd IN (-101, -20);
INSERT INTO "ntss"."sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-20, 'select 
...
where
	pat_id = @patId ', 3, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）入外区分', '2020-04-10 17:18:50', CURRENT_TIMESTAMP, NULL);
...
FROM data_middle_all 
		LEFT JOIN mst_equipment mmq ON data_middle_all.e01 = mmq.in_hospital_cd_1 and facility_cd = @facilityCd and data_middle_all.e03 = mmq.equipment_name
		order by sortTag
),
