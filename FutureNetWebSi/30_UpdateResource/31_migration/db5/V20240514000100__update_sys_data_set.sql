...
DELETE FROM "ntss"."sys_data_set" where sql_cd in (44);
...
;', 2, '[{"preview": "〇", "can_calc": "0", "data_code": "has_plan", "data_name": "予定有無", "data_type": "string", "conv_table": [{"code": "0", "disp": "×", "item": "予定無し"}, {"code": "1", "disp": "〇", "item": "予定有り"}], "data_class": "検査予定(セット・指定日)", "field_name": "has_plan", "disp_format": "", "filter_type": "Examin", "data_category": "検査", "facility_table": "", "facility_filter_type": "0"}]', '0', '{"applications": [1]}', '{"classes": [1, 2, 3, 9, 10, 11]}', '検査予定(セット・指定日)：予定有無 @patId @date 使用', '2020-03-26 16:30:00', CURRENT_TIMESTAMP, NULL);
DELETE FROM "ntss"."sys_data_set" where sql_cd in (49);
...
;', 2, '[{"preview": "〇", "can_calc": "0", "data_code": "has_plan", "data_name": "予定有無", "data_type": "string", "conv_table": [{"code": "0", "disp": "×", "item": "予定無し"}, {"code": "1", "disp": "〇", "item": "予定有り"}], "data_class": "検査予定(単項目・指定日)", "field_name": "has_plan", "disp_format": "", "filter_type": "Examin", "data_category": "検査", "facility_table": "", "facility_filter_type": "0"}]', '0', '{"applications": [1]}', '{"classes": [1, 2, 3, 9, 10, 11]}', '検査予定(単項目・指定日)：予定有無 @patId @date 使用', '2020-03-26 20:00:00', CURRENT_TIMESTAMP, NULL);
