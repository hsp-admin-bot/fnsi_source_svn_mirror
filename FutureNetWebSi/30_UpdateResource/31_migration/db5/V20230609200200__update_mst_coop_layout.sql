DELETE FROM "ntss"."mst_coop_layout" WHERE ctl_no = -1040001;
...
DELETE FROM "ntss"."mst_coop_layout" WHERE ctl_no = -1040002;
...
DELETE FROM "ntss"."mst_coop_layout" WHERE ctl_no = -1040003;
