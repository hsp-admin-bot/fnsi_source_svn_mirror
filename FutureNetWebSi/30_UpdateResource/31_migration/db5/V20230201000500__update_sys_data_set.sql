...
, amount
, unit
, function_class, area, ufr, koa, material, wetdry, disp_order, class_name, class_ename,anticoagulant_name
...
FROM (
    ...
    UNION ALL
	--血液回路
	SELECT 7 as disp_order,om.treat_date,kr.kur_cd,kr.kur_name,COALESCE(bd.bed_name,''未登録'') as bed_name,om.ind_bed_cd AS bed_cd,om.pat_id,COALESCE(eqc.class_name,'''') as kind,eq.equipment_name AS Name,1 AS Amount,COALESCE(eq.unit,'''') AS Unit
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''血液回路'' as class_name, null as Anticoagulant_name, om.ord_no, eq.in_hospital_cd_1, eq.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
	...
	LEFT OUTER JOIN mst_kur kr ON om.ind_kur_cd=kr.kur_cd and kr.is_del = ''0''
	LEFT OUTER JOIN mst_bed bd ON om.ind_bed_cd=bd.bed_cd and bd.is_del = ''0'' and bd.is_disp = ''1''
	WHERE om.ord_no IN (@ordNos) AND om.ind_cond_info::json#>>''{13,value}'' IS NOT NULL and om.is_del = ''0''
    AND eq.class_cd IN (@eqIds)
	UNION ALL
	--透析液
  ...
  , (TO_NUMBER( om.ind_cond_info :: json #>> ''{26,value}'', ''99999999.99'' ) + TO_NUMBER( om.ind_cond_info :: json #>> ''{28,value}'', ''99999999.99'' ) )
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry
	, ''抗凝固剤'' as class_name, null as Anticoagulant_name, om.ord_no, mmx.in_hospital_cd_1, mmx.in_hospital_cd_2
	, null AS equip_circuit
	, TO_NUMBER(om.ind_cond_info::json#>>''{26,value}'',''99999999.99'') || om.unit as cond_ac_shot
	, TO_NUMBER(om.ind_cond_info::json#>>''{27,value}'',''99999999.99'') || CASE WHEN om.unit IS NULL THEN '''' ELSE om.unit || ''/h'' END as cond_ac_spd
	, TO_NUMBER(om.ind_cond_info::json#>>''{28,value}'',''99999999.99'') || om.unit as cond_ac_dur_total
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''投与薬剤'' as class_name, null as Anticoagulant_name, om.ord_no, mdx.in_hospital_cd_1, mdx.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
...
, bd.amount
, bd.unit
, bd.function_class, bd.area, bd.ufr, bd.koa, bd.material, bd.wetdry, bd.disp_order, bd.class_name, bd.class_ename,bd.anticoagulant_name
