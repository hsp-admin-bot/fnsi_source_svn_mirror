delete from "mst_coop_layout_detail" where "ctl_no" in (-109000001);
INSERT INTO "mst_coop_layout_detail"("ctl_no", "facility_cd", "coop_cd", "direction", "coop_cd_detail", "coop_cd_detail_sub", "coop_name", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-109000001, 'nkknkk', 'exam_rst', 'R', '検査結果', 'all', '日機装標準', '検査結果受信', '１', '<root name="検査結果項目">
    <item  name="項目コード" len="10" col="$journal.detail.pat_exam_main.exam_result_info.item_cd" type="string"/>
