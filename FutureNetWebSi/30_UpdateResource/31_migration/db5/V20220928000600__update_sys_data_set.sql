...
UNION
 ...
 SELECT
  ...
  ''1'' AS e05,-- 選択単位フラグ
  COALESCE ( ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG WHERE key2 = ''ITEM_SOLUTION_AMT_UNIT'' ), '''' ) AS e06,--単位コード
  COALESCE ( ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG WHERE key2 = ''ITEM_SOLUTION_AMT_UNIT'' ), '''' ) AS e07,--単位名称
  '''' AS e08,
  '''' AS e09,
  ''28'' AS e10,
  COALESCE ( ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG WHERE key2 = ''ITEM_SOLUTION_TAG'' ), '''' ) AS e11,-- タグ名称
