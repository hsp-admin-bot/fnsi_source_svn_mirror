...
WHERE
	...
	AND to_date( @toDate, ''YYYYMMDDHH24MISS'' )', 2, '[]', '1', '{"applications": [5]}', '{"classes": []}', '患者情報1：患者イベント テキスト　@facilityCd @fromDate @toDate使用 {"Mergekey": ["pat_id"]}', '2021-02-26 17:51:54.726', '2021-02-26 17:51:54.726', NULL);
...
INSERT INTO "sys_data_set" ("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-2281, 'SELECT                					
    ...
    ,to_char(ntss_db5_pem.reg_exam_date, ''YYYYMMDDHH24MISS'') AS EXAM_DATE --検査予定日
...
INSERT INTO "sys_data_set" ("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-2291, 'SELECT           				
    ...
    ,to_char(ntss_db5_mws.inspection_date, ''YYYYMMDDHH24MISS'') AS CHECK_DATE --調査日   					
...
WHERE					
    ...
    AND ntss_db5_mws.up_date BETWEEN to_date( @fromDate, ''YYYYMMDDHH24MISS'' ) 					
    AND to_date( @toDate, ''YYYYMMDDHH24MISS'' )					
', 2, '[]', '1', '{"applications": [5]}', '{"classes": []}', '患者病歴情報　@facilityCd @fromDate @toDate使用 {"Mergekey": ["pat_id"]}', '2021-02-26 17:51:54.726', '2021-02-26 17:51:54.726', NULL);
