delete from "sys_data_set" where "sql_cd" in (-25,-42,-43,-44);
...
ORDER BY
  ...
  , tag_name ASC
  , in_hospital_cd1 ASC
LIMIT 299 ', 2, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）依頼検査繰り返し部', '2020-05-12 11:09:24', '2022-01-17 15:02:47', NULL);
...
FROM 
  data_info
ORDER BY order_no ASC LIMIT 1
', 2, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）検査依頼：検査日時取得 ★削除用', '2022-01-17 15:02:47', '2022-01-17 15:02:47', NULL);
...
ORDER BY
  ...
  , tag_name ASC
  , in_hospital_cd1 ASC
LIMIT 299 ', 2, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）依頼検査繰り返し部 ★削除用', '2022-01-17 15:02:47', '2022-01-17 15:02:47', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-44, 'SELECT
...
FROM
  ...
  ) AS T', 2, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）検査依頼者 ★削除用', '2022-01-17 15:02:47', '2022-01-17 15:02:47', NULL);
