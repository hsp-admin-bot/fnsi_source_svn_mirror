DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2240,-2170,-2100,-2190,-2518);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2518, 'SET enable_nestloop TO OFF;', 2, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
