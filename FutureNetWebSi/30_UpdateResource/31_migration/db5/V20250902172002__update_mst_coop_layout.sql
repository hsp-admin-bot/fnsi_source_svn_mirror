DELETE FROM mst_coop_layout WHERE ctl_no IN (-4080005);
...
VALUES(-4080005, 'P_hosp', 'rep_dial', 'pdf', 'S', 'upd', 'pdf', 'パナソニック 透析レポート(pdf)', 'Medicom', 'report', '1', '<rootnode></rootnode>', NULL, '1', '0', 4, '2020-05-25 18:26:36.811', CURRENT_TIMESTAMP, 'MED');