...
SELECT
  ...
  CASE WHEN oci.elem ->> ''medicine_type'' = ''1'' AND oci.class_cd = ''25'' THEN mm.unit 
       WHEN oci.elem ->> ''medicine_type'' = ''1'' AND oci.class_cd in (''15'', ''19'') THEN mm.unit_second
       ELSE mmm.unit 
  END as unit,
