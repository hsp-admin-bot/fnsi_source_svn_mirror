...
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (1708, e'with compareDate as (select (case TO_DATE(\'@dieDate_Date\', \'YYYY-MM-DD HH24:MI:SS\') >
...
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (1709, e'with compareDate as (select (case TO_DATE(\'@dieDate_Date\', \'YYYY-MM-DD HH24:MI:SS\') >
                                  TO_DATE(to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\'), \'YYYY-MM-DD HH24:MI:SS\')
                                 when true then \'@dieDate_Date\'
                                 else to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\') end) as die_date),
     check_for_setting as (SELECT (CASE
...
WHERE is_del = \'0\'
  ...
  AND TO_CHAR(reg_exam_date, \'YYYYMMDD\') not in (select treat_date
                                                 ...
                                                 WHERE is_del = \'0\'
                                                   ...
                                                   AND facility_cd = \'@facilityCd\'
                                                   AND treat_date >=
                                                       TO_CHAR(TO_DATE(compareDate.die_date, \'YYYY-MM-DD HH24:MI:SS\'),
                                                               \'YYYYMMDD\')
                                                   AND rst_dialysis_state > \'0\')', 2, '[{}]', '0', '{"applications": [4]}', null, '未来日データをコピーする。検査オーダ（pat_exam_main） → pat_exam_main_hst', '2020-05-25 18:21:40.841', CURRENT_TIMESTAMP, null);
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (1710, e'with compareDate as (select (case TO_DATE(\'@dieDate_Date\', \'YYYY-MM-DD HH24:MI:SS\') >
                                  TO_DATE(to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\'), \'YYYY-MM-DD HH24:MI:SS\')
                                 when true then \'@dieDate_Date\'
                                 else to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\') end) as die_date),
          check_for_setting as (SELECT (CASE
...
WHERE is_del = \'0\'
  ...
  AND TO_CHAR(reg_rad_date, \'YYYYMMDD\') not in (select treat_date
                                                 FROM ord_main, compareDate
                                                 WHERE is_del = \'0\'
                                                   AND rst_edition = 0
                                                   AND pat_id = @patId
                                                   ...
                                                   AND treat_date >=
                                                       TO_CHAR(TO_DATE(compareDate.die_date, \'YYYY-MM-DD HH24:MI:SS\'),
                                                               \'YYYYMMDD\')
                                                   AND rst_dialysis_state > \'0\')', 2, '[{}]', '0', '{"applications": [4]}', null, '未来日データをコピーする。一般撮影検査オーダ（pat_rad_main） → pat_rad_main_hst', '2020-05-25 18:21:40.841', CURRENT_TIMESTAMP, null);
...
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (1712, e'with compareDate as (select (case TO_DATE(\'@dieDate_Date\', \'YYYY-MM-DD HH24:MI:SS\') >
                                  TO_DATE(to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\'), \'YYYY-MM-DD HH24:MI:SS\')
                                 when true then \'@dieDate_Date\'
                                 else to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\') end) as die_date),
     check_for_setting as (SELECT (CASE
...
WHERE is_del = \'0\'
  ...
  AND pat_id = @patId
  AND facility_cd = \'@facilityCd\'
  AND (select value from check_for_setting) <> \'3\'
...
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (1713, e'with compareDate as (select (case TO_DATE(\'@dieDate_Date\', \'YYYY-MM-DD HH24:MI:SS\') >
                                  TO_DATE(to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\'), \'YYYY-MM-DD HH24:MI:SS\')
                                 when true then \'@dieDate_Date\'
                                 else to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\') end) as die_date),
     check_for_setting as (SELECT (CASE
...
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (1892, e'with compareDate as (select (case TO_DATE(\'@dieDate_Date\', \'YYYY-MM-DD HH24:MI:SS\') >
                                  TO_DATE(to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\'), \'YYYY-MM-DD HH24:MI:SS\')
                                 when true then \'@dieDate_Date\'
                                 else to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\') end) as die_date),
     check_for_setting as (SELECT (CASE
...
INSERT INTO ntss.sys_data_set (sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES (1893, e'with compareDate as (select (case TO_DATE(\'@dieDate_Date\', \'YYYY-MM-DD HH24:MI:SS\') >
                                  TO_DATE(to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\'), \'YYYY-MM-DD HH24:MI:SS\')
                                 when true then \'@dieDate_Date\'
                                 else to_char(CURRENT_TIMESTAMP, \'YYYY-MM-DD HH24:MI:SS\') end) as die_date),
     check_for_setting as (SELECT (CASE
