...
to_number(ord.ind_cond_info:: json ->''27'' ->> ''value'', ''999999'') as mix_count
...
CASE WHEN ''0'' = (SELECT case when (select staff_cd from CREATE_NUMBER_FUNCTION_cd) IS NULL or 
            ...
            END) THEN  
										case when (((a.e02::float)*100)::INTEGER) > 10 then ((a.e02::float)*100)::TEXT
										ELSE ''0''||(a.e02::float*100)::TEXT
										END
								 ELSE
