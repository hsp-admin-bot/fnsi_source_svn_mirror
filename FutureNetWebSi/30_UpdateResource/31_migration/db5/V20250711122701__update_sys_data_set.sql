...
FROM
	mni_monitor
	LEFT JOIN ord_main
	on mni_monitor.ord_no = ord_main.ord_no
WHERE
	mni_monitor.ord_no = @ordNo
	AND mni_monitor.data_type IN ( 0, 2, 4, 5, 6)
