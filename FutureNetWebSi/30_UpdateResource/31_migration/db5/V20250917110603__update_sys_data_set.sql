...
LEFT JOIN exam_sort ON exam_sort.code = CAST(rt.item_cd AS NUMERIC)
WHERE
    @selectExamSetCd = -1 OR et.exam_item_cd IS NOT NULL
ORDER BY exam_sort.code_order, rt.result_exam_date, ARRAY_POSITION(ARRAY[''1'',''2'',''0''], rt.reg_order_class);
