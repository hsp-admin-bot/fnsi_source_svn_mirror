UPDATE "ntss"."sys_data_set" SET "sql" = 'WITH plan_time AS (
...
FROM (
    ...
    , function_class, area || ''㎡'' as area, ufr, koa, material, wetdry, ''Dialyser'' as class_name, Anticoagulant.medicine_name as Anticoagulant_name, om.ord_no, dz.in_hospital_cd_1, dz.in_hospital_cd_2
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''Adsorption'' as class_name, null as Anticoagulant_name, om.ord_no, eq.in_hospital_cd_1, eq.in_hospital_cd_2
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''Film1'' as class_name, null as Anticoagulant_name, om.ord_no, eq.in_hospital_cd_1, eq.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''Film2'' as class_name, null as Anticoagulant_name, om.ord_no, eq.in_hospital_cd_1, eq.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''Puncture'' as class_name, null as Anticoagulant_name, om.ord_no, eq.in_hospital_cd_1, eq.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
	...
	, ''DialysisLiquid'' as class_name, null as Anticoagulant_name, om.ord_no, md.in_hospital_cd_1, md.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
	...
	, null as medi_timing
	, null as medi_proc
	, concat(cond_dl_am, CASE WHEN om.medicine_type = ''1'' THEN md.unit ELSE mdx.unit END) as num_unit
	, null as cond_va_dir
	, null as cond_va
	, null as equip_pnc_cls
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''ReplenishLiquid'' as class_name, null as Anticoagulant_name, om.ord_no, md.in_hospital_cd_1, md.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
	...
	, null as medi_timing
	, null as medi_proc
	, om.ind_cond_info::json#>>''{22, value}'' || CASE WHEN om.medicine_type = ''1'' THEN md.unit ELSE mdx.unit END as num_unit
	, null as cond_va_dir
	, null as cond_va
	, null as equip_pnc_cls
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry
	, ''AntiCoagulan'' as class_name, null as Anticoagulant_name, om.ord_no, md.in_hospital_cd_1, md.in_hospital_cd_2
	, null AS equip_circuit
	...
	, null as medi_timing
	, null as medi_proc
	, CASE WHEN medicine_type = ''1'' THEN ''1'' ELSE concat(''1'', om.unit) END as num_unit
	, null as cond_va_dir
	, null as cond_va
	, null as equip_pnc_cls
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''Medicine'' as class_name, null as Anticoagulant_name, om.ord_no, md.in_hospital_cd_1, md.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
	...
	, CASE WHEN om.medicine_type = ''1'' THEN om.amount || md.unit ELSE to_number(om.amount, ''9999999999.999'') * mdx.amount_unit || mdx.unit END as num_unit
	, null as cond_va_dir
	, null as cond_va
	, null as equip_pnc_cls
	FROM ord_medi as om
	LEFT OUTER JOIN mst_medicine md ON (om.medicine_type = ''1'' AND om.cd = md.medicine_cd and md.is_del = ''0'' and md.is_disp = ''1'')
    LEFT OUTER JOIN mst_medicine_mix mdx ON (om.medicine_type = ''2'' AND om.cd = mdx.medicine_mix_cd and mdx.is_del = ''0'' and mdx.is_disp = ''1'')
	LEFT OUTER JOIN mst_medicine_class mdc ON md.class_cd=mdc.class_cd and mdc.is_del = ''0'' and mdc.is_disp = ''1''
	LEFT OUTER JOIN mst_kur kr ON om.ind_kur_cd=kr.kur_cd and kr.is_del = ''0''
	LEFT OUTER JOIN mst_bed bd ON om.ind_bed_cd=bd.bed_cd and bd.is_del = ''0'' and bd.is_disp = ''1''
    ...
    , null as function_class, null as area, null as ufr, null as koa, null as material, null as wetdry, ''Equip'' as class_name, null as Anticoagulant_name, om.ord_no, eq.in_hospital_cd_1, eq.in_hospital_cd_2
	, null AS equip_circuit
	, null as cond_ac_shot
	, null as cond_ac_spd
	, null as cond_ac_dur_total
