DELETE FROM "ntss"."sys_data_set" where "sql_cd" IN (-44,-26,-73,-74,-75,-76);
...
1 AS order_no
, @default_user_no
 ORDER BY order_no ASC LIMIT 1', 1, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）検査オーダ：施設内職員ID(共通部)取得.削除', '2022-05-07 16:27:46.681',CURRENT_TIMESTAMP , '[{"sql_cd": -44, "field_name": "staff_cd_comm", "replace_var": "@userId"}, {"sql_cd": -44, "field_name": "default_user_no", "replace_var": "@default_user_no"}]');
...
1 AS order_no
, @default_user_no
 ORDER BY order_no ASC LIMIT 1', 1, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）検査オーダ：施設内職員ID(内容部)取得.削除', '2022-05-07 16:27:46.683',CURRENT_TIMESTAMP , '[{"sql_cd": -44, "field_name": "staff_cd_data", "replace_var": "@userId"}, {"sql_cd": -44, "field_name": "default_user_no", "replace_var": "@default_user_no"}]');
...
1 AS order_no
, @default_user_no
 ORDER BY order_no ASC LIMIT 1', 1, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）検査オーダ：施設内職員ID(共通部)取得', '2022-05-07 16:27:46.684',CURRENT_TIMESTAMP, '[{"sql_cd": -26, "field_name": "staff_cd_comm", "replace_var": "@userId"}, {"sql_cd": -26, "field_name": "default_user_no", "replace_var": "@default_user_no"}]');
...
1 AS order_no
, @default_user_no
 ORDER BY order_no ASC LIMIT 1', 1, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）検査オーダ：施設内職員ID(内容部)取得', '2022-05-07 16:27:46.685',CURRENT_TIMESTAMP, '[{"sql_cd": -26, "field_name": "staff_cd_data", "replace_var": "@userId"}, {"sql_cd": -26, "field_name": "default_user_no", "replace_var": "@default_user_no"}]');
