DELETE FROM "ntss"."sys_data_set" WHERE sql_cd in (-2010,-2040,-2041,-2050,-2060,-2080,-2090,-2100,-2110);
   ...
   AND (
        CASE
            WHEN @syncMode = ''update''
                THEN (
                (
                    ntss_db5_om.up_date BETWEEN to_date( @fromDate, ''YYYYMMDDHH24MISS'' ) AND to_date( @toDate, ''YYYYMMDDHH24MISS'' )
                )
                OR (
                    ntss_db5_os.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
                OR (
                    ntss_db5_mst_b.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
                OR (
                    ntss_db5_mst_k.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
            )
            else ntss_db5_om.up_date BETWEEN to_date( @fromDate, ''YYYYMMDDHH24MISS'' ) AND to_date( @toDate, ''YYYYMMDDHH24MISS'' )
            end
    )
    ...
    AND (
        CASE
            WHEN @syncMode = ''update''
                ...
                OR (
                    ntss_db5_om_mst_list.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
            )
            end
    )
    ...
    AND (
        CASE
            WHEN @syncMode = ''update''
                THEN (
                (
                    ntss_db5_pu.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
                OR (
                    ntss_db5_pu_mst_d.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
            )
            else ntss_db5_pu.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
            end
    )
    ...
    AND (
        CASE
            WHEN @syncMode = ''update''
                THEN (
                (
                    ntss_db5_pm.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'' ) AND to_date( @toDate , ''YYYYMMDDHH24MISS'' )
                )
                OR (
                    ntss_db5_mst_add.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
            )
            else ntss_db5_pm.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'' ) AND to_date( @toDate , ''YYYYMMDDHH24MISS'' )
            end
           ...
           AND (
                CASE
                    WHEN @syncMode = ''update''
                        ...
                        OR (
                            ntss_db5_pm_mst_wc.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                        )
                    )
                    else ntss_db5_pm.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                    end
...
WHERE
    ...
    AND (
        CASE WHEN @syncMode = ''update'' THEN (
            (
                ntss_db6_ppm.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
            )
            OR (
                ntss_db6_pat_ins.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
            )
        ) else ntss_db6_ppm.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
         end
    ...
    AND (
        CASE
            WHEN @syncMode = ''update''
                ...
                OR (
                    ntss_db5_mst_mi.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
                )
            )
            else ntss_db5_pm.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
            end
...
DELETE FROM "ntss"."sys_data_set" WHERE sql_cd in (-2120,-2130,-2140,-2150,-2163,-2164,-2170,-2180,-2190,-2200,-2210);
...
WHERE
    (
        CASE
            WHEN @syncMode = ''update''
                THEN (
                ntss_db5_om_1.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
            )
            OR (
                ntss_db5_os.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
            )
  ...
  , (-2200,'WITH ntss_db5_om_1 AS (
    ...
    WHERE
        ...
        AND (
            CASE
                WHEN @syncMode = ''update''
                    THEN ntss_db5_om_1.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
...
, ntss_db5_om_rei_json AS (
    ...
    WHERE
        ...
        AND (
            CASE
                WHEN @syncMode = ''update''
                    THEN om.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
...
WHERE
    ...
    AND (
        CASE
            WHEN @syncMode = ''update''
                THEN ntss_db5_om.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
...
DELETE FROM "ntss"."sys_data_set" WHERE sql_cd in (-2450,-2440,-2430,-2420,-2410,-2240,-2164,-2163,-2300,-2291,-2280,-2270,-2260,-2250,-2230);
...
WHERE
  ...
  , (-2440,'WITH ntss_db5_mst_mr1 AS (
    ...
    WHERE
        ...
        AND ntss_db5_mst_mr.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
)
, ntss_db5_mst_mr2 AS (
    SELECT
...
WHERE
    ntss_db5_mst_m.is_del = ''0''
    AND ntss_db5_mst_m.facility_cd = @facilityCd
    AND ntss_db5_mst_m.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')
',2,'[]','1','{"applications": [5]}','{"classes": []}','患者病歴情報　@facilityCd @fromDate @toDate使用 {"Mergekey": ["patid"]}','2021/02/26 17:51:54.726','2021/02/26 17:51:54.726',null)
  , (-2270,'SELECT
...
WHERE
    ...
    AND ntss_db5_op.up_date BETWEEN to_date(@fromDate, ''YYYYMMDDHH24MISS'') AND to_date(@toDate, ''YYYYMMDDHH24MISS'')',2,'[]','1','{"applications": [5]}','{"classes": []}','患者病歴情報　@facilityCd @fromDate @toDate使用 {"Mergekey": ["patid"]}','2021/02/26 17:51:54.726','2021/02/26 17:51:54.726',null)
