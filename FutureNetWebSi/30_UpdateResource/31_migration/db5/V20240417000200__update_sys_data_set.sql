...
select
  ...
  ,unescape_html(regexp_replace(picked_result_params[11]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data11
  ,unescape_html(regexp_replace(picked_result_params[12]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data12
  ,unescape_html(regexp_replace(picked_result_params[13]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data13
  ,unescape_html(regexp_replace(picked_result_params[14]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data14
  ,unescape_html(regexp_replace(picked_result_params[15]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data15
  ,unescape_html(regexp_replace(picked_result_params[16]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data16
  ,unescape_html(regexp_replace(picked_result_params[17]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data17
  ,unescape_html(regexp_replace(picked_result_params[18]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data18
  ,unescape_html(regexp_replace(picked_result_params[19]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data19
  ,unescape_html(regexp_replace(picked_result_params[20]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data20
  ,unescape_html(regexp_replace(picked_result_params[21]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data21
  ,unescape_html(regexp_replace(picked_result_params[22]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data22
  ,unescape_html(regexp_replace(picked_result_params[23]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data23
  ,unescape_html(regexp_replace(picked_result_params[24]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data24
  ,unescape_html(regexp_replace(picked_result_params[25]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data25
  ,unescape_html(regexp_replace(picked_result_params[26]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data26
  ,unescape_html(regexp_replace(picked_result_params[27]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data27
  ,unescape_html(regexp_replace(picked_result_params[28]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data28
  ,unescape_html(regexp_replace(picked_result_params[29]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data29
  ,unescape_html(regexp_replace(picked_result_params[30]->>''result_value'', ''<[^>]*>'', '''', ''g''))  as data30
from
  pe_array_agg
