...
, CASE mnt_machine_state.process_state WHEN ''01'' THEN ''プリセット''
  ...
  END
, b.ind_cond_info::json#>>''{3, value}'' AS 目標体重
, to_number(b.rst_weight_info::json->>''weight_before'', ''999.99'') - to_number(b.ind_cond_info::json#>>''{3, value}'', ''999.99'') AS 目標体重から
, b.rst_start_date
...
, to_char(to_number(b.rst_cond_info#>>''{18, value}'', ''999.9''), ''FM999.0'') AS 透析液温度
...
, to_char(to_number(b.rst_cond_info#>>''{23, value}'', ''999.99''), ''FM990.0'') AS 補液温度
...
, to_number(b.rst_cond_info#>>''{31, value}'', ''999.99'') AS ipワンショット量
, to_number(b.rst_cond_info#>>''{32, value}'', ''999.99'') AS ip速度
, to_number(b.rst_cond_info#>>''{33, value}'', ''999.99'') AS ip速度最大値
...
DELETE  FROM "ntss"."sys_data_set" WHERE sql_cd IN (8);
INSERT INTO "ntss"."sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (
8
,'WITH ord AS (
    SELECT
...
DELETE  FROM "ntss"."sys_data_set" WHERE sql_cd IN (97);
INSERT INTO "ntss"."sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (
97
,'with ord_key_tbl as (
  select
