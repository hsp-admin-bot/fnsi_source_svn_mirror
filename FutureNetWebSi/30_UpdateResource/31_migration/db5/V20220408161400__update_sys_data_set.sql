...
UNION
 ...
 FROM
  ...
  WHERE
     ((SELECT VALUE FROM fji_com_info  WHERE  key2 = ''MEDICINE_SEND_FLAG'') = ''2'' 
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''001'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''002'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''003'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''004'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''005'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''006'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''007'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''008'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''009'' )
       AND mmd.procedure_cd ::TEXT <> ( SELECT VALUE FROM DIALYSIS_ITEM_PROCEDURE_TAG  WHERE  key2 = ''010'' )
 ...
 FROM
  mst_medicine AS mmd
 LEFT OUTER JOIN RST_MEDI_INFO AS imu ON mmd.medicine_cd::TEXT <> imu.medi_cd
  WHERE
  ((SELECT VALUE FROM fji_com_info  WHERE  key2 = ''MEDICINE_SEND_FLAG'' ) = ''1'' AND mmd.is_shot = 0::TEXT ) 
 ) 
 UNION
 (--  実施コメンSOAP ト A
 SELECT
