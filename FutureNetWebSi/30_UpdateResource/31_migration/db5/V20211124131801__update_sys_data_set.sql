...
select
    ...
    , sum(sv.ind_rst_value ::integer) as amount
    , med.unit
    ,sum(sv.receipt_value ::integer) as receipt_value
    ,med.unit_second as unit_second
