...
-- source: V20260329222701__update_sys_data_set.sql
...
-- source: V20260330193001__update_sys_data_set.sql
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-600001, ' select
 ...
 pat_id = @patId', 3, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, '{"classes": []}'::jsonb, 'NEC標準(MegaOakHR) 透析レポート', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL::jsonb);

-- source: V20260330193101__update_sys_data_set.sql
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
WHERE
  ord.ord_no = @ordNo', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL::jsonb, 'NECiS)透析予約の透析指示情報を取得する', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL::jsonb);

-- source: V20260330193201__update_sys_data_set.sql
INSERT INTO ntss.sys_data_set
(sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
pat_personal_main.pat_id = @patId', 3, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL::jsonb, 'Medicom', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL::jsonb);

-- source: V20260330193301__update_sys_data_set.sql
INSERT INTO ntss.sys_data_set
(sql_cd, sql, db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-500001, ' select
 ...
 pat_personal_main
 where
 pat_id = @patId', 3, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, '{"classes": []}'::jsonb, 'SSI 透析レポート', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL::jsonb);
