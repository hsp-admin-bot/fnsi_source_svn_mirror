...
WHERE ctl_no IN (-1070004, -1070005, -1070006);
...
VALUES(-1070004, 'nkknkk', 'rst_dial', '', 'S', 'cre', 'text', '日機装拡張', 'nikkiso', '透析実績(拡張)', '1', '<root name="日機装拡張(透析実績)" multi="true:CRLF">
     ...
     <item  name="透析番号" len="12" value="dataset:-11.dialysis_no" padding_format="blank" padding_position="left"/>
...
VALUES(-1070006, 'nkknkk', 'rst_dial', '', 'S', 'del', 'text', '日機装拡張', 'nikkiso', '透析実績(拡張)', '1', '<root name="日機装拡張(透析実績)" multi="true:CRLF">
  ...
  <item name="医師コード" len="10" value="dataset:-112.disp_user_id"/>
     <item  name="透析番号" len="12" value="dataset:-505.dialysis_no" padding_format="blank" padding_position="left"/>
  <item name="ヘッダ1" len="1" value="auto:1"/>
