DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2440);
    ...
    WHERE
        ...
        CASE
            WHEN @syncMode = ''update''
                THEN (
                ntss_db5_mst_mr.up_date BETWEEN to_timestamp(@fromDate, ''YYYYMMDDHH24MISS'') AND to_timestamp(@toDate, ''YYYYMMDDHH24MISS'')
            )
            OR (
                ntss_db5_mst_m.up_date BETWEEN to_timestamp(@fromDate, ''YYYYMMDDHH24MISS'') AND to_timestamp(@toDate, ''YYYYMMDDHH24MISS'')
						)
            ELSE ntss_db5_mst_mr.up_date BETWEEN to_timestamp(@fromDate, ''YYYYMMDDHH24MISS'') AND to_timestamp(@toDate, ''YYYYMMDDHH24MISS'')
            END
    )
)
SELECT
...
WHERE
    ...
    AND (
        CASE
            ...
            OR (
                ntss_db5_mst_mr2.event_reg_date BETWEEN to_timestamp(@fromDate, ''YYYYMMDDHH24MISS'') AND to_timestamp(@toDate, ''YYYYMMDDHH24MISS'')
						)
            ELSE ntss_db5_mst_m.up_date BETWEEN to_timestamp(@fromDate, ''YYYYMMDDHH24MISS'') AND to_timestamp(@toDate, ''YYYYMMDDHH24MISS'')
            END
...
DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2430);
...
INSERT INTO ntss.sys_data_set(sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
    (-2430,'WITH ntss_db5_mm AS (
        ...
        CASE
            ...
            ELSE ntss_db5_mm.occur_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' ) AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )
            END
    );
		',2,'[]','1','{"applications": [5]}','{"classes": []}','患者病歴情報　@facilityCd @fromDate @toDate使用 {"Mergekey": ["patid"]}','2021/02/26 17:51:54.726','2021/02/26 17:51:54.726',NULL);

DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2300);
...
INSERT INTO ntss.sys_data_set(sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
    ...
    SELECT
        ...
        ,ntss_db5_om_mnt_mr.machine_record_cd
				...
				,ntss_db5_om_mnt_mr.up_date AS up_date
        ...
        CASE
            WHEN @syncMode = ''update''
							...
							THEN
							 ...
							 ntss_db5_om_mnt_mr.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )
...
DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2291);
        ...
        CASE
            WHEN @syncMode = ''update''
							...
							THEN
							  ...
							  ntss_db5_mnt_ws.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )

							 OR

							 ntss_db5_mnt_wsp.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )

					ELSE  ntss_db5_mnt_ws.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'')

					END
		 )

',2,'[]','1','{"applications": [5]}','{"classes": []}','患者病歴情報　@facilityCd @fromDate @toDate使用 {"Mergekey": [""]}','2021/02/26 17:51:54.726','2021/02/26 17:51:54.726',NULL);

DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2270);
        ...
        CASE
            WHEN @syncMode = ''update''
							...
							THEN
							  ...
							  ntss_db5_pxm.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )

							 OR

							 ntss_db5_mst_e.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )

					ELSE  ntss_db5_pxm.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'')
...
DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2280);
        ...
        CASE
            WHEN @syncMode = ''update''
							...
							THEN
							 ...
							 ntss_db5_pem.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )

							 OR

							 ntss_db5_pem_mst_ei.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )

					ELSE  ntss_db5_pem.up_date BETWEEN to_timestamp( @fromDate, ''YYYYMMDDHH24MISS'' )  AND to_timestamp( @toDate, ''YYYYMMDDHH24MISS'' )
...
DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2140);
...
DELETE FROM "ntss"."sys_data_set" where sql_cd in (-2450);
