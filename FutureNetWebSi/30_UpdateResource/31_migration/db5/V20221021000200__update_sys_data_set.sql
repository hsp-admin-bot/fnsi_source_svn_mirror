...
FROM (
	...
	, null as medi_timing
	, null as medi_proc
	, concat(TO_NUMBER(cond_dl_am, ''99999999.99''), CASE WHEN om.medicine_type = ''1'' THEN md.unit_second ELSE mdx.unit END) as num_unit
	, null as cond_va_dir
	, null as cond_va
	, null as equip_pnc_cls
	...
	, null as medi_timing
	, null as medi_proc
	, TO_NUMBER(om.ind_cond_info::json#>>''{22,value}'',''99999999.99'') || CASE WHEN om.medicine_type = ''1'' THEN COALESCE(md.unit_second,'''') ELSE COALESCE(mdx.unit,'''') END as num_unit
	, null as cond_va_dir
	, null as cond_va
	, null as equip_pnc_cls
	...
	, null as medi_timing
	, null as medi_proc
	, TO_NUMBER(om.ind_cond_info::json#>>''{28,value}'',''99999999.99'') || om.unit as num_unit
	, null as cond_va_dir
	, null as cond_va
	, null as equip_pnc_cls
