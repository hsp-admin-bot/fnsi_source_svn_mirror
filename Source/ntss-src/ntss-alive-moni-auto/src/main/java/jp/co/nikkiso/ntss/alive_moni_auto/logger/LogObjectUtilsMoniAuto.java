package jp.co.nikkiso.ntss.alive_moni_auto.logger;

import jp.co.nikkiso.ntss.alive_moni_auto.exception.NtssException;
 ...
 * ログ出力のユーティリティクラス.
 */
public class LogObjectUtilsMoniAuto {

  /**
   * SQLファイルのベースディレクトリパス
   */
  private static final String BASE_SQL_DIR = "META-INF/jp/co/nikkiso/ntss/alive_moni_auto/dao/";
