...
values ('F_hC41',NULL,'おかむらいいん','VAB004',NULL,'1','0','2020/01/16 9:06:09','2020/01/16 9:06:09');
...
is_del,
reg_date,
up_date) values ('F_hC41',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'0009770089','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
facility_cd,
fn_disease_cd,
disease_name,
...
is_del,
reg_date,
up_date) values ('F_hC41',NULL,'モヤモヤ','モヤ',NULL,NULL,NULL,NULL,NULL,'0001100011','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
insert into ntss.mst_disease (
facility_cd,
fn_disease_cd,
disease_name,
...
is_del,
reg_date,
up_date) values ('F_hC41',NULL,'モユモユ','モユ',NULL,NULL,NULL,NULL,NULL,'VB199999','1','0','2020/01/16 8:53:33','2020/01/16 8:53:33');
...
INSERT INTO mst_facility VALUES ('F_hC41','ジャーナル-テーブル登録テストデータ',NULL,'01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

INSERT INTO mst_device_set_info_default VALUES ('F_hC41',
'{"device": "setting"}',
...
12101, 'F_hC41', 1180, '桃', NULL, 1, NULL, 1, 0, '2020-04-09', '2020-04-09'
);
...
1211, 'F_hC41', NULL, '急性上気道炎', NULL, 112, 1, 0, '2020-04-09', '2020-04-09'
);

DELETE FROM mst_implant
WHERE facility_cd = 'F_hC41';

INSERT INTO mst_implant VALUES(
121001, 'F_hC41', '橈骨ボルト', NULL, 201, 1, 0, '2020-04-09', '2020-04-09'
);

DELETE FROM mst_obs_kind
WHERE facility_cd = 'F_hC41';

INSERT INTO mst_obs_kind VALUES(
41, 'F_hC41', '種別1', 400, '0', 0, 0, '0', '1', '0', current_timestamp, current_timestamp, 10
);
