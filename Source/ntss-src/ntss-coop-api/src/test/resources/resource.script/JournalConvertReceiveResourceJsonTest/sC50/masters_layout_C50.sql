...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC50','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC50','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<occ repeat="1">
  ...
  <item name="ダミーpat_unique" len="0" col="pat_unique.medical_hst_info.facility_cd" value="const:F_hC50" />
  ...
  <item name="ダミーpat_unique" len="0" col="pat_unique.medical_hst_info.diagnosis_facility_cd" value="const:F_hC50" />
