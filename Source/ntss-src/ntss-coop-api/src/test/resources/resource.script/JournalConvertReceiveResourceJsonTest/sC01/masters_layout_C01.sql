...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC01','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC01','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<occ repeat="10">
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.ctl_no" len="0" value="const:3" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.disp_order" len="0" value="const:3" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.is_key_person" len="0" value="const:0" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.pat_id" len="0" value="const:132435" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.last_name" len="0" value="const:へのへの" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.first_name" len="0" value="const:もへじ" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.last_name_kana" len="0" value="const:ﾍﾉﾍﾉ" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.first_name_kana" len="0" value="const:ﾓﾍｼﾞ" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.relation_cd" len="0" value="const:5" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.relation_name" len="0" value="const:兄弟姉妹" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.zip_cd" len="0" value="const:987-9876" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.address" len="0" value="const:鹿児島県" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.tel1" len="0" value="const:099-9876-4321" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.tel2" len="0" value="const:099-8642-1357" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.fax" len="0" value="const:099-7766-2211" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.e_mail" len="0" value="const:test999@example.com" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.work_name" len="0" value="const:第拾伍東京市農水省" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.work_tel" len="0" value="const:099-9898-7676" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.memo1" len="0" value="const:メモメモメモ1" />
  <item name="ダミーother_contact_info" col="pat_personal_main.other_contact_info.memo2" len="0" value="const:メモメモメモ2" />
</occ>
