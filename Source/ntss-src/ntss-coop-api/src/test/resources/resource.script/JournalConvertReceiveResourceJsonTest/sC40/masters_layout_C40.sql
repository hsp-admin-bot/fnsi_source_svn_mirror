...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC40','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hC40','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<occ repeat="1">
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.kind_info.kind_no" value="const:40" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.kind_info.kind_update" value="const:2020-04-01" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.kind_info.kind_name" value="const:kubun1" />
</occ>
<occ repeat="1">
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.reg_staff_info.reg_staff_cd" value="const:EGMAIN00" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.reg_staff_info.reg_staff_update" value="const:2020-04-10" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.reg_staff_info.reg_staff_name" value="const:医師00" />
</occ>
<occ repeat="1">
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.up_staff_info.up_staff_cd" value="const:EGMAIN10" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.up_staff_info.up_staff_update" value="const:2020-04-10" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.up_staff_info.up_staff_name" value="const:放射線技師01" />
</occ>
<occ repeat="1">
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.obs_rec_info.detail1" value="const:S" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.obs_rec_info.detail2" value="const:O" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.obs_rec_info.detail3" value="const:A" />
  <item name="ダミーpat_obs_rec" len="0" col="pat_obs_rec.obs_rec_info.detail4" value="const:P" />
</occ>
