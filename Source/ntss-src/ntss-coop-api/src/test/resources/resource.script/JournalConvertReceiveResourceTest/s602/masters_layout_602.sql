insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h602','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<occ len="0" repeat="5">
  <item name="PATTERN" col="pat_insurance.PATTERN" len="0" value="const:11" />
  <item name="PATTERNSEQ" col="pat_insurance.PATTERNSEQ" len="0" value="const:00" />
  <item name="STDATE" col="pat_insurance.STDATE" len="0" value="const:20200219" />
  <item name="EDDATE" col="pat_insurance.EDDATE" len="0" value="const:99991231" />
  <item name="INS_NO" col="pat_insurance.INS_NO" len="0" value="const:12345678" />
  <item name="KOHI_1" col="pat_insurance.KOHI_1" len="8" />
  <item name="KOHI_2" col="pat_insurance.KOHI_2" len="0" value="const:00000000" />
  <item name="KOHI_3" col="pat_insurance.KOHI_3" len="0" value="const:00000000" />
  <item name="KOHI_4" col="pat_insurance.KOHI_4" len="0" value="const:00000000" />
  <item name="PER_FAM_CLASS" col="pat_insurance.PER_FAM_CLASS" len="0" value="const:1" />
  <item name="BURDEN_RATIO GAIRAI" col="pat_insurance.BURDEN_RATIO GAIRAI" len="0" value="const:000" />
  <item name="BURDEN_RATIO NYUIN" col="pat_insurance.BURDEN_RATIO NYUIN" len="0" value="const:000" />
  <item name="INS_NAME" col="pat_insurance.INS_NAME" len="0" value="const:組　合本　　特　定" />
</occ>
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h602','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
