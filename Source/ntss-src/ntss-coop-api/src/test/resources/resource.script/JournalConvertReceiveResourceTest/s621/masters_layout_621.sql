...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h621','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h621','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="原疾患コード" len="0" type="string" value="const:0001100011" col="pat_personal_main.primary_disease_cd"/>
  ...
  <item name="保険者番号" len="0" value="const:06121212" col="pat_insurance.INS_NO"/>
