...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB01','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB01','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="pat_exam_mainテスト" len="0" col="pat_exam_main.reg_exam_date" value="const:2020-03-10" />
<item name="pat_exam_mainテスト" len="0" col="pat_exam_main.reg_order_class" value="const:1" />
<item name="pat_exam_mainテスト" len="0" col="pat_exam_main.cop_order_no1" value="const:12345" />

<occ repeat="2">
<item name="pat_exam_mainテスト" len="0" col="pat_exam_main.exam_result_info.disp_order" value="const:1" />
<item name="pat_exam_mainテスト" len="0" col="pat_exam_main.exam_result_info.exam_item_cd" value="const:1001" />
<item name="pat_exam_mainテスト" len="0" col="pat_exam_main.exam_result_info.exam_free_comment" value="const:あいうえお" />
</occ>
