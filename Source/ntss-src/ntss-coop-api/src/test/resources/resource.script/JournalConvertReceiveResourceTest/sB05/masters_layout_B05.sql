...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB05','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB05','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="pat_coop_detailテストデータ" len="0" col="pat_coop_detail.save1.key2" value="const:foo" />
<item name="pat_coop_detailテストデータ" len="0" col="pat_coop_detail.save1.key4" value="const:bar" />
<item name="pat_coop_detailテストデータ" len="0" col="pat_coop_detail.save1.key8" value="const:baz" />

<item name="pat_coop_detailテストデータ" len="0" col="pat_coop_detail.save6.key3" value="const:FOO" />
<item name="pat_coop_detailテストデータ" len="0" col="pat_coop_detail.save6.key5" value="const:BAR" />
<item name="pat_coop_detailテストデータ" len="0" col="pat_coop_detail.save6.key9" value="const:BAZ" />
