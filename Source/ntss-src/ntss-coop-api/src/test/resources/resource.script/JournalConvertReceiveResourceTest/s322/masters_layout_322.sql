...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h322','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_h322','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="ダミー:患者観察記録情報" len="0" type="string" value="const:EGMAIN01" col="pat_obs_rec.up_staff_info.up_staff_cd" />
