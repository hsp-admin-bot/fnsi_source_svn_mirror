...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_h311','ini_dial','R','ini_dial_meisai','pre','富士通想定透析初回申込-申込詳細','For test','1','
<root name="透析申込詳細">
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_h311','ini_dial','R','ini_dial_meisai','原疾患','富士通想定透析初回申込-申込詳細','For test','1','
<root name="透析申込詳細">"
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_h311','ini_dial','R','ini_dial_meisai','障害者加算','富士通想定透析初回申込-申込詳細','For test','1','
<root name="透析申込詳細">"
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_h311','ini_dial','R','ini_dial_meisai','コメント','富士通想定透析初回申込-申込詳細','For test','1','
<root name="透析申込詳細">
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_h311','ini_dial','R','ini_dial_meisai','治療方法','富士通想定透析初回申込-申込詳細','For test','1','
<root name="透析申込詳細">"
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_h311','ini_dial','R','ini_dial_meisai','明細','富士通想定透析初回申込-申込詳細','For test','1','
<root name="透析申込詳細">
<item name="明細.項目コード" len="8" col="pat_order_data.vender_1_info.treat_cd" type="string"/>
<item name="明細.項目属性" len="3" type="string"/>
<item name="明細.項目名称" len="50" col="pat_order_data.vender_1_info.treat_name" type="string"/>
