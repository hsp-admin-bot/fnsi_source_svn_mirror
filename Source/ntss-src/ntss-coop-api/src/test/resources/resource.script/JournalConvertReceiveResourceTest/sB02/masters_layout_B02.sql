...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB02','ini_dial','','R','pre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
insert into ntss.mst_coop_layout (
  ...
  , reg_date
  , up_date
) values ('F_hB02','ini_dial','','R','cre','text     ','富士通想定透析初回申し込み','Egmain-GX','テスト用','1','
<root name="透析初回申し込み">
...
<item name="pat_obs_recテストデータ" len="0" col="pat_obs_rec.rec_date" value="const:2020-01-01" />
<item name="pat_obs_recテストデータ" len="0" col="pat_obs_rec.up_cnt" value="const:100" />

<item name="pat_obs_recテストデータ" len="0" col="pat_obs_rec.kind_info.kind_no" value="const:12" />
<item name="pat_obs_recテストデータ" len="0" col="pat_obs_rec.kind_info.kind_name" value="const:種別名1" />

<item name="pat_obs_recテストデータ" len="0" col="pat_obs_rec.obs_rec_info.detail1" value="const:あ" />
<item name="pat_obs_recテストデータ" len="0" col="pat_obs_rec.obs_rec_info.detail3" value="const:い" />
<item name="pat_obs_recテストデータ" len="0" col="pat_obs_rec.obs_rec_info.detail6" value="const:う" />
