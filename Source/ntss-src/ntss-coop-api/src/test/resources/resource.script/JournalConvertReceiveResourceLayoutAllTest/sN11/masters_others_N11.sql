...
INSERT INTO mst_facility VALUES ('F_hN11','ジャーナル-テーブル登録テストデータ',NULL,'01',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

INSERT INTO mst_device_set_info_default VALUES ('F_hN11',
'{"device": "setting"}',
...
VALUES('F_hN11', '1', '0', '{"ins_mode":"FUJITSU_PROFILE"}');
...
VALUES(
20021, 'F_hN11', 1180, '桃', NULL, '11111111', NULL, 1, 0, '2020-05-25', '2020-05-25'
);

INSERT INTO mst_taboo_allergy(taboo_allergy_cd, facility_cd, fn_taboo_allergy_cd, content, detail_info,
in_hospital_cd_1, in_hospital_cd_2, is_disp, is_del, reg_date, up_date)
VALUES(
20022, 'F_hN11', 1181, 'ピーナッツ', NULL, '66666666', NULL, 1, 0, '2020-05-25', '2020-05-25'
);

INSERT INTO mst_taboo_allergy(taboo_allergy_cd, facility_cd, fn_taboo_allergy_cd, content, detail_info,
in_hospital_cd_1, in_hospital_cd_2, is_disp, is_del, reg_date, up_date)
VALUES(
20023, 'F_hN11', 1182, 'そば', NULL, '55555555', NULL, 1, 0, '2020-05-25', '2020-05-25'
);

INSERT INTO mst_taboo_allergy(taboo_allergy_cd, facility_cd, fn_taboo_allergy_cd, content, detail_info,
in_hospital_cd_1, in_hospital_cd_2, is_disp, is_del, reg_date, up_date)
VALUES(
20024, 'F_hN11', 1183, 'リドカイン製剤', NULL, 'LID', NULL, 1, 0, '2020-05-25', '2020-05-25'
);

INSERT INTO mst_taboo_allergy(taboo_allergy_cd, facility_cd, fn_taboo_allergy_cd, content, detail_info,
in_hospital_cd_1, in_hospital_cd_2, is_disp, is_del, reg_date, up_date)
VALUES(
20025, 'F_hN11', 1184, 'ヨード製剤', NULL, 'IOD', NULL, 1, 0, '2020-05-25', '2020-05-25'
);
...
VALUES(
21080, 'F_hN11', NULL, 'HBs抗原陽性', NULL, '311', 1, 0, '2020-04-09', '2020-04-09'
);

INSERT INTO mst_infection(infection_cd, facility_cd, fn_infection_cd, infection_name,
standard_infection_cd, in_hospital_cd_1, is_disp, is_del, reg_date, up_date)
VALUES(
21081, 'F_hN11', NULL, 'HBe抗原陽性', NULL, '312', 1, 0, '2020-04-09', '2020-04-09'
);
