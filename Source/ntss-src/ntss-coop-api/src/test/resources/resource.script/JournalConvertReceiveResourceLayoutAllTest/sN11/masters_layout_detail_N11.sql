...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_hN11','ini_dial','R','キシロカインアレルギー','all','富士通想定透析初回申込-申込詳細','For test','1','
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_hN11','ini_dial','R','ヨードアレルギー','all','富士通想定透析初回申込-申込詳細','For test','1','
<root name="ヨードアレルギー">
  <item name="明細.項目コード" len="1" type="string"
    col="pat_main.taboo_allergy_info.taboo_allergy_cd" value="json:allergy_cd" />
  <item name="アレルギークラス" len="0" type="string"
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_hN11','ini_dial','R','感染:HBs','all','富士通想定透析初回申込-申込詳細','For test','1','
<root name="感染:HBs">
...
insert into ntss.mst_coop_layout_detail(
  ...
  , reg_date
  , up_date
)  values ('F_hN11','ini_dial','R','感染:HBe','all','富士通想定透析初回申込-申込詳細','For test','1','
<root name="感染:HBe">
  <item name="感染症コード" len="1" type="string"
    col="pat_main.infect_info.infect" value="json:infection_key" />
