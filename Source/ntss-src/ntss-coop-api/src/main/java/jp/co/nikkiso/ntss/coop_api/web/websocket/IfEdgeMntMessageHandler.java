...
public class IfEdgeMntMessageHandler extends TextWebSocketHandler{
  ...
  public IfEdgeMntMessageHandler() {
  }
  ...
  public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
    ...
    sessionManager.removeClient(session, status, IfedgeFixedResult.SERVER_DISCONNECT,false);
...
// mod 2023-02-22 bug #6912 エッジの連携処理を停止しても稼働ビューア画面では正常と表示される 孫 end
      ...
      sessionManager.removeClient(session, CloseStatus.SERVER_ERROR, IfedgeFixedResult.IFEDGE_RES_ERR,false);
      // mod 7348 IFエッジ→AWSへの死活監視電文が送信されなくなった 吉 start
      // ログに吐きだして正常に終了
