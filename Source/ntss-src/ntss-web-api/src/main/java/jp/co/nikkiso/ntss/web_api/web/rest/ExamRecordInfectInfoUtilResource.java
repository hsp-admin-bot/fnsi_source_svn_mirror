...
import jp.co.nikkiso.ntss.web_api.service.ExamRecordInfectInfoUtilService;
...
@RestController
@RequestMapping("util")
public class ExamRecordInfectInfoUtilResource {

  /**
   * 感染症情報更新Service
   */
  @Autowired
  private ExamRecordInfectInfoUtilService examRecordInfectInfoUtilService;
  ...
  * 感染症情報更新処理.
  */
  @PostMapping("/updateInfectinfo")
  public ResponseEntity<?> updateInfectinfo(
    @Valid @RequestBody String bodydata
    ){
    // wp アプリケーションログの適正化 Add Start
    String mappingUrl = "util" + "/updateInfectinfo";
    ...
    try {
      ...
      examRecordInfectInfoUtilService.updateInfectinfo(examMainCd);
