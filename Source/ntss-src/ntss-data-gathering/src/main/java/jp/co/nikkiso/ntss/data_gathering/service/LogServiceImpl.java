...
import jp.co.nikkiso.ntss.data_gathering.logger.LogObjectUtilsDataGathering;
  ...
  public void log(LogLevel logType, EventLogMessage eventLogMessage, String functionCode, String serviceName,
    ...
    try {
      ...
      if (sqlFilePath != null && eventLogMessage.getSqlIdentification() != null) {
        try {
          String sqlData = LogObjectUtilsDataGathering.readSqlFile(sqlFilePath);
      ...
      if (!StringUtils.isEmpty(serviceName)) {
        eventLogMessage.setServiceName(MODULE_NAME.NTSS_DATA_GATHERING + ", " + serviceName);
      }
