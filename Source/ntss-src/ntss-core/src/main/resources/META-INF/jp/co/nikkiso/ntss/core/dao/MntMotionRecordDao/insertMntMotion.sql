insert into mnt_motion_record 
  (event_reg_date, facility_cd, device_edge_no, machine_type_cd, machine_serial, com_format_cd, data_type, test_type, machine_record_message, contents, reg_date, up_date)
  values
  (
