...
WHERE rt.facility_cd = /*facilityCd*/NULL
  ...
  /*%end*/
  /*%if treatWeekList != null && 0 != treatWeekList.size() && 0 != treatWeekList.get(0)*/
  AND rt.treat_week IN /*treatWeekList*/(NULL)
  /*%end*/
  /*%if indTreatmentCdList != null && 0 != indTreatmentCdList.size()*/
  AND rt.ind_treatment_cd IN /*indTreatmentCdList*/(NULL)
  /*%end*/
  /*%if indKurCdList != null && 0 != indKurCdList.size()*/
  AND rt.before_kur_cd IN /*indKurCdList*/(NULL)
  /*%end*/
  ),
