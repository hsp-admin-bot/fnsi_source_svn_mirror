...
ord_material_save_data AS (
 ...
 where oms.supplies_source_class in ('0', '1', '2', '3')
)
,cond_data_ord AS (
  SELECT
    ord_no,
...
FROM treatment_data_ord mdo
  LEFT JOIN mst_medicine_treatment mm ON mdo.json_value::int = mm.medicine_cd and mdo.medicine_type = '1'
  LEFT JOIN mst_medicine_mix_treatment mmm ON mdo.json_value::int = mmm.medicine_mix_cd and mdo.medicine_type != '1'
)
