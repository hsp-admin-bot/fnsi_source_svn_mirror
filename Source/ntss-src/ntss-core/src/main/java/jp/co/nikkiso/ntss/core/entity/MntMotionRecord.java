...
import jp.co.nikkiso.ntss.core.entity.entityListener.MntMotionRecordEntityListener;
 ...
 * 装置動作記録のEntity.
 */
@Entity(listener = MntMotionRecordEntityListener.class, naming=NamingType.SNAKE_LOWER_CASE)
...
public class MntMotionRecord extends BaseEntity{
  ...
  /**
   * URL設定.
   * 施設マスタのVPNセット項目の値を格納します。送信用メール本文に入れるサインインURL判定に使用します。
   */
  private String facilityUrlSetting;
