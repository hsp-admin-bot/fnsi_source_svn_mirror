...
public class EventLogMessage {
  ...
  public String buildLogMessage(LogLevel logLevel) {
    ...
    return Arrays.asList(
      logLevel.getLevel(), 
            Thread.currentThread().getName(), // add by shiyw 2023-03-17 : It is used to group logs with thread IDs and helps analyze problems
      facilityCd,
      userId,
      clientIp,
      sessionId,
      ...
      .map(value -> StringUtils.isEmpty(value) ? "" : value)
