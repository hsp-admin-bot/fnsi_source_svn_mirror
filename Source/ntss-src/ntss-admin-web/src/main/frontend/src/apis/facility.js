 ...
 * @param {string} facilityCd 施設コード
 */
export function sendRequestGetDoctorsAtFacility(facilityCd, selectedPatId) {
  return ApiHelper.get(
    `/facilities/${facilityCd}/personal-user/job/doctor`,
 ...
 * @param {string} facilityCd 施設コード
 */
export function sendRequestGetDoctorsAtFacilityIncludeDel(facilityCd, selectedPatId) {
  return ApiHelper.get(
    `/facilities/${facilityCd}/personal-user/job/doctorIncludeDel`,
    withSelectedPatId(undefined, selectedPatId)
  );
}
 ...
 * @param {string} facilityCd 施設コード
 */
export function sendRequestGetMstFacilityByCd(facilityCd, selectedPatId) {
  return ApiHelper.get(
