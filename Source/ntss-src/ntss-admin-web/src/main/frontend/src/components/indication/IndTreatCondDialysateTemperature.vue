...
<template>
  ...
  <!-- <v-ons-row> -->
    <v-ons-row :class="getIsUseFlagDialysateTemperature ? 'cell-disabled' : ''">
  <!-- mod 9664補液及び透析液仕様修正します yangqingzhe end -->
    <v-ons-col class="action-condition-column">透析液温度</v-ons-col>
    <v-ons-col class="action-condition-data-column">
      ...
      <!-- <custom-input-number
        ...
        :min-value="0.0"
        :max-value="999.0"
        :disabled="isDisabled || getIsUseFlagDialysateTemperature"
        class="action-condition-input ntss-custom-input-cond"
        style="width: 60px"
        @change="changeButton()"
      /> -->
      ...
      <!-- <custom-input-number
        ...
        :min-value="0.0"
        :max-value="999.0"
        :disabled="isDisabled || getIsUseFlagDialysateTemperature || !getItemAuthorized('Indication', 'default_authority')"
        class="action-condition-input ntss-custom-input-cond"
        style="width: 60px"
      /> -->
...
export default {
  ...
  computed: {
    ...mapGetters("pat-viewer-treat-cond", {
      ...
      // add 8204 周安寧 start
      getIsUseFlagDialysateTemperature: "getIsUseFlagDialysateTemperature"
      // add 8204 周安寧 end
    })
  },
  methods: {
