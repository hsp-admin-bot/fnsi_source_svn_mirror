  ...
  <v-card>
    ...
    <v-ons-popover cancelable
      ...
      <div style='margin:10px;'>
        ...
        <!-- mod #7320 start LJX-->
        <!--<v-ons-row class='condition-row' v-if="masterPhysicalName != 'sys_medicine' && masterPhysicalName != 'mst_take_medicine' && masterPhysicalName != 'mst_holiday'">-->
        <v-ons-row class='condition-row' v-if="masterPhysicalName != 'sys_medicine' && masterPhysicalName != 'mst_take_medicine' && masterPhysicalName != 'mst_holiday' && masterPhysicalName != 'mst_vital_graph'">
        <!-- mod #7320 end LJX-->
          <v-ons-col width='40%' vertical-align='center'>
            <v-ons-checkbox input-id='includeDeleted' float  v-model='condition.inProgress.includeDeleted'></v-ons-checkbox>
          </v-ons-col>
          <v-ons-col width='60%' v-if="masterPhysicalName != 'mst_holiday'" vertical-align='center'>
