...
@Component
public class ECUMtreatmentPattern implements PatTreatmentPatternStategy, InitializingBean {
  @Autowired
  PatTreatmentPatternDao patTreatmentPatternDao;

  @Override
  public void update(OrdMainOnly ord, String facilityCd, Integer code) {
    patTreatmentPatternDao.updatePatTreatmentPatternByPatIdsECUM(ord,facilityCd,code);
  }
