...
/**
 * 透析液流量自己診断結果記録のResponse返却用Model.
 */
public class DialysateFlowRateTestModel extends BaseTestModel {
  
  /**
   * 透析液流量自己診断結果のJSONオブジェクト.
   */
  public DialysateFlowRateTestDto result;
...
//  public DialysateFlowRateTestModel(String eventRegDate, String eventRegTime, DialysateFlowRateTestDto result) {
//    // イベント発生日時
...
//    this.result = result;
//  }
  public DialysateFlowRateTestModel(String eventRegDate, String eventRegTime, DialysateFlowRateTestDto result,String motionRecordNo) {
    // イベント発生日時
    this.eventRegDate = eventRegDate;
    this.eventRegTime = eventRegTime;
    // 自己診断結果
