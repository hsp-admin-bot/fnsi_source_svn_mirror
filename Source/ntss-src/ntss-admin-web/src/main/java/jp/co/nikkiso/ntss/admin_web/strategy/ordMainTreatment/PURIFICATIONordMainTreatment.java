...
@Component
public class PURIFICATIONordMainTreatment implements OrdMainTreatmentStrategy, InitializingBean {
  @Autowired
  ...
  public void update( Integer treatmentCd, OrdMainOnly ord, List<Long> ordNoList,
    ...
    ordMainDao.updateByTreatmentCdOnlyForPURIFICATION(treatmentCd,ord,ordNoList,indUserId,userId);
  }

  @Override
  public void afterPropertiesSet() throws Exception {
    register("PURIFICATION",this);
    // add #10739 コンバート施設で指示受け(治療単位)が表示されない 関 start
    register("UNKNOWN",this);
