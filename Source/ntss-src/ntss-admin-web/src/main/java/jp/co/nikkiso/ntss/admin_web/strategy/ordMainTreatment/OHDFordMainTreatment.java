...
@Component
public class OHDFordMainTreatment implements OrdMainTreatmentStrategy, InitializingBean {
  @Autowired
  ...
  public void update(Integer treatmentCd, OrdMainOnly ord, List<Long> ordNoList,
    ...
    ordMainDao.updateByTreatmentCdOnlyForOHDF(treatmentCd,ord,ordNoList,indUserId,userId);
  }
