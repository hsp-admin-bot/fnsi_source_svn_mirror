...
public class Constant {
  ...
  public static class DailyReportDispItemCd {
     ...
     * 血液回路
     */
    public static final short BLOOD_CIRCUIT = 87;
    /**
     * 吸着カラム
     */
    public static final short ADSORBENT = 88;
    /**
     * 補液
     */
    public static final short FLUID_REPLACEMENT = 89;
  ...
  public static class NextPatMemoItemCd {
    ...
    */
     ...
     * 目標体重
     */
    public static final int targetWeight = 56;
    /**
     * 血流量
     */
     ...
     * IP速度
     */
    public static final int ipSpeed = 58;
    /**
     * IPワンショット量
     */
    public static final int ipOneshot = 59;
    /**
     * IP自動切時間
     */
    public static final int ipAutoPowerOffTime = 60;
    /**
     * 補液選択
     */
    public static final int fluidReplacementSelect = 61;
    /**
     * 補液量
     */
    public static final int fluidReplacementVolume = 62;
    /**
     * 補液速度
     */
    public static final int fluidReplacementRate = 63;
    /**
     * 一次膜
     */
    public static final int oneceMembrane = 64;
    // add FNSI-バグ 通信サーバ #8009 高 end
    /**
    * (空白)
    */
  ...
  public static class WebSocketTopic {
    ...
    public static class WeightState {
       ...
       * 装置状態
       */
      public static final String MACHINE_RESULT = "MACHINE/MACHINE_RESULT";
