DELETE from sys_data_set where sql_cd= -497;
DELETE from sys_data_set where sql_cd= -494;
...
ORDER BY
  all_cost.e01
	limit 108', 2, '[{}]', '1', '{"applications": [4]}', NULL, '日機装)実績）医材繰り返し部', '2020-05-22 11:43:49.001', CURRENT_TIMESTAMP, NULL);
