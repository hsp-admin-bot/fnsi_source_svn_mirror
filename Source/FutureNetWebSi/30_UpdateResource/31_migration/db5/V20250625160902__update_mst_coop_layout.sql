...
VALUES(-11040014, 'Secom', 'ind_dial', '', 'S', 'upd', 'csv', 'セコム連携_透析指示連携', 'Secom', '透析指示連携（rootレイアウト）', '1', '<root name="透析指⽰電文">
  ...
  <file name="注射依頼" detail="inj_top_cre" sqlCode="-1100011"/>
  <file name="カルテ記録" detail="med_top_cre" sqlCode="-1100010"/>
</root>', '{"dataset": [{"key0": "key0", "key1": "SCM_DIALYSISSCHESEND", "key2": "SCHE_FILE_NAME", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102006, "facilityCd": "facilityCd", "file_extension": "csv"}, {"key0": "key0", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102007, "facilityCd": "facilityCd"}, {"key0": "key0", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102008, "facilityCd": "facilityCd"}, {"key0": "key0", "key1": "SCM_DIALYSISSCHESEND", "key2": "KARTE_FILE_STR", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102009, "facilityCd": "facilityCd", "file_extension": "txt"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Secom');
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
</root>', '{"dataset": [{"key0": "key0", "key1": "SCM_DIALYSISSCHESEND", "key2": "SCHE_FILE_NAME", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102016, "facilityCd": "facilityCd", "file_extension": "csv"}, {"key0": "key0", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102017, "facilityCd": "facilityCd"}, {"key0": "key0", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102018, "facilityCd": "facilityCd"}, {"key0": "key0", "key1": "SCM_DIALYSISSCHESEND", "key2": "KARTE_FILE_STR", "ctlNo": "ctlNo", "patId": "patId", "sqlCode": -1102019, "facilityCd": "facilityCd", "file_extension": "txt"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Secom');