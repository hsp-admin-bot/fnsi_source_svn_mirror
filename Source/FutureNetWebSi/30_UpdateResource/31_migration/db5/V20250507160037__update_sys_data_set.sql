...
else (case when  (picked_input_params [ 1 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[1]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[1]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data1
...
else (case when  (picked_input_params [ 2 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[2]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[2]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data2
...
else (case when  (picked_input_params [ 3 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[3]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[3]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data3
...
else (case when  (picked_input_params [ 4 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[4]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[4]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data4
...
else (case when  (picked_input_params [ 5 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[5]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[5]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data5
...
else (case when  (picked_input_params [ 6 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[6]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[6]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data6
...
(case when  (picked_input_params [ 7 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[7]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[7]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data7
...
else (case when  (picked_input_params [ 8 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[8]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[8]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data8
...
else (case when  (picked_input_params [ 9 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[9]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[9]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data9
...
else (case when  (picked_input_params [ 10 ]-> ''item_json'') ->> ''is_formatting'' = ''1'' then substring(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g'') from 1 for length(regexp_replace(picked_result_params[10]->>''result_value'' , ''</[p^>]*>'', E''\n'', ''g''))) else picked_result_params[10]->>''result_value'' end)
end, ''<[^>]*>'', '''', ''g'')) as data10
from
  pe_array_agg
  inner join pe_basicinfo on pe_array_agg.pat_event_cd = pe_basicinfo.pat_event_cd
