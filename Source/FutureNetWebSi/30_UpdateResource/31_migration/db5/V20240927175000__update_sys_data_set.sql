DELETE FROM "ntss"."sys_data_set" where sql_cd in ('-2420', '-2430');
...
', 2, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者病歴情報　@facilityCd @fromDate @toDate使用 {"Mergekey": ["patid"]}', '2021-02-26 17:51:54.726', '2024-08-27 18:13:40.486', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2430, 'WITH sys_moni AS (
    ...
    , ntss_db5_om.ord_no AS ordno --透析番号
        ...
        WHERE
            ...
            AND ntss_db5_mm.data_type IN (1,2,5,6);', 2, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者病歴情報　@facilityCd使用 {"Mergekey": ["patid"]}', '2021-02-26 17:51:54.726', '2024-08-27 18:13:40.486', NULL);
