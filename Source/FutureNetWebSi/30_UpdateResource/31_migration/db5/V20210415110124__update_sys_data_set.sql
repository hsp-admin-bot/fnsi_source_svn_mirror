UPDATE "ntss"."sys_data_set" SET "sql" = 'with ord_tbl as (
  ...
  and 
     treat_date > (select treat_date from ord_main where ord_no=@ordNo and is_del = ''0'' and rst_dialysis_state = ''0'') ORDER BY treat_date ASC limit 1	
  and is_del = ''0''
  and rst_dialysis_state = ''0''
), kur_tbl as (
  select
