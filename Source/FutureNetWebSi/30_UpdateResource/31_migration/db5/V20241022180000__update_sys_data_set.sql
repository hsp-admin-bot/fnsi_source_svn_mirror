DELETE FROM sys_data_set WHERE sql_cd IN (-800011,-66669);
...
from (SELECT 0 as rows,
      ...
      order by rows
      limit 1) as t', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '富士通）検査依頼：検査日時取得 ★削除用', '2023-06-16 17:46:51.625', CURRENT_TIMESTAMP, NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
