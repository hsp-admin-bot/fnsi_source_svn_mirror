...
VALUES ( 
  ...
  , CASE ''@patBloodTypeRh'' 
    WHEN '''' THEN ''0'' 
    ELSE 
         CASE WHEN (select ''@patBloodTypeRh'' ~ ''^[0-9\.]+$'') = true THEN TO_NUMBER(''@patBloodTypeRh'', ''FM9999999999999999'') 
              ELSE ''0'' 
         END
    END 
...
)', 3, '[{}]', '0', '{"applications": [4]}', NULL, '(受信用)患者個人情報の取得の新規', '2020-05-25 18:21:40.841', '2022-02-07 08:32:43.192', '[{"sql_cd": 1001, "field_name": "dial_diff_com_info", "replace_var": "@dialDiffComInfo"}]');
