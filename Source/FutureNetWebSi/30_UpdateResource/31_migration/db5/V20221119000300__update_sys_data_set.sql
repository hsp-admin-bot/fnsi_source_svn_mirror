...
from data_all_meq where aa = ''治医疗材料'' order by sorttag1
 ...
 sorttag::text,sortTag1::text,sortTag2::text,''药剂''::text as  aa, ROW_NUMBER() OVER()::text as ordernow
 from med_order),
 ...
 ''手技''::text as aa
  ...
  med_order4 as
  (--手技の番号取得
	select med_order3.* ,med_order2.ordernow::text  as ordernow from med_order2,med_order3 where med_order2.sorttag1=med_order3.sorttag1  order by ordernow),
