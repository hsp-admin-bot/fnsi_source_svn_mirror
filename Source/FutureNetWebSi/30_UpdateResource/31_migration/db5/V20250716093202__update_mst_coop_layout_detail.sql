...
WHERE ctl_no in (-1111000002, -1111000003, -1111000004, -1111000005, -1111000006);
...
', '{"dataset": [{"key0": "key0", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1106006, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, '2025-06-24 10:35:38.507', CURRENT_TIMESTAMP, 'Secom');
INSERT INTO mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"key0": "key0", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1106007, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, '2025-06-24 10:35:38.507', CURRENT_TIMESTAMP, 'Secom');
INSERT INTO mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"key0": "key0", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1106008, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, '2025-06-24 10:35:38.507', CURRENT_TIMESTAMP, 'Secom');