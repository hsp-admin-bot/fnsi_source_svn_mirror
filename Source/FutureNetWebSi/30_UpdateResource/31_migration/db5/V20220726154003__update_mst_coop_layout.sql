DELETE FROM "ntss"."mst_coop_layout" WHERE ctl_no IN (-1040003,-1070003,-1070006);
INSERT INTO "ntss"."mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1070006, 'nkknkk', 'rst_dial', '', 'S', 'del', 'text', '日機装拡張', 'nikkiso', '透析実績(拡張)', '1', '<root name="日機装拡張(透析実績)" multi="true:CRLF">
    ...
    <item  name="透析実施時間" len="3" value="dataset:-14.running_time_str"/>
...
INSERT INTO "ntss"."mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-1040003, 'nkknkk', 'ind_dial', '', 'S', 'del', 'text', '日機装標準', 'nikkiso', '透析予約', '1', '<root name="日機装標準(透析予約)" multi="true:CRLF">
    ...
    <item  name="抗凝固剤コード" len="8" value="dataset:-131.ds_cd1"/>
    <item  name="抗凝固剤総量" len="8" value="dataset:-131.anti_coagulant_total_amount"/>
    <item  name="抗凝固剤単位" len="8" value="dataset:-131.anti_coagulant_one_shot_amount_unit"/>
...
</root>', '{"dataset": [{"patId": "patId", "sqlCode": -400001}, {"ordNo": "ordNo", "sqlCode": -131}, {"ordNo": "ordNo", "sqlCode": -13}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -952, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -852, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -181, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -502, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -191, "facilityCd": "facilityCd"}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -99992}, "CoopIniConvUtil": {"-400001.in_out_class": "CONV_INOUT_TO_KARTE"}}', '1', '0', -4, '2022-07-04 05:09:15.054', CURRENT_TIMESTAMP);
