...
-- コメント修正
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hosp_a_startdate" IS E'利用開始日A';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_a1" IS E'院内コードA1';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_a2" IS E'院内コードA2';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_a3" IS E'院内コードA3';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_a4" IS E'院内コードA4';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hosp_b_startdate" IS E'利用開始日B';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_b1" IS E'院内コードB1';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_b2" IS E'院内コードB2';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_b3" IS E'院内コードB3';
COMMENT ON COLUMN "mst_pat_event_sub_category"."in_hospital_cd_b4" IS E'院内コードB4';
