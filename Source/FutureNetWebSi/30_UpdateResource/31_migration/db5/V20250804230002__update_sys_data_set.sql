...
WHERE sql_cd IN (-1103016, -1103017, -1103018, -1103019, -1103020, -1103021, -1103022);
...
order by rp_no;
-- SQL: -1103018 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 注射実績(削除電文用)', current_timestamp, current_timestamp, '[{"sql_cd": -1103016, "field_name": "content_json", "replace_var": "@contentJson"}]'::jsonb);
...
FROM rows;
-- SQL: -1103019 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 行取得用(削除電文用)', '2025-07-24 22:27:41.353', '2025-07-24 22:27:41.353', '[{"sql_cd": -1102029, "field_name": "content_json", "replace_var": "@contentJson"}]'::jsonb);
...
FROM rows;
-- SQL: -1103020 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 項目取得用(削除電文用)', current_timestamp, current_timestamp, '[{"sql_cd": -1102029, "field_name": "content_json", "replace_var": "@contentJson"}]'::jsonb);
...
SELECT 
    ...
    row->>39 AS col40
FROM rows
where row->>@targetColNo = @targetColValue::text;
-- SQL: -1103021 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 注射実績 行取得用(削除電文用)', current_timestamp, current_timestamp, '[{"sql_cd": -1102029, "field_name": "content_json", "replace_var": "@contentJson"}]'::jsonb);
...
where row->>@targetColNo = @targetColValue::text;
-- SQL: -1103022 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 注射実績 項目取得用(削除電文用)', current_timestamp, current_timestamp, '[{"sql_cd": -1102029, "field_name": "content_json", "replace_var": "@contentJson"}]'::jsonb);
