...
WHERE sql_cd IN (-307086, -307133, -307134, -307135);
...
', 2, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, NULL, '2025-06-19 10:54:40.687', CURRENT_TIMESTAMP, NULL);
INSERT INTO sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
', 2, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '処方薬剤連携 処置・治療項目情報の存在確認', '2025-06-19 10:54:40.687', CURRENT_TIMESTAMP, '[{"sql_cd": -307033, "field_name": "dial_diff_cds", "replace_var": "@dialDiffCds"}]'::jsonb);
INSERT INTO sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
)', 2, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '処方薬剤連携 処置・人工腎臓以外(夜間・休日加算)情報の存在確認', '2025-06-19 10:54:40.687', CURRENT_TIMESTAMP, NULL);
INSERT INTO sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
)', 2, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '処方薬剤連携 処置・人工腎臓以外(導入期加算)情報の存在確認', '2025-06-19 10:54:40.687', CURRENT_TIMESTAMP, NULL);