delete from "mst_coop_layout" where "ctl_no" in (-2100001,-2100002,-2100003);
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2100001, 'F_hosp', 'exam_ord', '', 'S', 'cre', 'text', '富士通検査依頼', 'fujitsu', '検体検査依頼', '1', '<root name="検査依頼">
    ...
    <item  name="伝票情報.オーダ番号" len="8" value="$JOURNAL.coop_ord_no" padding_format="zero" padding_position="left"/>
    ...
    <item  name="伝票情報.文書番号(オーダ番号)" len="8" value="$JOURNAL.coop_ord_no" padding_format="zero" padding_position="left"/>
    ...
    <item  name="伝票情報.伝票コード" len="4" value="const:E001"/>
    <item  name="伝票情報.伝票名称" len="50" value="const:透析発生検査"/>
...
</root>', '{"dataset": [{"patId": "patId", "sqlCode": -20}, {"ordNo": "ordNo", "sqlCode": -23}, {"ordNo": "ordNo", "sqlCode": -25, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -26, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -39, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -100001}]}', '1', '0',-1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
