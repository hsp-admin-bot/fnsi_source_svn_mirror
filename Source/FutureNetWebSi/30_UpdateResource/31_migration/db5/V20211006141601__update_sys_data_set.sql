...
]',can_repeat='0',use_application='{"applications": [1]}',report_class='{"classes": [1, 2, 3, 9, 10, 11]}',memo='実績（治療中）：透析条件/ベッド情報/ダイアライザ情報/実績情報 @ordNo 使用',reg_date='2021-08-05T13:30:00',up_date='2021-08-05T13:30:00',pre_sql_info=null where sql_cd=166;
