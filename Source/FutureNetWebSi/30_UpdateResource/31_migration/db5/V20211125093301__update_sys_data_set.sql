...
SELECT ord_no,disp_order,to_timestamp(treat_date,''YYYYMMDD'') as treat_date,kind,Name,SUM(Amount) as amount,unit,in_hospital_cd_1,in_hospital_cd_2,in_hospital_cd_3,in_hospital_cd_4 
FROM (
