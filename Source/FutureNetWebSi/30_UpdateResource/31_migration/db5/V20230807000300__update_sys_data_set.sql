delete from ntss.sys_data_set where sql_cd in ('-131','-13');
...
WHERE
  ...
  pm.pat_id = ord.pat_id', 2, '[{}]', '0', '{"applications": [4]}', NULL, '汎用）指示）透析条件', '2022-08-05 10:58:32.885', '2023-08-04 08:05:35.359', NULL);
...
', 2, '[{}]', '0', '{"applications": [4]}', NULL, '汎用）指示）透析条件', '2022-06-18 05:06:30.638', '2023-08-04 08:05:35.359', NULL);
