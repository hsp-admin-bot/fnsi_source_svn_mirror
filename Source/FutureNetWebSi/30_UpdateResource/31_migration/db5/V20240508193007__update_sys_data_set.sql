DELETE FROM ntss.sys_data_set WHERE sql_cd IN (3303);
...
WHERE
  ...
  AND pat_id = @patId 
  AND facility_cd = ''@facilityCd'' ', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)富士通の初回申し込み→治療情報(バックアップ)', '2022-01-07 18:21:46.000', CURRENT_TIMESTAMP, NULL);
