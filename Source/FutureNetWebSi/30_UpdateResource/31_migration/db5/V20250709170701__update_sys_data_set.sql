DELETE FROM "ntss"."sys_data_set" WHERE sql_cd IN (6,199);
...
order by
  ...
  (
   ...
   where ord.is_del = ''0'' and ord.rst_dialysis_state <> ''0''
    and ord_no = @ordNo
    and (treatment->>''medicine_type'' is null or treatment->>''medicine_type'' = ''1'')
union all
    select
      ord.ord_no,
      treatment->>''occur_date'' as occur_date,
