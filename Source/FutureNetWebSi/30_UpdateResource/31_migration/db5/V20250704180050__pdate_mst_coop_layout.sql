DELETE FROM mst_coop_layout WHERE ctl_no IN (
  -12101001, -12102001,-12103001
  );


INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_format, coop_name, coop_vender, description, is_editable, coop_cd_sub, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-12101001, 'F_SX', 'exam_ord', '', 'S', 'text', 'SX連携_血液検査', 'F_SX', '血液検査', '1', 'cre', '<root name="検査依頼">
...
', '{"dataset": [{"key0": "key0", "patId": "patId", "sqlCode": -1200000, "facilityCd": "facilityCd"}, {"key0": "key0", "sqlCode": -1202000, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202001, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202002, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -1202003, "facilityCd": "facilityCd"}, {"key0": "key0", "patId": "patId", "sqlCode": -1202004, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202007, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202008, "facilityCd": "facilityCd"}], "dumpFileName": {"key0": "key0", "ctlNo": "ctlNo", "sqlCode": -1202020, "facilityCd": "facilityCd"}, "CoopIniConvUtil": {"-1202004.pat_sex": "CONV_SEX_TO_KARTE", "-1202004.in_out_class": "CONV_INOUT_TO_KARTE"}}'::jsonb, '1', '0', 4, '2025-06-12 12:01:39.589', CURRENT_TIMESTAMP, 'F_SX');
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_format, coop_name, coop_vender, description, is_editable, coop_cd_sub, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-12103001, 'F_SX', 'exam_ord', '', 'S', 'text', 'SX連携_血液検査', 'F_SX', '血液検査', '1', 'del', '<root name="検査依頼">
  <item name="レコード区分" len="2" value="const:O1"/>
  <item name="センターコード" len="6" value="dataset:-1202000.code"/>
  <item name="検査予定日" len="8" value="dataset:-1202001.exam_date_yyyymmdd"/>
  <item name="検査予定時刻" len="4" value="dataset:-1202002.treat_time"/>
...
', '{"dataset": [{"key0": "key0", "patId": "patId", "sqlCode": -1200000, "facilityCd": "facilityCd"}, {"key0": "key0", "sqlCode": -1202000, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202001, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202002, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -1202003, "facilityCd": "facilityCd"}, {"key0": "key0", "patId": "patId", "sqlCode": -1202004, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202007, "facilityCd": "facilityCd"}, {"key0": "key0", "ordNo": "ordNo", "sqlCode": -1202008, "facilityCd": "facilityCd"}], "dumpFileName": {"key0": "key0", "ctlNo": "ctlNo", "sqlCode": -1202020, "facilityCd": "facilityCd"}, "CoopIniConvUtil": {"-1202004.pat_sex": "CONV_SEX_TO_KARTE", "-1202004.in_out_class": "CONV_INOUT_TO_KARTE"}}'::jsonb, '1', '0', -1, '2025-06-12 12:01:39.589', CURRENT_TIMESTAMP, 'F_SX');
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_format, coop_name, coop_vender, description, is_editable, coop_cd_sub, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-12102001, 'F_SX', 'exam_ord', '', 'S', 'text', 'SX連携_血液検査', 'F_SX', '血液検査', '1', 'upd', '<root name="検査依頼">
  <item name="レコード区分" len="2" value="const:O1"/>
  <item name="センターコード" len="6" value="dataset:-1202000.code"/>
  <item name="検査予定日" len="8" value="dataset:-1202001.exam_date_yyyymmdd"/>
  <item name="検査予定時刻" len="4" value="dataset:-1202002.treat_time"/>
