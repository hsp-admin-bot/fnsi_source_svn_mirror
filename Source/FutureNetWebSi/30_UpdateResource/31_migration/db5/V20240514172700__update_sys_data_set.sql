...
WITH 
	...
	UNION ALL
	    ...
	    ,ntss_db5_mst_list_ici.ind_user_id AS indicatorcd -- 指示者(加筆要りそうな気がする)
	    ,  CASE
	        WHEN ntss_db5_ptp.flg = ''1''
	            THEN ''0''
	        ELSE ''1''
...
;
', 3, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者病歴情報　@facilityCd使用 {"Mergekey": ["patid"]}', '2021-02-26 17:51:54.726', CURRENT_TIMESTAMP, NULL);
