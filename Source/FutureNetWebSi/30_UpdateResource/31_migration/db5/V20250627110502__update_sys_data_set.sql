...
SELECT
  ...
  to_char(to_timestamp(@time, ''YYYYMMDDHH24MISS''), ''YYYY-MM-DD'') AS occur_date,
  to_char(to_timestamp(@time, ''YYYYMMDDHH24MISS''), ''HH24:MI:SS'') AS occur_time
FROM
  (SELECT
