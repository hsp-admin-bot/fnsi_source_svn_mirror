...
<item  name="薬剤数量" len="8" value="dataset:-18.medi_amount" padding_format="blank" padding_position="left"/>
<item  name="薬剤回数" len="2" value="dataset:-18.medi_back" padding_format="blank" padding_position="left"/>
