            ...
            string_to_array(
              (
                SELECT
                  mst_f.value AS rtt
                FROM
                  mst_facility_setting AS mst_f
                WHERE
                  mst_f.facility_setting_no = ''3007''
            ...
            string_to_array(
              (
                ...
                FROM
                  mst_facility_setting AS mst_f
                WHERE
                  mst_f.facility_setting_no = ''3006''
                  AND mst_f.facility_cd = @facilityCd
              ),
              '',''
            )
...
, pro_medi_table AS (
  ...
  FROM (
    ...
    SELECT
        imi.temp_no,
        33000 + imi.medicine_type as medicine_type,
        33000 + t.timing_code_order AS timing_code_order,
        33000 + p.procedure_code_order AS procedure_code_order,
        33000 + imi.interval_no AS interval_no,
        33000 + mst_medi.medi_code_order AS medi_code_order,
        33000 + mst_medi.medi_class_code_order AS medi_class_code_order,
        imi.mst_cd::integer AS mst_cd,
        imi.hosp_cd AS hosp_cd,
        imi.amount AS amount,
        imi.unit AS unit,
  ...
  UNION ALL
    SELECT
        ti.temp_no,
        50000 + ti.medicine_type as medicine_type,
        50000 + t.timing_code_order AS timing_code_order,
        50000 + p.procedure_code_order AS procedure_code_order,
        50000 + ti.interval_no AS interval_no,
        50000 + mst_medi.medi_code_order AS medi_code_order,
        50000 + mst_medi.medi_class_code_order AS medi_class_code_order,
        ti.mst_cd::integer AS mst_cd,
        ti.hosp_cd AS hosp_cd,
        ti.amount AS amount,
        ti.unit AS unit,
