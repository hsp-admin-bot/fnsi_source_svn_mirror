...
WHERE sql_cd IN (-2010,-2011,-2012,-2013,-2014,-2015,-2016,-2515,-2516,-2517)
;
...
FROM
    mst_transport mst
WHERE
    mst.facility_cd = @facilityCd', 2, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者基本情報：　@facilityCd使用 {"Mergekey": ["mergetransportcd"]}', '2021-07-29 16:18:57.000', CURRENT_TIMESTAMP, NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2014, 'SELECT
...
FROM
    mst_disease mst
WHERE
    mst.facility_cd = @facilityCd', 2, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者基本情報：　@facilityCd使用 {"Mergekey": ["mergediseasecd"]}', '2021-07-29 16:18:57.000', CURRENT_TIMESTAMP, NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
...
', 3, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者基本情報：@facilityCd @fromDate @toDate使用 {"Mergekey": ["patid","doctorcd1","mergedialdiffcd","mergediseasecd","mergetransportcd", "severitycd","doctorcd2","staffcd1","staffcd2"]}', '2021-02-26 17:51:54.000', '2021-02-26 17:51:54.000', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2016, 'SELECT
...
WHERE
    mst.facility_cd = @facilityCd', 3, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者基本情報：　@facilityCd使用 {"Mergekey": ["doctorcd1"]}', '2021-07-29 16:18:57.000', CURRENT_TIMESTAMP, NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2013, 'SELECT
...
FROM
    mst_personal_user mst
WHERE
    mst.facility_cd = @facilityCd', 3, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者基本情報：　@facilityCd使用 {"Mergekey": ["doctorcd2"]}', '2021-07-29 16:18:57.000', CURRENT_TIMESTAMP, NULL);
    INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2516, 'SELECT
...
FROM
    mst_personal_user mst
WHERE
    mst.facility_cd = @facilityCd', 3, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者基本情報：　@facilityCd使用 {"Mergekey": ["staffcd1"]}', '2021-07-29 16:18:57.000', CURRENT_TIMESTAMP, NULL);
    INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2517, 'SELECT
...
FROM
    mst_personal_user mst
WHERE
    mst.facility_cd = @facilityCd', 3, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者基本情報：　@facilityCd使用 {"Mergekey": ["staffcd2"]}', '2021-07-29 16:18:57.000', CURRENT_TIMESTAMP, NULL);