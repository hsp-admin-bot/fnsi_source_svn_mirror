delete from "mst_coop_layout" where "ctl_no" in (-5170001,-5170002,-5170003);
...
', '{"dataset": [{"patId": "patId", "sqlCode": -500001}, {"ordNo": "ordNo", "sqlCode": -11}, {"ctlNo": "ctlNo", "ordNo": "ordNo", "sqlCode": -38}, {"ordNo": "ordNo", "sqlCode": -14}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -99987}}', '1', '0', 4, '2020-05-22 09:38:28.418', '2020-05-22 09:38:33.3');
...
', '{"dataset": [{"patId": "patId", "sqlCode": -500001}, {"ordNo": "ordNo", "sqlCode": -11}, {"ctlNo": "ctlNo", "ordNo": "ordNo", "sqlCode": -38}, {"ordNo": "ordNo", "sqlCode": -14}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -99987}}', '1', '0', 4, '2020-05-22 09:38:28.418', '2020-05-22 09:38:33.3');
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-5170003, 'S_hosp', 'karte_ord', '', 'S', 'del', 'xml', 'SSI', 'SSI', 'karte', '1', '<SsiData Type="KARTE_NOTIFY">
    <NotifyDate>$SYSDATE yyyyMMdd</NotifyDate><!-- yyyyMMdd,yyyy/MM/dd,yyyy-MM-dd -->
    <NotifyTime>$SYSTIME HHmmss</NotifyTime><!-- HHmmssSSS,HHmmss,HH:mm:ss.SSS,HH:mm:ss -->
    <Karte>
        <PatientID>dataset:-500001.hosp_pat_id8</PatientID><!-- パラメータをジャーナルのid -->
