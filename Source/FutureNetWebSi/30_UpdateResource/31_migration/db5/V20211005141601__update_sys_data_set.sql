...
]',can_repeat='0',use_application='{"applications": [1]}',report_class='{"classes": [1, 2, 3, 9, 10, 11]}',memo='実績(前回体重)',reg_date=now(),up_date=now(),pre_sql_info=null where sql_cd=12;
