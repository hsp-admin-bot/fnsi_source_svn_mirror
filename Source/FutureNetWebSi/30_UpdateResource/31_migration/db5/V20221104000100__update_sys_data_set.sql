DELETE from sys_data_set where sql_cd = 5;
...
from
  ord_main as ord
	...
	left join mst_dialyzer md on md.dialyzer_cd = cast(ord.ind_cond_info->''5''->>''value'' as INTEGER)	and md.dialyzer_cd IN (@diaIds)	
where
  ord.ord_no = @ordNo
