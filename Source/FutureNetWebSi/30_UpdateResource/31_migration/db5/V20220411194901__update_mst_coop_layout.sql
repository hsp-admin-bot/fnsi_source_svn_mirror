DELETE FROM "ntss"."mst_coop_layout" where "ctl_no" IN (-5040001,-5040002,-5040003);
INSERT INTO "ntss"."mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-5040001, 'S_hosp', 'ind_dial', '', 'S', 'cre', 'xml', 'SSI', 'SSI', '予定送信', '1', '<SsiData Type="DIALYSISPLAN">
    <PlanData>
...
</SsiData>', '{"dataset": [{"patId": "patId", "sqlCode": -500001}, {"ordNo": "ordNo", "sqlCode": -13}, {"ordNo": "ordNo", "sqlCode": -305}, {"ordNo": "ordNo", "sqlCode": -306}, {"ordNo": "ordNo", "sqlCode": -307}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -99989}}', '1', '0', 4, '2020-05-25 11:02:55.825', CURRENT_TIMESTAMP);
INSERT INTO "ntss"."mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-5040002, 'S_hosp', 'ind_dial', '', 'S', 'upd', 'xml', 'SSI', 'SSI', '予定送信', '1', '<SsiData Type="DIALYSISPLAN">
    <PlanData>
        <PatientID>dataset:-500001.hosp_pat_id8</PatientID>
        <DIALYSIS_DATE>dataset:-13.dialysis_date</DIALYSIS_DATE>
        <DIALYSIS_NO>0</DIALYSIS_NO>
...
INSERT INTO "ntss"."mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-5040003, 'S_hosp', 'ind_dial', '', 'S', 'del', 'xml', 'SSI', 'SSI', '予定送信', '1', '<SsiData Type="DIALYSISPLAN">
    <PlanData>
        <PatientID>dataset:-500001.hosp_pat_id8</PatientID>
        <DIALYSIS_DATE>dataset:-13.dialysis_date</DIALYSIS_DATE>
        <DIALYSIS_NO>0</DIALYSIS_NO>
