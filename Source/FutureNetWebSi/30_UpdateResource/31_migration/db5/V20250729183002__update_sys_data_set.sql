DELETE FROM ntss.sys_data_set WHERE sql_cd in (-1102029, -1102031);
...
INSERT INTO ntss.sys_data_set (sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES(-1102031, '-- SQL: -1102031 begin
...
FROM rows;
-- SQL: -1102031 end	
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '透析指示連携 新規処理dump取得用', '2025-07-25 11:29:21.073', current_timestamp, '[{"sql_cd": -1102029, "field_name": "content_json", "replace_var": "@contentJson"}]'::jsonb);