DELETE FROM sys_data_set WHERE sql_cd IN (8104);
...
input_data AS(
  SELECT
    ...
    COALESCE(TO_CHAR(NULLIF(''@ind_off_water_info.ind_off_water_info.weight_5'', '''')::numeric / 10, ''FM9990.0''),(ord_main.ind_cond_info->''31''->>''value'')::TEXT)AS indCondInfo031,
