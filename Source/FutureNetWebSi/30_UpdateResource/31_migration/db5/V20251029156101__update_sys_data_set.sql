...
select
	...
	end as e01', 2, '[{}]'::jsonb, '1', '{"applications": [4]}'::jsonb, NULL, 'Medicom透析経過データ連携穿刺者取得SQL', '2023-11-21 23:54:57.716', '2025-10-01 14:51:54.081', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-317113, '
...
select
	...
	end as e01', 2, '[{}]'::jsonb, '1', '{"applications": [4]}'::jsonb, NULL, 'Medicom透析経過データ連携回収者取得SQL', '2023-11-21 23:54:57.716', '2025-10-01 14:51:54.081', NULL);
INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-317114, '
...
select
    ...
    end as e01', 2, '[{}]'::jsonb, '1', '{"applications": [4]}'::jsonb, NULL, 'Medicom透析経過データ連携担当者取得SQL', '2023-11-21 23:54:57.716', '2025-06-19 10:54:40.225', NULL);