DELETE from ntss.mst_coop_layout_detail where ctl_no= -103000011;
INSERT INTO ntss.mst_coop_layout_detail (ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date) VALUES (-103000011, 'nkknkk', 'profile', 'R', '詳細項目', '感染症', '日機装標準', '患者情報（XML)', '1', '<DetailInfo Function="1" SEQ="" info="感染症">
  <Item Code="col:$journal.detail.pat_main_2.infect_info.infection_cd">
      col:$journal.detail.pat_main_2.infect_info.name
  </Item>
