DELETE FROM "ntss"."mst_coop_layout_detail" WHERE ctl_no IN (-207000031);
INSERT INTO "ntss"."mst_coop_layout_detail"("ctl_no", "facility_cd", "coop_cd", "direction", "coop_cd_detail", "coop_cd_detail_sub", "coop_name", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-207000031, 'F_hosp', 'rst_dial', 'S', '実績詳細', '実績詳細', '富士通実績', '実績送信', '1', '<root name="透析実績詳細(実績詳細)">
    ...
    <item  name="明細.タグ名称" len="20" type="string" value="dataset:-101.e11"/>
