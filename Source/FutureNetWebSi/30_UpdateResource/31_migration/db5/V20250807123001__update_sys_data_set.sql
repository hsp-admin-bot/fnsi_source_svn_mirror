DELETE FROM ntss.sys_data_set WHERE sql_cd=-1103000;

INSERT INTO ntss.sys_data_set (sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES(-1103000, '-- SQL: -1103000 begin
...
FROM
  ...
  karute_txt kt,
  coop_detail cd
-- SQL: -1103000 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(送信用)セコムの透析実績連携', '2025-06-03 08:56:02.129', current_timestamp, '[{"sql_cd": -1100003, "field_name": "user_list", "replace_var": "@userList"}]'::jsonb);