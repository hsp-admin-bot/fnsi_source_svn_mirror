delete from "mst_coop_layout_detail" where "ctl_no" in (-110000001,-110000002,-110000003);
INSERT INTO "mst_coop_layout_detail"("ctl_no", "facility_cd", "coop_cd", "direction", "coop_cd_detail", "coop_cd_detail_sub", "coop_name", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-110000003, 'nkknkk', 'exam_ord', 'S', '検査項目', '検査項目', '日機装標準', '依頼送信((※電文フォーマットはMedicomと一致しています。直接にMedicomのフォーマットを使います。))', '1', '<root name="明細詳細(検査項目)">
...
INSERT INTO "mst_coop_layout_detail"("ctl_no", "facility_cd", "coop_cd", "direction", "coop_cd_detail", "coop_cd_detail_sub", "coop_name", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-110000002, 'nkknkk', 'exam_ord', 'S', '検査項目', 'all', '日機装標準', '依頼送信 ※送信：preとallの設定無効', '1', '<root name="明細詳細(pre)">
...
INSERT INTO "mst_coop_layout_detail"("ctl_no", "facility_cd", "coop_cd", "direction", "coop_cd_detail", "coop_cd_detail_sub", "coop_name", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-110000001, 'nkknkk', 'exam_ord', 'S', '検査項目', 'pre', '日機装標準', '依頼送信 ※送信：preとallの設定無効', '1', '<root name="明細詳細(pre)">
    <item  name="レコード区分" len="2" key="分類属性" value="const:O2"/>
    <item  name="検査機関コード" len="6" value="const:0000000"/>
    <item  name="依頼者KEY（日付）" len="6" value="$SYSDATE"/>
    <item  name="依頼者KEY（受付番号）" len="4" value="$journal.accept_no"/>
