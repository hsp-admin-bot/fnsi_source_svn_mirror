DELETE FROM "ntss"."sys_data_set" where sql_cd in (249);
...
, tmp AS (
    SELECT
        ...
        to_number( ord.rst_weight_info -> ''recrcl_rt'' -> ( ord.rst_weight_info -> ''recrcl_rt'' ->> ''valid_no'' ) ->> ''rate'', ''999'' ) AS re_loop_rate,
