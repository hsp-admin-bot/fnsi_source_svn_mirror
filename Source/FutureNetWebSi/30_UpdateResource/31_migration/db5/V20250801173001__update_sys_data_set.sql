DELETE FROM ntss.sys_data_set WHERE sql_cd=-1102000;
INSERT INTO ntss.sys_data_set (sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) VALUES(-1102000, 'WITH RECURSIVE coop_ini_info AS (
    --連携設定から取得
    SELECT
