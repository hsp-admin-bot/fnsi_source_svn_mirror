...
-1104000002, -1104000003, -1104000004, -1104000005, -1104000006, -1104000007, -1104000008, -1104000009, -1104000010,-1104000028,-1104000029,-1104000030,-1104000031,-1104000032,-1104000033
  );
...
', '{"dataset": [{"key0,": "key0", "patId": "patId", "ctlNo,": "ctlNo", "ordNo,": "ordNo", "sqlCode": -1, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"key0,": "key0", "patId": "patId", "ctlNo,": "ctlNo", "ordNo,": "ordNo", "sqlCode": -1100000, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -1100006}, {"patId": "patId", "ordNo,": "ordNo", "sqlCode": -1102000, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
', '{"dataset": [{"key0,": "key0", "patId": "patId", "ctlNo,": "ctlNo", "ordNo,": "ordNo", "sqlCode": -1100000, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -1100006}, {"patId": "patId", "ordNo,": "ordNo", "sqlCode": -1102000, "facilityCd": "facilityCd"}, {"patId": "patId", "ordNo,": "ordNo", "sqlCode": -1102002, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
VALUES(-1104000030, 'Secom', 'ind_dial', 'S', 'trt_index_del', '01', 'セコム連携_透析指示連携', '処置依頼ファイル_オーダーインデックス', '1', '<root name="セコム連携_透析指示_処置依頼ファイル_オーダーインデックス">
  ...
  <item name="未使用" value="$BLANK"/>
  <item name="未使用" value="$BLANK"/>
</root>', '{"dataset": [{"key0,": "key0", "patId": "patId", "ctlNo,": "ctlNo", "ordNo,": "ordNo", "sqlCode": -1100000, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -1100006}, {"patId": "patId", "ordNo,": "ordNo", "sqlCode": -1102000, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
VALUES(-1104000032, 'Secom', 'ind_dial', 'S', 'trt_unit_del', '01', 'セコム連携_透析指示連携', '処置依頼ファイル_処置単位', '1', '<root name="処置単位">
 ...
 <item name="未使用" value="$BLANK"/>
 <item name="診療区分コード" value="$BLANK"/>
</root>', '{"dataset": [{"key0,": "key0", "patId": "patId", "ctlNo,": "ctlNo", "ordNo,": "ordNo", "sqlCode": -1100000, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -1100006}, {"patId": "patId", "ordNo,": "ordNo", "sqlCode": -1102000, "facilityCd": "facilityCd"}, {"patId": "patId", "ordNo,": "ordNo", "sqlCode": -1102002, "facilityCd": "facilityCd"}]}'::jsonb, '1', '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
