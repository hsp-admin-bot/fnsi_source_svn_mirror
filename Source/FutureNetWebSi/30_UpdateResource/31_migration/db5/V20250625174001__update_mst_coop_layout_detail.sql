...
VALUES(-110400000, 'Secom', 'ind_dial', 'S', 'res_top_cre', '01', 'セコム連携_透析指示連携', 'セコム連携_透析指示連携_予約受付_cre', '1', '<root name="セコム連携_透析指示_予約受付" multi="true:CRLF">
...
</root>', '{"dataset": [{"ordNo": "ordNo", "patId": "patId", "sqlCode": -1102000, "facilityCd": "-1102006.facility_cd"}, {"key0": "-1102006.key0", "patId": "patId", "sqlCode": -1100006}, {"ordNo": "ordNo", "sqlCode": -1104000, "facilityCd": "-1102006.facility_cd"}]}'::jsonb, '1', '0', 5843, current_timestamp, current_timestamp, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
...
</root>', '{"dataset": [{"key0": "-1102009.key0", "ctlNo": "-1102009.ctl_no", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1100000, "facilityCd": "-1102009.facility_cd"}, {"key0": "-1102009.key0", "patId": "patId", "sqlCode": -1100006, "facilityCd": "-1102009.facility_cd"}, {"sqlCode": -1102000}]}'::jsonb, '1', '0', 5843, current_timestamp, current_timestamp, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
