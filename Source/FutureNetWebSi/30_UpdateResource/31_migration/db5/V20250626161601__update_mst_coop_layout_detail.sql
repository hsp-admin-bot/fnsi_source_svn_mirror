...
VALUES(-1104000019, 'Secom', 'ind_dial', 'S', 'med_top_del', '01', 'セコム連携_透析指示連携', 'セコム連携_透析指示連携_カルテ記録_del', '1', '<root name="セコム連携_透析指示_カルテ" multi="true:CRLF">
  ...
  <item name="発生日" value="dataset:-1102027.occur_date"/>
  <item name="SEQ番号" value="dataset:-1102027.occur_time"/>
...
', '{"dataset": [{"key0": "-1102009.key0", "ctlNo": "-1102009.ctl_no", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1100000, "facilityCd": "-1102009.facility_cd", "sharedSysdate": "$SHARED_SYSDATE:yyyyMMddHHmmss"}, {"key0": "-1102009.key0", "patId": "patId", "sqlCode": -1100006, "facilityCd": "-1102009.facility_cd"}, {"sqlCode": -1102000}, {"sqlCode": -1102027}]}'::jsonb, '1', '0', -1, '2025-06-24 14:35:49.849', current_timestamp, 'Secom');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
