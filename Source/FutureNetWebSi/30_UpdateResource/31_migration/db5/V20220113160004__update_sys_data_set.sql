delete from "sys_data_set" where "sql_cd" in (-26,-39,-25);
...
ORDER BY
  ...
  , set_order_flag ASC
  , tag_name ASC
  , in_hospital_cd1 ASC', 2, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）依頼検査繰り返し部', '2020-05-12 11:09:24', '2020-05-12 11:09:28.001', NULL);
INSERT INTO "sys_data_set"("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (-26, 'SELECT
...
FROM
  ...
  ) AS T', 2, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）検査依頼者', '2020-05-12 12:15:09.001', '2020-05-12 12:15:13', NULL);
...
, exam_info AS ( 
  ...
  FROM
    pat_exam_main AS exam 
    INNER JOIN pat_main AS main 
      ON exam.pat_id = main.pat_id 
