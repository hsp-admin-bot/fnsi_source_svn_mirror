DELETE FROM "ntss"."sys_data_set" where sql_cd in (110, 111);
...
, mainte_detail_tbl as (
	select
		...
		mmd.mainte_detail_cd,
		mmd.edition_no,
		mmd.mainte_content_1,
		mmd.mainte_content_2,
		mmd.mainte_content_3,

		mlw.tabIndex,

		mlw.mainte_category_idx,
		mct.mainte_category_cd,
