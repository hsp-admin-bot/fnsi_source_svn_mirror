...
WHERE
  ...
  AND facility_cd = ''@facilityCd''', "db_class" = 3, "detail" = '[{}]', "can_repeat" = '0', "use_application" = '{"applications": [4]}', "report_class" = NULL, "memo" = '(受信用)患者個人情報の取得の修正', "reg_date" = '2022-01-07 18:21:46', "up_date" = current_timestamp, "pre_sql_info" = '[{"sql_cd": 1009, "field_name": "up_base_disease_flg", "replace_var": "@upBaseDiseaseFlg"}, {"sql_cd": 1010, "field_name": "check_value", "replace_var": "@patBloodRhType"}, {"sql_cd": 1011, "field_name": "check_value", "replace_var": "@patBloodAboType"}]' WHERE "sql_cd" = 1103;
