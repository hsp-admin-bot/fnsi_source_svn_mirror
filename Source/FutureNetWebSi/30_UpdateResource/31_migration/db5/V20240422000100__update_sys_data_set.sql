DELETE FROM "ntss"."sys_data_set" where sql_cd in (50, 51, 60, 85);
...
select
  ...
  ,case when picked_result_params[1]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[1]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[1]->>''result_value'' end  as data1
  ,case when picked_result_params[2]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[2]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[2]->>''result_value'' end  as data2
  ,case when picked_result_params[3]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[3]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[3]->>''result_value'' end  as data3
  ,case when picked_result_params[4]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[4]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[4]->>''result_value'' end   as data4
  ,case when picked_result_params[5]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[5]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[5]->>''result_value'' end    as data5
  ,case when picked_result_params[6]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[6]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[6]->>''result_value'' end    as data6
  ,case when picked_result_params[7]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[7]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[7]->>''result_value'' end  as data7
  ,case when picked_result_params[8]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[8]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[8]->>''result_value'' end   as data8
  ,case when picked_result_params[9]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[9]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[9]->>''result_value'' end    as data9
 ,case when picked_result_params[10]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[10]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[10]->>''result_value'' end   as data10
 ,case when picked_result_params[11]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[11]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[11]->>''result_value'' end   as data11
  ,case when picked_result_params[12]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[12]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[12]->>''result_value'' end   as data12
  ,case when picked_result_params[13]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[13]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[13]->>''result_value'' end   as data13
  ,case when picked_result_params[14]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[14]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[14]->>''result_value'' end   as data14
  ,case when picked_result_params[15]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[15]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[15]->>''result_value'' end   as data15
  ,case when picked_result_params[16]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[16]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[16]->>''result_value'' end   as data16
  ,case when picked_result_params[17]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[17]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[17]->>''result_value'' end   as data17
  ,case when picked_result_params[18]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[18]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[18]->>''result_value'' end   as data18
  ,case when picked_result_params[19]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[19]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[19]->>''result_value'' end   as data19
  ,case when picked_result_params[20]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[20]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[20]->>''result_value'' end   as data20
  ,case when picked_result_params[21]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[21]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[21]->>''result_value'' end   as data21
  ,case when picked_result_params[22]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[22]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[22]->>''result_value'' end   as data22
  ,case when picked_result_params[23]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[23]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[23]->>''result_value'' end   as data23
  ,case when picked_result_params[24]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[24]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[24]->>''result_value'' end   as data24
  ,case when picked_result_params[25]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[25]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[25]->>''result_value'' end   as data25
  ,case when picked_result_params[26]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[26]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[26]->>''result_value'' end   as data26
  ,case when picked_result_params[27]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[27]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[27]->>''result_value'' end   as data27
  ,case when picked_result_params[28]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[28]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[28]->>''result_value'' end   as data28
  ,case when picked_result_params[29]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[29]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[29]->>''result_value'' end   as data29
  ,case when picked_result_params[30]->>''format_class'' = ''1'' then  unescape_html(regexp_replace(picked_result_params[30]->>''result_value'', ''<[^>]*>'', '''', ''g'')) 
	else picked_result_params[30]->>''result_value'' end    as data30
from
  pe_array_agg
...
--   ,pe_basicinfo.up_date
  ...
  ,case when picked_result_params[1]->>''result_value'' is null or picked_result_params[1]->>''result_value'' = '''' then picked_input_params[1]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[1]->>''result_value'', ''<[^>]*>'', '''', ''g''))
  ...
  ,case when picked_result_params[2]->>''result_value'' is null or picked_result_params[2]->>''result_value'' = '''' then picked_input_params[2]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[2]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data2
  ,case when picked_result_params[3]->>''result_value'' is null or picked_result_params[3]->>''result_value'' = '''' then picked_input_params[3]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[3]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data3
  ,case when picked_result_params[4]->>''result_value'' is null or picked_result_params[4]->>''result_value'' = '''' then picked_input_params[4]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[4]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data4
  ,case when picked_result_params[5]->>''result_value'' is null or picked_result_params[5]->>''result_value'' = '''' then picked_input_params[5]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[5]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data5
  ,case when picked_result_params[6]->>''result_value'' is null or picked_result_params[6]->>''result_value'' = '''' then picked_input_params[6]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[6]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data6
  ,case when picked_result_params[7]->>''result_value'' is null or picked_result_params[7]->>''result_value'' = '''' then picked_input_params[7]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[7]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data7
  ,case when picked_result_params[8]->>''result_value'' is null or picked_result_params[8]->>''result_value'' = '''' then picked_input_params[8]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[8]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data8
  ,case when picked_result_params[9]->>''result_value'' is null or picked_result_params[9]->>''result_value'' = '''' then picked_input_params[9]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[9]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data9
  ,case when picked_result_params[10]->>''result_value'' is null or picked_result_params[10]->>''result_value'' = '''' then picked_input_params[10]->''item_json''->>''default_value''
        else unescape_html(regexp_replace(picked_result_params[10]->>''result_value'', ''<[^>]*>'', '''', ''g''))
   end as data10
from
  pe_array_agg
  inner join pe_basicinfo on pe_array_agg.pat_event_cd = pe_basicinfo.pat_event_cd
