...
VALUES(-11170001, 'Secom', 'karte_ord', '', 'S', 'cre', 'csv', 'セコム連携_指示変更履歴連携', 'Secom', '指示変更履歴連携', '1', '<root name="カルテ記録ファイル">
  ...
  <item name="ユーザID" len="6" value="dataset:-1107000.user_id"/>
...
', '{"dataset": [{"key0": "key0", "ctlNo": "ctlNo", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1107000, "treatDate": "treatDate", "facilityCd": "facilityCd"}, {"key0": "key0", "ctlNo": "ctlNo", "ordNo": "ordNo", "patId": "patId", "content": "nullValue", "sqlCode": -1107004, "facilityCd": "facilityCd"}], "dumpFileName": {"key0": "key0", "ctlNo": "ctlNo", "ordNo": "ordNo", "patId": "patId", "sqlCode": -1107005, "facilityCd": "facilityCd"}}'::jsonb, '1', '0', -1, '2025-06-07 13:30:11.438', '2025-06-07 13:30:11.438', 'Secom');
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-11170002, 'Secom', 'karte_ord', '', 'S', 'upd', 'csv', 'セコム連携_指示変更履歴連携', 'Secom', '指示変更履歴連携', '1', '<root name="カルテ記録ファイル">
  <item name="病院ID" len="6" value="dataset:-1107000.hospital_id"/>
  <item name="患者ID" value="dataset:-1107000.patient_id"/>
  <item name="発生日" len="10" value="dataset:-1107000.occurrence_date"/>
  <item name="SEQ番号" len="8" value="dataset:-1107000.seq_number"/>
