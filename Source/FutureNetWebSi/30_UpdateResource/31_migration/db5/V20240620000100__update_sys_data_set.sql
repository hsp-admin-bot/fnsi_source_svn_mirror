-- add 10708 by kangjie 20240611 start
DELETE FROM "ntss"."sys_data_set" where sql_cd in (5,228,229);
...
INSERT INTO "ntss"."sys_data_set" ("sql_cd", "sql", "db_class", "detail", "can_repeat", "use_application", "report_class", "memo", "reg_date", "up_date", "pre_sql_info") VALUES (229, '{"collection": "pat_unique_history", "eq": {"pat_id": "@patId", "is_del": "0"}, "lt": {"up_date": "@fromDate"}, "sort": {"up_date": "desc"}, "slice": {"up_date": 1}_physical_info_desc}', 4, '[]', '1', '{"applications": [1]}', '{"classes": [1, 2, 3, 9]}', 'DW指示情報 @patId @fromDate使用', '2024-06-13 16:51:25', CURRENT_TIMESTAMP, NULL);
...
-- -- add 10708 by kangjie 20240611 end
