...
near_day_date AS (
 select
  ...
  where
    ...
    and m.exam_status = ''1''
    and m.pat_id = @patId
    and m.result_exam_date < date_trunc(''day'', @fromDate ::timestamp) + interval ''1 days - 1 milliseconds''
