delete from "mst_coop_layout" where "ctl_no" in (-4060001,-4060002,-4060003,-4100001,-4100002,-4100003);
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-4060001, 'P_hosp', 'accept', '', 'S', 'cre', 'text', 'パナソニック 受付情報', 'Medicom', '受付情報', '1', '<root name="再来受付">
    <item  name="再受機No" len="2" value="const:S1"/>
    ...
    <item  name="来院理由" len="4" value="const:23"/>
...
</root>', '{"dataset": [{"patId": "patId", "sqlCode": -300001}, {"patId": "patId", "sqlCode": -455}, {"ordNo": "ordNo", "sqlCode": -456}, {"patId": "patId", "sqlCode": -457}, {"ordNo": "ordNo", "sqlCode": -1001}], "dumpFileName": {"patId": "patId", "sqlCode": -99998}}', '1', '0', -2, '2020-03-17 16:25:14.394', '2020-03-17 16:25:17.47');
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-4060002, 'P_hosp', 'accept', '', 'S', 'upd', 'text', 'パナソニック 受付情報', 'Medicom', '受付情報', '1', '<root name="再来受付">
    <item  name="再受機No" len="2" value="const:S1"/>
    <item  name="患者コード" len="13" value="dataset:-300001.hosp_pat_id"/>
    <item  name="保険種別" len="3" value="$BLANK"/>
    <item  name="外/入" len="1" value="const:1"/>
...
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-4060003, 'P_hosp', 'accept', '', 'S', 'del', 'text', 'パナソニック 受付情報', 'Medicom', '受付情報', '1', '<root name="再来受付">
    <item  name="再受機No" len="2" value="const:S1"/>
    <item  name="患者コード" len="13" value="dataset:-300001.hosp_pat_id"/>
    <item  name="保険種別" len="3" value="$BLANK"/>
    <item  name="外/入" len="1" value="const:1"/>
