DELETE FROM ntss.sys_data_set WHERE sql_cd IN (9115);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(9115, 'INSERT INTO ord_main( 
  pat_id
  , fn_pat_id
  , treat_date
  , treat_week
...
VALUES ( 
  ...
  , NULL
  , NULL
)', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(受信用)NECの治療情報(INSERT)', '2021-11-23 12:12:12.000', CURRENT_TIMESTAMP, NULL);
