...
select 
CASE (select bed_code_conv from default_bed_code_conv) WHEN ''1'' THEN COALESCE(NULLIF(mbd.in_hospital_cd_1,''''), ''V9999999'')  WHEN ''2'' THEN COALESCE(NULLIF(mbd.in_hospital_cd_2,''''), ''V9999999'')  ELSE ''V9999999'' end as bed_cd
from 
   ord_main AS ord
