delete from ntss.sys_data_set where sql_cd in ('-81');
...
order by all_cost.sortTag', 2, '[{}]', '0', '{"applications": [4]}', NULL, '富士通）項目情報部', '2022-08-31 05:57:49.586', CURRENT_TIMESTAMP, '[{"sql_cd": -20, "field_name": "in_out", "replace_var": "@inOut"}]');
