...
VALUES(-1102004, 'WITH dial_diff_com_info AS (
SELECT
...
FROM
  dial_diff_com_info', 3, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(送信用)セコムの透析指示_患者個人情報の透析困難コード取得', '2025-06-16 16:16:46.764', CURRENT_TIMESTAMP, NULL);
