...
FROM
    exam_items
    limit 1',2,'[]','0','{"applications": [6]}',NULL,'Medicom検査依頼実績連携','2023-11-21 23:54:57.716',CURRENT_TIMESTAMP,'[{"sql_cd": -310009, "field_name": "staff_cd", "replace_var": "@doctorCd"}, {"sql_cd": -310009, "field_name": "user_name", "replace_var": "@doctorName"}]');
