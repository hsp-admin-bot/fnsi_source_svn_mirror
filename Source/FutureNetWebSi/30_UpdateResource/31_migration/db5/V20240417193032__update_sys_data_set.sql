...
WHERE sql_cd IN(-2502,-2051)
;

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-2502, 'WITH ntss_db5_om_temp AS (
    SELECT
        om.ord_no
        ,om.pat_id
...
FROM
    ...
    LEFT JOIN ntss_db5_mst_m_mix
        ON rst_cond_list.value = ntss_db5_mst_m_mix.medicine_mix_cd ::text;', 2, '[]'::jsonb, '1', '{"applications": [5]}'::jsonb, '{"classes": []}'::jsonb, '患者病歴情報　@facilityCd使用 {"Mergekey": ["patid"]}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
