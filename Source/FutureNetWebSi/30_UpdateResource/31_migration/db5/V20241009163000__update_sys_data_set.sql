DELETE FROM sys_data_set sds WHERE sql_cd  = -59;
...
WHERE
  ord.ord_no = @ordNo
    ...
    order by del_date desc limit 1)', 2, '[]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '富士通）透析予約：オーダ日付とオーダ時間取得', '2022-03-22 10:53:38.415', CURRENT_TIMESTAMP, NULL);