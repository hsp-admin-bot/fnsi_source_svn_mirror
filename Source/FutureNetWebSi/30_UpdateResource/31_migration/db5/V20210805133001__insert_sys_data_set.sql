insert into ntss.sys_data_set(sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) values (187,'SELECT
	rst_rounds_info ->> ''content'' AS content,
	rst_rounds_info ->> ''round_type_name'' AS roundTypeName,
	rst_rounds_info ->> ''round_type_cd'' AS roundTypeCd,
	rst_rounds_info ->> ''reg_date_time'' AS regDateTime,
	rst_rounds_info ->> ''ind_user_id'' AS indUserId,
	(rst_rounds_info ->> ''ind_user_last_name'') || ''　'' ||(rst_rounds_info ->> ''ind_user_first_name'') AS indUserName,
	rst_rounds_info ->> ''reg_user_id'' AS regUserId,
	(rst_rounds_info ->> ''reg_user_last_name'') || ''　'' ||(rst_rounds_info ->> ''reg_user_first_name'') AS regUserName,
	case rst_rounds_info ->> ''is_ind_comment_post'' when ''0'' then ''転記しない'' else ''転記する'' end as isIndCommentPost,
	rst_rounds_info ->> ''ind_comment_no'' AS indCommentNo,
	case rst_rounds_info ->> ''posting_class'' when ''0'' then ''継続'' else ''当日のみ'' end as postingClass,
	rst_rounds_info ->> ''created_user_id'' AS createdUserId,
	(rst_rounds_info ->> ''created_user_last_name'') || ''　'' ||(rst_rounds_info ->> ''created_user_first_name'') AS createdUserName,
	rst_rounds_info ->> ''updated_user_id'' AS updated_user_id,
	(rst_rounds_info ->> ''updated_user_last_name'') || ''　'' ||(rst_rounds_info ->> ''updated_user_first_name'') AS updatedUserName
FROM
	ord_main 
WHERE
	ord_no = @ordNo 
	...
	AND rst_dialysis_state < ''6''',2,'[{"preview": "001", "can_calc": "0", "data_code": "roundTypeName", "data_name": "種別名", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "roundTypeName", "disp_format": "0", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "002", "can_calc": "1", "data_code": "content", "data_name": "種別内容", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "content", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "003", "can_calc": "1", "data_code": "roundTypeCd", "data_name": "種別コード", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "roundTypeCd", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "004", "can_calc": "1", "data_code": "regDateTime", "data_name": "起票日時", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "regDateTime", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "005", "can_calc": "1", "data_code": "indUserId", "data_name": "指示者ID", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "indUserId", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "006", "can_calc": "1", "data_code": "indUserName", "data_name": "指示者名", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "indUserName", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "007", "can_calc": "1", "data_code": "regUserId", "data_name": "起票者ID", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "regUserId", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "008", "can_calc": "1", "data_code": "regUserName", "data_name": "起票者名", "data_type": "string", "conv_table": [], "data_class": "regUserName", "field_name": "content", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "009", "can_calc": "1", "data_code": "isIndCommentPost", "data_name": "指示コメントに転記", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "isIndCommentPost", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "010", "can_calc": "1", "data_code": "indCommentNo", "data_name": "指示コメント番号", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "indCommentNo", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "011", "can_calc": "1", "data_code": "postingClass", "data_name": "転記区分", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "postingClass", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "012", "can_calc": "1", "data_code": "createdUserId", "data_name": "登録者ID", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "createdUserId", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "013", "can_calc": "1", "data_code": "createdUserName", "data_name": "登録者名", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "createdUserName", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "014", "can_calc": "1", "data_code": "updated_user_id", "data_name": "更新者ID", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "updated_user_id", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "015", "can_calc": "1", "data_code": "updatedUserName", "data_name": "更新者名", "data_type": "string", "conv_table": [], "data_class": "回診記録", "field_name": "updatedUserName", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}]','1','{"applications": [1]}','{"classes": [1, 2, 3, 9]}','実績（治療中）：回診記録 @ordNo 使用','2020-07-31T18:29:49','2020-07-31T18:29:49',null);
...
order by ord.treat_date DESC LIMIT 1 OFFSET 0',2,'[{"preview": "56.78", "can_calc": "1", "data_code": "last_weight_before", "data_name": "前体重(前回)", "data_type": "decimal", "conv_table": [], "data_class": "体重情報（過去実績）", "field_name": "last_weight_before", "disp_format": "0.00", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2011/3/12  8:21:00", "can_calc": "1", "data_code": "last_weight_before_date", "data_name": "前体重測定日時(前回)", "data_type": "DateTime", "conv_table": [], "data_class": "体重情報（過去実績）", "field_name": "last_weight_before_date", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "56.78", "can_calc": "1", "data_code": "last_weight_after", "data_name": "後体重(前回)", "data_type": "decimal", "conv_table": [], "data_class": "体重情報（過去実績）", "field_name": "last_weight_after", "disp_format": "0.00", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2011/3/12  8:21:00", "can_calc": "1", "data_code": "last_weight_after_date", "data_name": "後体重測定日時(前回)", "data_type": "DateTime", "conv_table": [], "data_class": "体重情報（過去実績）", "field_name": "last_weight_after_date", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "50", "can_calc": "1", "data_code": "last_ctr", "data_name": "CTR(前回)", "data_type": "decimal", "conv_table": [], "data_class": "体重情報（過去実績）", "field_name": "last_ctr", "disp_format": "0.00", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "2011/3/12  8:21:00", "can_calc": "1", "data_code": "last_ctr_measure_date", "data_name": "CTR測定日時(前回)", "data_type": "DateTime", "conv_table": [], "data_class": "体重情報（過去実績）", "field_name": "last_ctr_measure_date", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}, {"preview": "56.78", "can_calc": "1", "data_code": "last_ctr_weight", "data_name": "CTR測定時体重(前回)", "data_type": "decimal", "conv_table": [], "data_class": "体重情報（過去実績）", "field_name": "last_ctr_weight", "disp_format": "0.00", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}]','0','{"applications": [1]}','{"classes": [1, 2, 3, 9]}','実績（治療中）(前回体重)','2021-08-05T13:30:00','2021-08-05T13:30:00',null);
...
from
  oxygen_tbl
;',2,'[{"preview": "16", "can_calc": "1", "data_code": "total_amount", "data_name": "吸入総量", "data_type": "decimal", "conv_table": [], "data_class": "酸素吸入総量", "field_name": "total_amount", "disp_format": "0", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}]','0','{"applications": [1]}','{"classes": [1, 2, 3, 9]}','実績（治療中）：酸素吸入総量 @ordNo 使用','2021-08-05T13:30:00','2021-08-05T13:30:00',null);
insert into ntss.sys_data_set(sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) values (175,'
...
select 
  rst_device_set_info#>>''{"ope","dev","A","179"}'' as ope_dev_a_0179 -- 血流量設定最大値
  ,rst_device_set_info#>>''{"ope","dev","A","181"}'' as ope_dev_a_0181 -- 除水速度制限
  ,rst_device_set_info#>>''{"ope","dev","A","38"}'' as ope_dev_a_0038 -- 動脈側気泡検出器
  ,rst_device_set_info#>>''{"ope","dev","A","21"}'' as ope_dev_a_0021 -- 除水計算時間
  ,rst_device_set_info#>>''{"ope","dev","A","22"}'' as ope_dev_a_0022 -- 除水計算優先項目
  ,rst_device_set_info#>>''{"ope","dev","A","39"}'' as ope_dev_a_0039 -- 除水開始遅延時間
  ,rst_device_set_info#>>''{"ope","dev","A","182"}'' as ope_dev_a_0182 -- 透析液温度操作範囲上限
  ,rst_device_set_info#>>''{"ope","dev","A","183"}'' as ope_dev_a_0183 -- 透析液温度操作範囲下限
  ,rst_device_set_info#>>''{"ope","dev","A","24"}'' as ope_dev_a_0024 -- シングルニードル切替圧上限
  ,rst_device_set_info#>>''{"ope","dev","A","25"}'' as ope_dev_a_0025 -- シングルニードル切替圧下限
  ,rst_device_set_info#>>''{"ope","dev","A","241"}'' as ope_dev_a_0241 -- TMPゼロ補正
  ,rst_device_set_info#>>''{"ope","dev","A","168"}'' as ope_dev_a_0168 -- HD補正警報上限値
  ,rst_device_set_info#>>''{"ope","dev","A","169"}'' as ope_dev_a_0169 -- HD補正警報下限値
  ,rst_device_set_info#>>''{"ope","dev","A","171"}'' as ope_dev_a_0171 -- ECUM補正警報上限値
  ,rst_device_set_info#>>''{"ope","dev","A","172"}'' as ope_dev_a_0172 -- ECUM補正警報下限値
  ,rst_device_set_info#>>''{"ope","dev","A","174"}'' as ope_dev_a_0174 -- HDF補正警報上限値
  ,rst_device_set_info#>>''{"ope","dev","A","175"}'' as ope_dev_a_0175 -- HDF補正警報下限値
  ,rst_device_set_info#>>''{"ope","dev","A","177"}'' as ope_dev_a_0177 -- HF補正警報上限値
  ,rst_device_set_info#>>''{"ope","dev","A","178"}'' as ope_dev_a_0178 -- HF補正警報下限値
  ,rst_device_set_info#>>''{"ope","dev","B","37"}'' as ope_dev_b_0037 -- HD+補液補正警報上限値
  ,rst_device_set_info#>>''{"ope","dev","B","38"}'' as ope_dev_b_0038 -- HD+補液補正警報下限値
  ,rst_device_set_info#>>''{"ope","dev","A","391"}'' as ope_dev_a_0391 -- OHDF補正警報上限値
  ,rst_device_set_info#>>''{"ope","dev","A","392"}'' as ope_dev_a_0392 -- OHDF補正警報下限値
  ,rst_device_set_info#>>''{"ope","dev","A","394"}'' as ope_dev_a_0394 -- OHF補正警報上限値
  ,rst_device_set_info#>>''{"ope","dev","A","395"}'' as ope_dev_a_0395 -- OHF補正警報下限値
  ,rst_device_set_info#>>''{"ope","dev","A","383"}'' as ope_dev_a_0383 -- 補液量制限
  ,rst_device_set_info#>>''{"ope","dev","A","389"}'' as ope_dev_a_0389 -- 補液計算優先項目
  ,rst_device_set_info#>>''{"ope","dev","A","379"}'' as ope_dev_a_0379 -- 補液比率（前補液）
  ,rst_device_set_info#>>''{"ope","dev","B","39"}'' as ope_dev_b_0039 -- 補液比率（後補液）
  ,rst_device_set_info#>>''{"ope","dev","A","398"}'' as ope_dev_a_0398 -- 補液開始遅延時間
  ,rst_device_set_info#>>''{"ope","dev","A","369"}'' as ope_dev_a_0369 -- DP=Qd+Qs(補液速度加算)
  ,rst_device_set_info#>>''{"ope","dev","A","90"}'' as ope_dev_a_0090 -- 濾過率（前補液）
  ,rst_device_set_info#>>''{"ope","dev","B","40"}'' as ope_dev_b_0040 -- 濾過率（後補液）
  ,rst_device_set_info#>>''{"ope","dev","A","91"}'' as ope_dev_a_0091 -- ヘマトクリット（Ht）
  ,rst_device_set_info#>>''{"ope","dev","A","92"}'' as ope_dev_a_0092 -- 総タンパク（TP）
  ,rst_device_set_info#>>''{"ope","dev","A","336"}'' as ope_dev_a_0336 -- 緊急補液速度
  ,rst_device_set_info#>>''{"ope","dev","A","337"}'' as ope_dev_a_0337 -- 緊急補液量
  ,rst_device_set_info#>>''{"ope","dev","A","185"}'' as ope_dev_a_0185 -- HDF速度操作範囲上限前補液
  ,rst_device_set_info#>>''{"ope","dev","B","31"}'' as ope_dev_b_0031 -- HDF速度操作範囲上限後補液
  ,rst_device_set_info#>>''{"ope","dev","A","186"}'' as ope_dev_a_0186 -- HF速度操作範囲上限前補液
  ,rst_device_set_info#>>''{"ope","dev","B","32"}'' as ope_dev_b_0032 -- HF速度操作範囲上限後補液
  ,rst_device_set_info#>>''{"ope","dev","B","30"}'' as ope_dev_b_0030 -- HD+補液速度操作範囲上限前補液
  ,rst_device_set_info#>>''{"ope","dev","B","33"}'' as ope_dev_b_0033 -- HD+補液速度操作範囲上限後補液
  ,rst_device_set_info#>>''{"ope","dev","A","396"}'' as ope_dev_a_0396 -- OHDF速度操作範囲上限前補液
  ,rst_device_set_info#>>''{"ope","dev","B","34"}'' as ope_dev_b_0034 -- OHDF速度操作範囲上限後補液
  ,rst_device_set_info#>>''{"ope","dev","A","397"}'' as ope_dev_a_0397 -- OHF速度操作範囲上限前補液
  ,rst_device_set_info#>>''{"ope","dev","B","35"}'' as ope_dev_b_0035 -- OHF速度操作範囲上限後補液
  ,rst_device_set_info#>>''{"ope","dev","A","384"}'' as ope_dev_a_0384 -- AFBF補液比率使用選択
  ,rst_device_set_info#>>''{"ope","dev","A","385"}'' as ope_dev_a_0385 -- AFBF補液比率
  ,rst_device_set_info#>>''{"ope","dev","A","386"}'' as ope_dev_a_0386 -- AFBF速度操作範囲上限
  ,rst_device_set_info#>>''{"ope","dev","A","387"}'' as ope_dev_a_0387 -- AFBF速度操作範囲下限
  ,rst_device_set_info#>>''{"ihdf","dev","A","200"}'' as ihdf_dev_a_0200 -- I-HDF_補液量設定
  ,rst_device_set_info#>>''{"ihdf","dev","A","201"}'' as ihdf_dev_a_0201 -- I-HDF_補液速度
  ,rst_device_set_info#>>''{"ihdf","dev","A","202"}'' as ihdf_dev_a_0202 -- I-HDF_補液周期
  ,rst_device_set_info#>>''{"ihdf","dev","A","203"}'' as ihdf_dev_a_0203 -- I-HDF_補液開始時間
  ,rst_device_set_info#>>''{"ihdf","dev","A","204"}'' as ihdf_dev_a_0204 -- I-HDF_除水再開時間
  ,rst_device_set_info#>>''{"ihdf","dev","A","205"}'' as ihdf_dev_a_0205 -- I-HDF_総補液量上限
  ,rst_device_set_info#>>''{"blood_flow","judge"}'' as blood_flow_judge --ホスト監視血流量監視フラグ
  ,rst_device_set_info#>>''{"blood_flow","upper"}'' as blood_flow_upper --ホスト監視血流量上限
  ,rst_device_set_info#>>''{"blood_flow","lower"}'' as blood_flow_lower --ホスト監視血流量下限
  ,rst_device_set_info#>>''{"ip_speed","judge"}'' as ip_speed_judge --ホスト監視IP速度監視フラグ
  ,rst_device_set_info#>>''{"ip_speed","upper"}'' as ip_speed_upper --ホスト監視IP速度上限
  ,rst_device_set_info#>>''{"ip_speed","lower"}'' as ip_speed_lower --ホスト監視IP速度下限
  ,rst_device_set_info#>>''{"ufr","judge"}'' as ufr_judge --ホスト監視除水速度監視フラグ
  ,rst_device_set_info#>>''{"ufr","upper"}'' as ufr_upper --ホスト監視除水速度上限
  ,rst_device_set_info#>>''{"ufr","lower"}'' as ufr_lower --ホスト監視除水速度下限
  ,rst_device_set_info#>>''{"bp_max","judge"}'' as bp_max_judge --ホスト監視最高血圧監視フラグ
  ,rst_device_set_info#>>''{"bp_max","upper"}'' as bp_max_upper --ホスト監視最高血圧上限
  ,rst_device_set_info#>>''{"bp_max","lower"}'' as bp_max_lower --ホスト監視最高血圧下限
  ,rst_device_set_info#>>''{"bp_min","judge"}'' as bp_min_judge --ホスト監視最低血圧監視フラグ
  ,rst_device_set_info#>>''{"bp_min","upper"}'' as bp_min_upper --ホスト監視最低血圧上限
  ,rst_device_set_info#>>''{"bp_min","lower"}'' as bp_min_lower --ホスト監視最低血圧下限
  ,rst_device_set_info#>>''{"bp_ave","judge"}'' as bp_ave_judge --ホスト監視平均血圧監視フラグ
  ,rst_device_set_info#>>''{"bp_ave","upper"}'' as bp_ave_upper --ホスト監視平均血圧上限
  ,rst_device_set_info#>>''{"bp_ave","lower"}'' as bp_ave_lower --ホスト監視平均血圧下限
  ,rst_device_set_info#>>''{"pulse","judge"}'' as pulse_judge --ホスト監視脈拍監視フラグ
  ,rst_device_set_info#>>''{"pulse","upper"}'' as pulse_upper --ホスト監視脈拍上限
  ,rst_device_set_info#>>''{"pulse","lower"}'' as pulse_lower --ホスト監視脈拍下限
  ,rst_device_set_info#>>''{"vp","judge"}'' as vp_judge --ホスト監視静脈圧監視フラグ
  ,rst_device_set_info#>>''{"vp","upper"}'' as vp_upper --ホスト監視静脈圧上限
  ,rst_device_set_info#>>''{"vp","lower"}'' as vp_lower --ホスト監視静脈圧下限
  ,rst_device_set_info#>>''{"ap","judge"}'' as rst_ap_judge --ホスト監視動脈圧監視フラグ
  ,rst_device_set_info#>>''{"ap","upper"}'' as rst_ap_upper --ホスト監視動脈圧上限
  ,rst_device_set_info#>>''{"ap","lower"}'' as rst_ap_lower --ホスト監視動脈圧下限
  ,rst_device_set_info#>>''{"na_conc","judge"}'' as na_conc_judge --ホスト監視Na濃度監視フラグ
  ,rst_device_set_info#>>''{"na_conc","upper"}'' as na_conc_upper --ホスト監視Na濃度上限
  ,rst_device_set_info#>>''{"na_conc","lower"}'' as na_conc_lower --ホスト監視Na濃度下限
  ,rst_device_set_info#>>''{"dialys_temp","judge"}'' as dialys_temp_judge --ホスト監視透析液温度監視フラグ
  ,rst_device_set_info#>>''{"dialys_temp","upper"}'' as dialys_temp_upper --ホスト監視透析液温度上限
  ,rst_device_set_info#>>''{"dialys_temp","lower"}'' as dialys_temp_lower --ホスト監視透析液温度下限
  ,rst_device_set_info#>>''{"care_i","judge"}'' as care_i_judge --ホスト監視血圧未測定時報知監視フラグ
  ,rst_device_set_info#>>''{"care_i","interval"}'' as care_i_interval --ホスト監視ケア報知
  ,rst_device_set_info#>>''{"war","dev","A","240"}'' as war_dev_a_0240 -- TMP監視モード
  ,rst_device_set_info#>>''{"war","dev","A","100"}'' as war_dev_a_0100 -- HD/ECUM静脈圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","101"}'' as war_dev_a_0101 -- HD/ECUM静脈圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","102"}'' as war_dev_a_0102 -- HD/ECUM静脈圧自動設定警報限界上限
  ,rst_device_set_info#>>''{"war","dev","A","103"}'' as war_dev_a_0103 -- HD/ECUM静脈圧自動設定警報限界下限
  ,rst_device_set_info#>>''{"war","dev","A","104"}'' as war_dev_a_0104 -- HD/ECUM静脈圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","105"}'' as war_dev_a_0105 -- HD/ECUM静脈圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","152"}'' as war_dev_a_0152 -- HD/ECUMダイアライザ入口圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","153"}'' as war_dev_a_0153 -- HD/ECUMダイアライザ入口圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","154"}'' as war_dev_a_0154 -- HD/ECUMダイアライザ入口圧自動設定警報限界上限
  ,rst_device_set_info#>>''{"war","dev","A","155"}'' as war_dev_a_0155 -- HD/ECUMダイアライザ入口圧自動設定警報限界下限
  ,rst_device_set_info#>>''{"war","dev","A","156"}'' as war_dev_a_0156 -- HD/ECUMダイアライザ入口圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","157"}'' as war_dev_a_0157 -- HD/ECUMダイアライザ入口圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","112"}'' as war_dev_a_0112 -- HD/ECUM液圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","113"}'' as war_dev_a_0113 -- HD/ECUM液圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","114"}'' as war_dev_a_0114 -- HD/ECUM液圧自動設定警報限界上限
  ,rst_device_set_info#>>''{"war","dev","A","115"}'' as war_dev_a_0115 -- HD/ECUM液圧自動設定警報限界下限
  ,rst_device_set_info#>>''{"war","dev","A","116"}'' as war_dev_a_0116 -- HD/ECUM液圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","117"}'' as war_dev_a_0117 -- HD/ECUM液圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","128"}'' as war_dev_a_0128 -- HD/ECUMTMP自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","129"}'' as war_dev_a_0129 -- HD/ECUMTMP自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","130"}'' as war_dev_a_0130 -- HD/ECUMTMP自動設定警報限界上限
  ,rst_device_set_info#>>''{"war","dev","A","131"}'' as war_dev_a_0131 -- HD/ECUMTMP自動設定警報限界下限
  ,rst_device_set_info#>>''{"war","dev","A","132"}'' as war_dev_a_0132 -- HD/ECUMTMP固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","133"}'' as war_dev_a_0133 -- HD/ECUMTMP固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","126"}'' as war_dev_a_0126 -- HD/ECUMTMP自動追従警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","127"}'' as war_dev_a_0127 -- HD/ECUMTMP自動追従警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","146"}'' as war_dev_a_0146 -- HD/ECUMダイアライザ差圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","147"}'' as war_dev_a_0147 -- HD/ECUMダイアライザ差圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","148"}'' as war_dev_a_0148 -- HD/ECUMダイアライザ差圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","149"}'' as war_dev_a_0149 -- HD/ECUMダイアライザ差圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","106"}'' as war_dev_a_0106 -- HDF/HF静脈圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","107"}'' as war_dev_a_0107 -- HDF/HF静脈圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","158"}'' as war_dev_a_0158 -- HDF/HFダイアライザ入口圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","159"}'' as war_dev_a_0159 -- HDF/HFダイアライザ入口圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","118"}'' as war_dev_a_0118 -- HDF/HF液圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","119"}'' as war_dev_a_0119 -- HDF/HF液圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","136"}'' as war_dev_a_0136 -- HDF/HFTMP自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","137"}'' as war_dev_a_0137 -- HDF/HFTMP自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","134"}'' as war_dev_a_0134 -- HDF/HFTMP自動追従警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","135"}'' as war_dev_a_0135 -- HDF/HFTMP自動追従警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","150"}'' as war_dev_a_0150 -- HDF/HFダイアライザ差圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","151"}'' as war_dev_a_0151 -- HDF/HFダイアライザ差圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","110"}'' as war_dev_a_0110 -- SN静脈圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","111"}'' as war_dev_a_0111 -- SN静脈圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","162"}'' as war_dev_a_0162 -- SNダイアライザ入口圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","163"}'' as war_dev_a_0163 -- SNダイアライザ入口圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","120"}'' as war_dev_a_0120 -- SN液圧自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","121"}'' as war_dev_a_0121 -- SN液圧自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","122"}'' as war_dev_a_0122 -- SN液圧自動設定警報限界上限
  ,rst_device_set_info#>>''{"war","dev","A","123"}'' as war_dev_a_0123 -- SN液圧自動設定警報限界下限
  ,rst_device_set_info#>>''{"war","dev","A","124"}'' as war_dev_a_0124 -- SN液圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","125"}'' as war_dev_a_0125 -- SN液圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","140"}'' as war_dev_a_0140 -- SNTMP自動設定警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","141"}'' as war_dev_a_0141 -- SNTMP自動設定警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","142"}'' as war_dev_a_0142 -- SNTMP自動設定警報限界上限
  ,rst_device_set_info#>>''{"war","dev","A","143"}'' as war_dev_a_0143 -- SNTMP自動設定警報限界下限
  ,rst_device_set_info#>>''{"war","dev","A","144"}'' as war_dev_a_0144 -- SNTMP固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","145"}'' as war_dev_a_0145 -- SNTMP固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","138"}'' as war_dev_a_0138 -- SNTMP自動追従警報幅上限
  ,rst_device_set_info#>>''{"war","dev","A","139"}'' as war_dev_a_0139 -- SNTMP自動追従警報幅下限
  ,rst_device_set_info#>>''{"war","dev","A","108"}'' as war_dev_a_0108 -- 準備回収静脈圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","109"}'' as war_dev_a_0109 -- 準備回収静脈圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","160"}'' as war_dev_a_0160 -- 準備回収ダイアライザ入口圧固定警報上限
  ,rst_device_set_info#>>''{"war","dev","A","161"}'' as war_dev_a_0161 -- 準備回収ダイアライザ入口圧固定警報下限
  ,rst_device_set_info#>>''{"war","dev","A","254"}'' as war_dev_a_0254 -- Na濃度自動警報幅上限値
  ,rst_device_set_info#>>''{"war","dev","A","255"}'' as war_dev_a_0255 -- Na濃度自動警報幅下限値
  ,rst_device_set_info#>>''{"war","dev","A","256"}'' as war_dev_a_0256 -- Na濃度固定警報幅上限値
  ,rst_device_set_info#>>''{"war","dev","A","257"}'' as war_dev_a_0257 -- Na濃度固定警報幅下限値
  ,rst_device_set_info#>>''{"bp","dev","A","211"}'' as bp_dev_a_0211 -- 血圧警報点最高血圧上限
  ,rst_device_set_info#>>''{"bp","dev","A","212"}'' as bp_dev_a_0212 -- 血圧警報点最高血圧下限
  ,rst_device_set_info#>>''{"bp","dev","A","213"}'' as bp_dev_a_0213 -- 血圧警報点最低血圧上限
  ,rst_device_set_info#>>''{"bp","dev","A","214"}'' as bp_dev_a_0214 -- 血圧警報点最低血圧下限
  ,rst_device_set_info#>>''{"bp","dev","A","215"}'' as bp_dev_a_0215 -- 血圧警報点平均血圧上限
  ,rst_device_set_info#>>''{"bp","dev","A","216"}'' as bp_dev_a_0216 -- 血圧警報点平均血圧下限
  ,rst_device_set_info#>>''{"bp","dev","A","217"}'' as bp_dev_a_0217 -- 血圧警報点脈拍数上限
  ,rst_device_set_info#>>''{"bp","dev","A","218"}'' as bp_dev_a_0218 -- 血圧警報点脈拍数下限
  ,rst_device_set_info#>>''{"bp","dev","A","219"}'' as bp_dev_a_0219 -- 最高血圧上限警報_血液ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","227"}'' as bp_dev_a_0227 -- 最高血圧上限警報_血液ポンプ_速度
  ,rst_device_set_info#>>''{"bp","dev","A","220"}'' as bp_dev_a_0220 -- 最高血圧下限警報_血液ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","228"}'' as bp_dev_a_0228 -- 最高血圧下限警報_血液ポンプ_速度
  ,rst_device_set_info#>>''{"bp","dev","A","221"}'' as bp_dev_a_0221 -- 最高血圧上限警報_除水ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","229"}'' as bp_dev_a_0229 -- 最高血圧上限警報_除水ポンプ_速度
  ,rst_device_set_info#>>''{"bp","dev","A","222"}'' as bp_dev_a_0222 -- 最高血圧下限警報_除水ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","230"}'' as bp_dev_a_0230 -- 最高血圧下限警報_除水ポンプ_速度
  ,rst_device_set_info#>>''{"bp","dev","A","223"}'' as bp_dev_a_0223 -- 最高血圧上限警報_Na注入ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","231"}'' as bp_dev_a_0231 -- 最高血圧上限警報_Na注入ポンプ_速度
  ,rst_device_set_info#>>''{"bp","dev","A","224"}'' as bp_dev_a_0224 -- 最高血圧下限警報_Na注入ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","232"}'' as bp_dev_a_0225 -- 最高血圧上限警報_補液ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","233"}'' as bp_dev_a_0233 -- 最高血圧上限警報_補液ポンプ_速度
  ,rst_device_set_info#>>''{"bp","dev","A","226"}'' as bp_dev_a_0226 -- 最高血圧下限警報_補液ポンプ_動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","234"}''as bp_dev_a_0234 -- 最高血圧下限警報_補液ポンプ_速度
  ,rst_device_set_info#>>''{"bp","dev","A","191"}'' as bp_dev_a_0191 -- 血圧カフ選択
  ,rst_device_set_info#>>''{"bp","dev","A","190"}'' as bp_dev_a_0190 -- 血圧自動測定間隔
  ,rst_device_set_info#>>''{"bp","dev","A","192"}'' as bp_dev_a_0192 -- 昇圧値
  ,rst_device_set_info#>>''{"bp","dev","A","193"}'' as bp_dev_a_0193 -- 昇圧方法選択
  ,rst_device_set_info#>>''{"bp","dev","A","195"}'' as bp_dev_a_0195 -- 血圧測定方法選択
  ,rst_device_set_info#>>''{"bp","dev","A","239"}'' as bp_dev_a_0239 -- 高速測定選択
  ,rst_device_set_info#>>''{"bp","dev","A","194"}'' as bp_dev_a_0194 -- 血圧連続測定動作選択
  ,rst_device_set_info#>>''{"bp","dev","A","235"}'' as bp_dev_a_0235 -- 警報連動測定開始時間
  ,rst_device_set_info#>>''{"bp","dev","A","236"}'' as bp_dev_a_0236 -- 治療条件連動測定時間
  ,rst_device_set_info#>>''{"bp","dev","A","237"}'' as bp_dev_a_0237 -- 静脈圧警報発生時の血圧測定
  ,rst_device_set_info#>>''{"bp","dev","A","238"}'' as bp_dev_a_0238 -- 血流量または除水速度変更時の血圧測定
  ,rst_device_set_info#>>''{"bv","dev","A","267"}'' as bv_dev_a_0267 -- BV計使用選択
  ,rst_device_set_info#>>''{"bv","dev","A","260"}'' as bv_dev_a_0260 -- ⊿BV低下警報点1
  ,rst_device_set_info#>>''{"bv","dev","A","261"}'' as bv_dev_a_0261 -- ⊿BV低下警報点2
  ,rst_device_set_info#>>''{"bv","dev","A","262"}'' as bv_dev_a_0262 -- ⊿BV変化率警報点
  ,rst_device_set_info#>>''{"bv","dev","A","277"}'' as bv_dev_a_0277 -- ⊿BV除水低下速度
  ,rst_device_set_info#>>''{"bv","dev","A","278"}'' as bv_dev_a_0278 -- ⊿BV除水低下遅延時間
  ,rst_device_set_info#>>''{"bv","dev","A","258"}'' as bv_dev_a_0258 -- アクセス再循環測定使用選択
  ,rst_device_set_info#>>''{"bv","dev","A","259"}'' as bv_dev_a_0259 -- アクセス再循環自動測定1
  ,rst_device_set_info#>>''{"bv","dev","A","263"}'' as bv_dev_a_0263 -- アクセス再循環自動測定2
  ,rst_device_set_info#>>''{"bv","dev","A","264"}'' as bv_dev_a_0264 -- アクセス再循環自動測定3
  ,rst_device_set_info#>>''{"bv","dev","A","265"}'' as bv_dev_a_0265 -- アクセス再循環自動測定4
  ,rst_device_set_info#>>''{"bv","dev","A","266"}'' as bv_dev_a_0266 -- アクセス再循環自動測定5
  ,rst_device_set_info#>>''{"dfas","dev","A","270"}'' as dfas_dev_a_0270 -- 動脈側返血使用選択
  ,rst_device_set_info#>>''{"bv","dev","A","281"}'' as bv_dev_a_0281 -- アクセス再循環再循環率報知
  ,rst_device_set_info#>>''{"pri","pat","A","219"}'' as pri_pat_a_0219 -- プライミング補助動脈充填液量
  ,rst_device_set_info#>>''{"pri","pat","A","220"}'' as pri_pat_a_0220 -- プライミング補助動脈充填流速
  ,rst_device_set_info#>>''{"pri","pat","A","225"}'' as pri_pat_a_0225 -- プライミング補助動脈充填後継続の有無
  ,rst_device_set_info#>>''{"pri","pat","A","221"}'' as pri_pat_a_0221 -- プライミング補助静脈充填液量
  ,rst_device_set_info#>>''{"pri","pat","A","222"}'' as pri_pat_a_0222 -- プライミング補助静脈充填流速
  ,rst_device_set_info#>>''{"pri","pat","A","226"}'' as pri_pat_a_0226 -- プライミング補助静脈充填後継続の有無
  ,rst_device_set_info#>>''{"pri","pat","A","223"}'' as pri_pat_a_0223 -- プライミング補助気泡抜き液量
  ,rst_device_set_info#>>''{"pri","pat","A","224"}'' as pri_pat_a_0224 -- プライミング補助気泡抜き流速
  ,rst_device_set_info#>>''{"pri","pat","A","227"}'' as pri_pat_a_0227 -- プライミング補助気泡抜き間欠動作選択
  ,rst_device_set_info#>>''{"pri","pat","A","228"}'' as pri_pat_a_0228 -- プライミング補助液交換量
  ,rst_device_set_info#>>''{"pri","pat","A","229"}'' as pri_pat_a_0229 -- プライミング補助間欠動作動作時間
  ,rst_device_set_info#>>''{"pri","pat","A","230"}'' as pri_pat_a_0230 -- プライミング補助間欠動作停止時間
  ,rst_device_set_info#>>''{"pri","pat","A","232"}'' as pri_pat_a_0232 -- 自動プライミング落差時間
  ,rst_device_set_info#>>''{"pri","pat","A","238"}'' as pri_pat_a_0238 -- 自動プライミング総量
  ,rst_device_set_info#>>''{"pri","pat","A","231"}'' as pri_pat_a_0231 -- 自動プライミング開始時間
  ,rst_device_set_info#>>''{"pri","pat","A","233"}'' as pri_pat_a_0233 -- 自動プライミング送液液量
  ,rst_device_set_info#>>''{"pri","pat","A","234"}'' as pri_pat_a_0234 -- 自動プライミング送液流速1回目
  ,rst_device_set_info#>>''{"pri","pat","A","235"}'' as pri_pat_a_0235 -- 自動プライミング送液流速2回目以降
  ,rst_device_set_info#>>''{"pri","pat","A","236"}'' as pri_pat_a_0236 -- 自動プライミング循環流速
  ,rst_device_set_info#>>''{"pri","pat","A","237"}'' as pri_pat_a_0237 -- 自動プライミング循環時間
  ,rst_device_set_info#>>''{"pri","dev","A","370"}'' as pri_dev_a_0370 -- 自動回収_使用液量
  ,rst_device_set_info#>>''{"pri","dev","A","371"}'' as pri_dev_a_0371 -- 自動回収_流速
  ,rst_device_set_info#>>''{"pri","dev","A","372"}'' as pri_dev_a_0372 -- 自動回収_血液判別器による終了選択
  ,rst_device_set_info#>>''{"pri","pat","B","51"}'' as pri_pat_b_0051 -- オンラインプライミング_ダイアライザ気泡抜き時間_後補液
  ,rst_device_set_info#>>''{"pri","pat","B","32"}'' as pri_pat_b_0032 -- オンラインプライミング_動脈チャンバ液面作成時間_前補液
  ,rst_device_set_info#>>''{"pri","pat","B","52"}'' as pri_pat_b_0052 -- オンラインプライミング_動脈チャンバ液面作成時間_後補液
  ,rst_device_set_info#>>''{"pri","pat","B","33"}'' as pri_pat_b_0033 -- オンラインプライミング_循環洗浄時間_前補液
  ,rst_device_set_info#>>''{"pri","pat","B","53"}'' as pri_pat_b_0053 -- オンラインプライミング_循環洗浄時間_後補液
  ,rst_device_set_info#>>''{"ufr","dev","A","290"}'' as ufr_dev_a_0290 -- UFRプログラム使用選択
  ,rst_device_set_info#>>''{"na","dev","A","315"}'' as na_dev_a_0315 -- Na注入プログラム使用選択
  ,rst_device_set_info#>>''{"na","dev","A","184"}'' as na_dev_a_0184 -- Na注入濃度最大値
  ,rst_device_set_info#>>''{"dc","dev","A","340"}'' as dc_dev_a_0340 -- 透析液濃度プログラム使用選択
  ,rst_device_set_info#>>''{"ecum","dev","A","16"}'' as ecum_dev_a_0016 -- ECUM選択
  ,rst_device_set_info#>>''{"ecum","dev","A","17"}'' as ecum_dev_a_0017 -- ECUM量
  ,rst_device_set_info#>>''{"ecum","dev","A","18"}'' as ecum_dev_a_0018 -- ECUM時間
  ,rst_device_set_info#>>''{"ecum","dev","A","19"}'' as ecum_dev_a_0019 -- ECUM時間カウント選択
  ,rst_device_set_info#>>''{"cpro","dev","A","252"}'' as cpro_dev_a_0252 -- Ｂ液濃度プログラム自動設定警報幅上限
  ,rst_device_set_info#>>''{"cpro","dev","A","253"}'' as cpro_dev_a_0253 -- Ｂ液濃度プログラム自動設定警報幅下限
  ,rst_device_set_info#>>''{"cpro","dev","A","250"}'' as cpro_dev_a_0250 -- 透析液濃度プログラム自動設定警報幅上限
  ,rst_device_set_info#>>''{"cpro","dev","A","251"}'' as cpro_dev_a_0251 -- 透析液濃度プログラム自動設定警報幅下限
  ,rst_device_set_info#>>''{"dfas","pat","B","1"}'' as dfas_pat_b_0001 -- IPラインプライミング使用選択
  ...
  ,rst_device_set_info#>>''{"dfas","pat","B","5"}'' as dfas_pat_b_0005 -- 中空糸_プライミング時のBP速度
  ,rst_device_set_info#>>''{"dfas","pat","B","7"}'' as dfas_pat_b_0007 -- 中空糸_送液最大時間
  ,rst_device_set_info#>>''{"dfas","pat","B","8"}'' as dfas_pat_b_0008 -- 中空糸_回路内洗浄送液量
  ,rst_device_set_info#>>''{"dfas","pat","B","9"}'' as dfas_pat_b_0009 -- 中空糸_気泡抜き動作実行回数
  ,rst_device_set_info#>>''{"dfas","pat","B","10"}'' as dfas_pat_b_0010 -- 中空糸_気泡抜き圧力上限
  ,rst_device_set_info#>>''{"dfas","pat","B","59"}'' as dfas_pat_b_0059 -- 積層_プライミング時のBP速度
  ,rst_device_set_info#>>''{"dfas","pat","B","54"}'' as dfas_pat_b_0054 -- 積層_送液最大時間
  ,rst_device_set_info#>>''{"dfas","pat","B","55"}'' as dfas_pat_b_0055 -- 積層_回路内洗浄送液量
  ,rst_device_set_info#>>''{"dfas","pat","B","56"}'' as dfas_pat_b_0056 -- 積層_気泡抜き動作実行回数
  ,rst_device_set_info#>>''{"dfas","pat","B","57"}'' as dfas_pat_b_0057 -- 積層_気泡抜き圧力上限
  ,rst_device_set_info#>>''{"dfas","pat","B","58"}'' as dfas_pat_b_0058 -- 積層_除水ポンプ速度
  ,rst_device_set_info#>>''{"dfas","dev","A","339"}'' as dfas_dev_a_0339 -- 脱血方法選択
  ,rst_device_set_info#>>''{"dfas","dev","A","333"}'' as dfas_dev_a_0333 -- 脱血速度
  ,rst_device_set_info#>>''{"dfas","dev","A","331"}'' as dfas_dev_a_0331 -- 同時脱血_脱血量
  ,rst_device_set_info#>>''{"dfas","dev","A","334"}'' as dfas_dev_a_0334 -- 片側脱血(除水なし)_脱血量
  ,rst_device_set_info#>>''{"dfas","dev","A","338"}'' as dfas_dev_a_0338 -- 片側脱血（除水あり）_脱血量
  ,rst_device_set_info#>>''{"dfas","dev","A","332"}'' as dfas_dev_a_0332 -- 片側脱血への切替え透析液圧
  ,treat_condition->>''335'' as ord_treat_condition_335 -- 治療開始時_血液ポンプ速度
  ,rst_device_set_info#>>''{"dfas","dev","A","373"}'' as dfas_dev_a_0373 -- 静脈側返血速度
  ,rst_device_set_info#>>''{"dfas","dev","A","374"}'' as dfas_dev_a_0374 -- 静脈側最大返血量
  ,rst_device_set_info#>>''{"dfas","dev","A","377"}'' as dfas_dev_a_0377 -- 静脈側返血_血液判別器使用選択
  ,rst_device_set_info#>>''{"dfas","dev","A","376"}'' as dfas_dev_a_0376 -- 動脈側最大返血量
  ,rst_device_set_info#>>''{"dfas","dev","A","378"}'' as dfas_dev_a_0378 -- 動脈側返血_血液判別器使用選択
  ,rst_device_set_info#>>''{"dia","dev","A","282"}'' as dia_dev_a_0282 -- 透析量プログラム使用選択
  ...
  ,rst_device_set_info#>>''{"dia","dev","A","288"}'' as dia_dev_a_0288 -- 目標Kt/V
  ...
  ,rst_device_set_info#>>''{"bvufc","dev","A","196"}'' as bvufc_dev_a_0196 -- BV-UFC使用選択
  ,rst_device_set_info#>>''{"bvufc","dev","A","197"}'' as bvufc_dev_a_0197 -- UFC期間除水速度上限
  ,rst_device_set_info#>>''{"bvufc","dev","A","198"}'' as bvufc_dev_a_0198 -- UFC期間除水速度下限
  ,rst_device_set_info#>>''{"bvufc","dev","A","199"}'' as bvufc_dev_a_0199 -- 開始期間 時間
  ,rst_device_set_info#>>''{"bvufc","dev","A","206"}'' as bvufc_dev_a_0206 -- 開始期間 除水速度倍率
  ,rst_device_set_info#>>''{"bvufc","dev","A","207"}'' as bvufc_dev_a_0207 -- 固定倍率除水期間 時間
  ,rst_device_set_info#>>''{"bvufc","dev","A","208"}'' as bvufc_dev_a_0208 -- 固定倍率除水期間 除水速度倍率
  ,rst_device_set_info#>>''{"bvufc","dev","A","209"}'' as bvufc_dev_a_0209 -- 固定倍率除水終了条件　最高血圧
  ,rst_device_set_info#>>''{"bvufc","dev","A","210"}'' as bvufc_dev_a_0210 -- 固定倍率除水終了条件　脈拍
  ,rst_device_set_info#>>''{"bvufc","dev","A","248"}'' as bvufc_dev_a_0248 -- 固定倍率除水終了条件　ΔBV
  ,rst_device_set_info#>>''{"bvufc","dev","A","249"}'' as bvufc_dev_a_0249 -- 終了前期間 時間
  ,rst_device_set_info#>>''{"ope","dev","A","268"}'' as ope_dev_a_0268 -- 透析液流量　設定方法
  ,rst_device_set_info#>>''{"ope","dev","A","269"}'' as ope_dev_a_0269 -- 透析液流量　比率設定
  ,rst_device_set_info#>>''{"bvufc","dev","A","271"}'' as bvufc_dev_a_0271 -- 開始時ΔBV基準値
  ,rst_device_set_info#>>''{"bvufc","dev","A","272"}'' as bvufc_dev_a_0272 -- ΔBV基準線　指数1
  ,rst_device_set_info#>>''{"bvufc","dev","A","273"}'' as bvufc_dev_a_0273 -- ΔBV基準線　指数2
  ,rst_device_set_info#>>''{"bvufc","dev","A","274"}'' as bvufc_dev_a_0274 -- ΔBV基準線　指数3
  ,rst_device_set_info#>>''{"bvufc","dev","A","275"}'' as bvufc_dev_a_0275 -- 終了時ΔBV基準値
  ,rst_device_set_info#>>''{"qbqd","dev","A","400"}'' as qbqd_dev_a_0400 -- QBプログラム血流量1
  ,rst_device_set_info#>>''{"qbqd","dev","A","401"}'' as qbqd_dev_a_0401 -- QBプログラム血流量2
  ,rst_device_set_info#>>''{"qbqd","dev","A","402"}'' as qbqd_dev_a_0402 -- QBプログラム血流量3
  ,rst_device_set_info#>>''{"qbqd","dev","A","403"}'' as qbqd_dev_a_0403 -- QBプログラム血流量4
  ,rst_device_set_info#>>''{"qbqd","dev","A","404"}'' as qbqd_dev_a_0404 -- QBプログラム血流量5
  ,rst_device_set_info#>>''{"qbqd","dev","A","405"}'' as qbqd_dev_a_0405 -- QBプログラム血流量6
  ,rst_device_set_info#>>''{"qbqd","dev","A","406"}'' as qbqd_dev_a_0406 -- QBプログラム血流量7
  ,rst_device_set_info#>>''{"qbqd","dev","A","407"}'' as qbqd_dev_a_0407 -- QBプログラム血流量8
  ,rst_device_set_info#>>''{"qbqd","dev","A","408"}'' as qbqd_dev_a_0408 -- QBプログラム血流量9
  ,rst_device_set_info#>>''{"qbqd","dev","A","409"}'' as qbqd_dev_a_0409 -- QBプログラム血流量10
  ,rst_device_set_info#>>''{"qbqd","dev","A","410"}'' as qbqd_dev_a_0410 -- QDプログラム透析液流量1
  ,rst_device_set_info#>>''{"qbqd","dev","A","411"}'' as qbqd_dev_a_0411 -- QDプログラム透析液流量2
  ,rst_device_set_info#>>''{"qbqd","dev","A","412"}'' as qbqd_dev_a_0412 -- QDプログラム透析液流量3
  ,rst_device_set_info#>>''{"qbqd","dev","A","413"}'' as qbqd_dev_a_0413 -- QDプログラム透析液流量4
  ,rst_device_set_info#>>''{"qbqd","dev","A","414"}'' as qbqd_dev_a_0414 -- QDプログラム透析液流量5
  ,rst_device_set_info#>>''{"qbqd","dev","A","415"}'' as qbqd_dev_a_0415 -- QDプログラム透析液流量6
  ,rst_device_set_info#>>''{"qbqd","dev","A","416"}'' as qbqd_dev_a_0416 -- QDプログラム透析液流量7
  ,rst_device_set_info#>>''{"qbqd","dev","A","417"}'' as qbqd_dev_a_0417 -- QDプログラム透析液流量8
  ,rst_device_set_info#>>''{"qbqd","dev","A","418"}'' as qbqd_dev_a_0418 -- QDプログラム透析液流量9
  ,rst_device_set_info#>>''{"qbqd","dev","A","419"}'' as qbqd_dev_a_0419 -- QDプログラム透析液流量10
  ,rst_device_set_info#>>''{"qbqd","dev","A","420"}'' as qbqd_dev_a_0420 -- QB、QDプログラム切替時間1
  ,rst_device_set_info#>>''{"qbqd","dev","A","421"}'' as qbqd_dev_a_0421 -- QB、QDプログラム切替時間2
  ,rst_device_set_info#>>''{"qbqd","dev","A","422"}'' as qbqd_dev_a_0422 -- QB、QDプログラム切替時間3
  ,rst_device_set_info#>>''{"qbqd","dev","A","423"}'' as qbqd_dev_a_0423 -- QB、QDプログラム切替時間4
  ,rst_device_set_info#>>''{"qbqd","dev","A","424"}'' as qbqd_dev_a_0424 -- QB、QDプログラム切替時間5
  ,rst_device_set_info#>>''{"qbqd","dev","A","425"}'' as qbqd_dev_a_0425 -- QB、QDプログラム切替時間6
  ,rst_device_set_info#>>''{"qbqd","dev","A","426"}'' as qbqd_dev_a_0426 -- QB、QDプログラム切替時間7
  ,rst_device_set_info#>>''{"qbqd","dev","A","427"}'' as qbqd_dev_a_0427 -- QB、QDプログラム切替時間8
  ,rst_device_set_info#>>''{"qbqd","dev","A","428"}'' as qbqd_dev_a_0428 -- QB、QDプログラム切替時間9
  ,rst_device_set_info#>>''{"qbqd","dev","A","429"}'' as qbqd_dev_a_0429 -- QB、QDプログラム最大ステップ数
  ,rst_device_set_info#>>''{"qbqd","dev","A","430"}'' as qbqd_dev_a_0430 -- QBプログラム電源
  ,rst_device_set_info#>>''{"qbqd","dev","A","431"}'' as qbqd_dev_a_0431 -- QDプログラム電源
  ,rst_device_set_info#>>''{"ihdf","dev","A","432"}'' as ihdf_dev_a_0432 -- I-HDFプログラム使用選択
  ,rst_device_set_info#>>''{"ihdf","dev","A","433"}'' as ihdf_dev_a_0433 -- 予定補液回数
  ,rst_device_set_info#>>''{"ihdf","dev","A","434"}'' as ihdf_dev_a_0434 -- 補液バランス制限
  ,rst_device_set_info#>>''{"ihdf","dev","A","435"}'' as ihdf_dev_a_0435 -- 補液量01
  ,rst_device_set_info#>>''{"ihdf","dev","A","436"}'' as ihdf_dev_a_0436 -- 補液量02
  ,rst_device_set_info#>>''{"ihdf","dev","A","437"}'' as ihdf_dev_a_0437 -- 補液量03
  ,rst_device_set_info#>>''{"ihdf","dev","A","438"}'' as ihdf_dev_a_0438 -- 補液量04
  ,rst_device_set_info#>>''{"ihdf","dev","A","439"}'' as ihdf_dev_a_0439 -- 補液量05
  ,rst_device_set_info#>>''{"ihdf","dev","A","440"}'' as ihdf_dev_a_0440 -- 補液量06
  ,rst_device_set_info#>>''{"ihdf","dev","A","441"}'' as ihdf_dev_a_0441 -- 補液量07
  ,rst_device_set_info#>>''{"ihdf","dev","A","442"}'' as ihdf_dev_a_0442 -- 補液量08
  ,rst_device_set_info#>>''{"ihdf","dev","A","443"}'' as ihdf_dev_a_0443 -- 補液量09
  ,rst_device_set_info#>>''{"ihdf","dev","A","444"}'' as ihdf_dev_a_0444 -- 補液量10
  ,rst_device_set_info#>>''{"ihdf","dev","A","445"}'' as ihdf_dev_a_0445 -- 補液量11
  ,rst_device_set_info#>>''{"ihdf","dev","A","446"}'' as ihdf_dev_a_0446 -- 補液量12
  ,rst_device_set_info#>>''{"ihdf","dev","A","447"}'' as ihdf_dev_a_0447 -- 補液量13
  ,rst_device_set_info#>>''{"ihdf","dev","A","448"}'' as ihdf_dev_a_0448 -- 補液量14
  ,rst_device_set_info#>>''{"ihdf","dev","A","449"}'' as ihdf_dev_a_0449 -- 補液量15
  ,rst_device_set_info#>>''{"ihdf","dev","A","450"}'' as ihdf_dev_a_0450 -- 補液量16
  ,rst_device_set_info#>>''{"ihdf","dev","A","451"}'' as ihdf_dev_a_0451 -- 回収量01
  ,rst_device_set_info#>>''{"ihdf","dev","A","452"}'' as ihdf_dev_a_0452 -- 回収量02
  ,rst_device_set_info#>>''{"ihdf","dev","A","453"}'' as ihdf_dev_a_0453 -- 回収量03
  ,rst_device_set_info#>>''{"ihdf","dev","A","454"}'' as ihdf_dev_a_0454 -- 回収量04
  ,rst_device_set_info#>>''{"ihdf","dev","A","455"}'' as ihdf_dev_a_0455 -- 回収量05
  ,rst_device_set_info#>>''{"ihdf","dev","A","456"}'' as ihdf_dev_a_0456 -- 回収量06
  ,rst_device_set_info#>>''{"ihdf","dev","A","457"}'' as ihdf_dev_a_0457 -- 回収量07
  ,rst_device_set_info#>>''{"ihdf","dev","A","458"}'' as ihdf_dev_a_0458 -- 回収量08
  ,rst_device_set_info#>>''{"ihdf","dev","A","459"}'' as ihdf_dev_a_0459 -- 回収量09
  ,rst_device_set_info#>>''{"ihdf","dev","A","460"}'' as ihdf_dev_a_0460 -- 回収量10
  ,rst_device_set_info#>>''{"ihdf","dev","A","461"}'' as ihdf_dev_a_0461 -- 回収量11
  ,rst_device_set_info#>>''{"ihdf","dev","A","462"}'' as ihdf_dev_a_0462 -- 回収量12
  ,rst_device_set_info#>>''{"ihdf","dev","A","463"}'' as ihdf_dev_a_0463 -- 回収量13
  ,rst_device_set_info#>>''{"ihdf","dev","A","464"}'' as ihdf_dev_a_0464 -- 回収量14
  ,rst_device_set_info#>>''{"ihdf","dev","A","465"}'' as ihdf_dev_a_0465 -- 回収量15
  ,rst_device_set_info#>>''{"ihdf","dev","A","466"}'' as ihdf_dev_a_0466 -- 回収量16
from
  ord_main
...
where
  ...
  and rst_dialysis_state > ''0'' and rst_dialysis_state < ''6''
order by no
;',2,'[{"preview": "指示簿テストです。", "can_calc": "0", "data_code": "content", "data_name": "指示内容", "data_type": "string", "conv_table": [], "data_class": "指示簿", "field_name": "content", "disp_format": "", "data_category": "実績（治療中）", "facility_table": "", "facility_filter_type": "0"}]','0','{"applications": [1]}','{"classes": [1, 2, 3, 9]}','実績（治療中）：指示簿(指示コメント) @ordNo 使用','2021-08-05T13:30:00','2021-08-05T13:30:00',null);
