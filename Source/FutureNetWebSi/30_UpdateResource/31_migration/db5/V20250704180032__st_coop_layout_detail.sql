...
(-1207100002,-1207100001,-1210100003,-1210100002,-1210100001);
...
</root>', '{"key": {"分類属性": {"02": "all"}}}'::jsonb, '1', '0', 4, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP, 'F_SX');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-1210100001, 'F_SX', 'exam_ord', 'S', '検査項目', 'pre', 'SX連携', '依頼送信 ※送信：preとallの設定無効', '1', '<root name="明細詳細(pre)">
    <item  name="レコード区分" len="2" key="分類属性" value="const:O2"/>
    ...
    <item  name="RSV" len="8" value="$BLANK"/>
    <item  name="改行" len="1" value="$CR"/>
</root>', '{"key": {"分類属性": {"O2": "all"}}}'::jsonb, '1', '0', 4, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP, 'F_SX');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-1207100002, 'F_SX', 'rst_dial', 'S', '薬剤', 'blank', 'SX連携', 'S', '1', '<root name="薬剤">
...
</root>', '{}'::jsonb, '1', '0', 4, CURRENT_TIMESTAMP,CURRENT_TIMESTAMP, 'F_SX');
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-1207100001, 'F_SX', 'rst_dial', 'S', '薬剤', '薬剤', 'SX連携', 'S', '1', '<root name="薬剤">
...
INSERT INTO ntss.mst_coop_layout_detail
(ctl_no, facility_cd, coop_cd, direction, coop_cd_detail, coop_cd_detail_sub, coop_name, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-1210100002, 'F_SX', 'exam_ord', 'S', '検査項目', 'all', 'SX連携', '依頼送信 ※送信：preとallの設定無効', '1', '<root name="明細詳細(pre)">
