...
VALUES(-110001, 'Secom', 'rep_dial', 'pdf', 'D', 'S', 'I', 'A', 1, 'http://localhost:8080/ntss-coop-api/journal/setReportDialSkip', 'POST', '{"crud": "D", "key0": "$JOURNAL.key0", "ord_no": "$JOURNAL.ord_no", "pat_id": "$JOURNAL.pat_id", "coop_cd": "$JOURNAL.coop_cd", "facility_cd": "$JOURNAL.facility_cd", "coop_version": "Secom", "coop_cd_index": "$JOURNAL.coop_cd_index"}'::jsonb, '{"exit_code": [], "continue_code": [200]}'::jsonb, '{}'::jsonb, '0', -1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '0', NULL, 'Secom');