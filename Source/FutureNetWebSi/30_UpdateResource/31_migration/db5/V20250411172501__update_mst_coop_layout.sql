...
VALUES(-4170001, 'P_hosp', 'karte_ord', '', 'S', 'cre', 'xml', 'カルテ記載(透析経過データ連携)', 'medicom', 'Medicomのカルテ記載(透析経過データ連携)', '1', '<MCSSData ver="Ver.03.02 2010-01-20">
  ...
  <Content>
    ...
    <Row RowCount="19" MasterID="124" detail="SOAP" _detail="soap" _sqlCode="-317121" _isZeroDisp="true">
    </Row>
    <Row RowCount="20" MasterID="125" detail="看護メモ" _detail="nurse_memo" _sqlCode="-317122" _isZeroDisp="true">
    </Row>
    <Row RowCount="21" MasterID="126" detail="問診記録" _detail="medical_record" _sqlCode="-317123" _isZeroDisp="true">
    </Row>
