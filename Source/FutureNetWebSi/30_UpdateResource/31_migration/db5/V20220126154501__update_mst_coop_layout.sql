delete from "mst_coop_layout" where "ctl_no" in (-2070001,-2070002,-2070003);
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2070001, 'F_hosp', 'rst_dial', '', 'S', 'cre', 'text', '富士通実績', 'fujitsu', '実績送信', '1', '<root name="富士通透析実績">
    ...
    <item  name="伝票情報.診療科コード" len="3" value="dataset:-11.course_cd"/>
    <item  name="伝票情報.病棟コード" len="3" value="dataset:-11.ward_cd"/>
    ...
    <item  name="予約情報.予約枠コード" len="7" value="dataset:-11.bed_cd" padding_format="zero"/>
    ...
    <occ  name="明細行数" len="4" detail="実績詳細" sqlCode="-101"/>
    <item  name="終端" value="$CR"/>
</root>', '{"dataset": [{"patId": "patId", "sqlCode": 1}, {"ordNo": "ordNo", "sqlCode": -101}, {"ordNo": "ordNo", "sqlCode": -14}, {"ordNo": "ordNo", "sqlCode": -11}, {"ordNo": "ordNo", "sqlCode": -102}, {"ordNo": "ordNo", "sqlCode": -22}], "dumpFileName": {"patId": "patId", "sqlCode": -99997}}', '1', '0', 4, '2020-05-01 10:15:53.808', '2020-05-01 10:16:00.803');
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2070002, 'F_hosp', 'rst_dial', '', 'S', 'upd', 'text', '富士通実績', 'fujitsu', '実績送信', '1', '<root name="富士通透析実績">
    <item  name="電文種別" len="2" value="const:VO"/>
    <item  name="レコード継続指示" len="1" value="const:E"/>
    <item  name="送信先システムコード" len="2" value="const:XX"/>
    <item  name="発信元システムコード"  len="2" value="const:VN"/>
...
INSERT INTO "mst_coop_layout"("ctl_no", "facility_cd", "coop_cd", "coop_cd_index", "direction", "coop_cd_sub", "coop_format", "coop_name", "coop_vender", "description", "is_editable", "coop_setting", "coop_ext_setting", "is_disp", "is_del", "user_id", "reg_date", "up_date") VALUES (-2070003, 'F_hosp', 'rst_dial', '', 'S', 'del', 'text', '富士通実績', 'fujitsu', '実績送信', '1', '<root name="富士通透析実績">
    <item  name="電文種別" len="2" value="const:VO"/>
    <item  name="レコード継続指示" len="1" value="const:E"/>
    <item  name="送信先システムコード" len="2" value="const:XX"/>
    <item  name="発信元システムコード"  len="2" value="const:VN"/>
