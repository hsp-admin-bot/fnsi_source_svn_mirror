...
WHERE sql_cd=-1103010;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103011;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103005;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103006;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103007;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103008;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103001;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103002;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103003;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103018;
DELETE FROM ntss.sys_data_set
WHERE sql_cd=-1103013;
...
-- SQL: -1103001 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(送信用)セコムの透析実績連携', '2025-07-16 14:50:48.578', current_timestamp, '[{"sql_cd": -1102004, "field_name": "pat_personal_info", "replace_var": "@patPersonalInfo"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-1103002, 'WITH RECURSIVE coop_ini_info AS (
--連携設定から取得
SELECT
  COALESCE(NULLIF(info ->> ''value'', ''''), info ->> ''default_v'') AS value,
  info ->> ''key1'' AS key1,
...
ORDER BY rp_no, medi_no', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, '(送信用)セコムの透析実績連携', '2025-06-03 08:56:02.129', current_timestamp, '[{"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);
...
-- SQL: -1103003 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_オーダーインデックス', '2025-07-16 14:50:48.578', current_timestamp, '[{"sql_cd": -1102004, "field_name": "pat_personal_info", "replace_var": "@patPersonalInfo"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-1103005, '-- SQL: -1103005 begin
select  
CASE @crud
    when ''del'' then
  		CASE @dumpResult
...
@fileName AS file_name,
@folderName AS folder_name
-- SQL: -1103006 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_処置ヘッダー', '2025-07-30 10:00:11.290', current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-1103007, '-- SQL: -1103007 begin
select  
CASE @crud
    when ''del'' then
  		CASE @dumpResult
...
@fileName AS file_name,
@folderName AS folder_name
-- SQL: -1103007 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_処置単位', '2025-07-30 10:00:11.290', current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-1103008, '-- SQL: -1103008 begin
select  
CASE @crud
    when ''del'' then
  		CASE @dumpResult
...
@fileName AS file_name,
@folderName AS folder_name
-- SQL: -1103008 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 処置実績ファイル_処置項目', '2025-07-30 10:00:11.290', current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-1103010, '-- SQL: -1103010 begin
select  
CASE @crud
    when ''del'' then
  		CASE @dumpResult
...
@folderName AS folder_name,
@rpNo AS rp_no
-- SQL: -1103010 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 注射実績ファイル_オーダーインデックス', '2025-07-30 10:00:11.290', current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);

INSERT INTO ntss.sys_data_set
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info)
VALUES(-1103011, '-- SQL: -1103011 begin
select  
CASE @crud
    when ''del'' then
  		CASE @dumpResult
...
@folderName AS folder_name,
@rpNo AS rp_no
-- SQL: -1103011 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 注射実績ファイル_処置項目', '2025-07-30 10:00:11.290', current_timestamp, '[{"sql_cd": -1100008, "field_name": "filename", "replace_var": "@fileName"}, {"sql_cd": -1100013, "field_name": "folder_name", "replace_var": "@folderName"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);

INSERT INTO ntss.sys_data_set 
(sql_cd, "sql", db_class, detail, can_repeat, use_application, report_class, memo, reg_date, up_date, pre_sql_info) 
VALUES(-1103018, '-- SQL: -1103018 begin
WITH raw_data AS (
...
order by rp_no;
-- SQL: -1103018 end
', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 注射実績(削除電文用)', '2025-08-05 10:51:12.178', current_timestamp, '[{"sql_cd": -1103016, "field_name": "content_json", "replace_var": "@contentJson"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);
...
ORDER BY rp_no::int
-- SQL: -1103013 end', 2, '[{}]'::jsonb, '0', '{"applications": [4]}'::jsonb, NULL, 'セコム連携 透析実績連携 注射中止ファイル', '2025-08-01 15:43:21.288', current_timestamp, '[{"sql_cd": -1103016, "field_name": "content_json", "replace_var": "@contentJson"}, {"sql_cd": -1100016, "field_name": "dump_result", "replace_var": "@dumpResult"}]'::jsonb);
