...
insert into sys_system_define values (33, '003', '期間外削除テーブル管理(FNSi含む施設)', '[]', '期間削除で対象とするテーブルを指定する
db_class: 対象のDBクラス
table_name: 期間外削除の対象テーブル名
time_column_name: 期間外の判断基準とするTimeStampのカラム
retention_period：データ保持期間：単位は月
