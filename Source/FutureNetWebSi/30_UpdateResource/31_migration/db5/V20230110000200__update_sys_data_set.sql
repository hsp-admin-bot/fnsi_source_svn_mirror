...
ORDER BY item_cd_s, login_ord_s asc
 ...
 FROM
  ...
  med_orderC as (--調製薬剤グループ
	select * from med_orderA
	union all
  (select detail_id,sbt_key,e01,e02,e03,e04,e05,e06,e07,e08,e09,e10,e11,sorttag,sorttag1,sorttag2,aa,ordernow
	from med_order
  ...
  select med_orderB.detail_id, med_orderB.sbt_key,med_orderB.e01, med_orderB.e02,
	 ...
	 med_orderB.sorttag1,med_orderB.sorttag2,med_orderB.aa,med_order.ordernow
   from med_orderB, med_order where med_orderB.sorttag1 = med_order.sorttag1)
	order by ordernow ,sorttag1,sorttag2,e04
	)
 select * from (
