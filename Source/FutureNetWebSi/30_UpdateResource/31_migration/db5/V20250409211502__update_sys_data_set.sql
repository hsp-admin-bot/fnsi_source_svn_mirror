delete FROM "sys_data_set" WHERE sql_cd IN (-307063,-307064,-307065,-307066,-307071,-307068);
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
 ...
 where
    ...
    and mst_addition.addition_class in (''10'', ''11'')',2,'[]','0','{"applications": [4]}',NULL,NULL,'2023-11-21 23:54:57.716',CURRENT_TIMESTAMP,NULL);

INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	 (-307064,'with ord_main_info as(
    select
        ord_addition_info ->> ''cd'' as code,
        ord_addition_info ->> ''name'' as name
    from
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
 ...
 where
    ord_main_info.code = mst_addition.addition_cd :: text
    and mst_addition.addition_class in (''9'')',2,'[]','0','{"applications": [4]}',NULL,NULL,'2023-11-21 23:54:57.716',CURRENT_TIMESTAMP,NULL);

INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	 (-307066,'with ord_main_info as(
    select
        ord_addition_info ->> ''cd'' as code,
        ord_addition_info ->> ''name'' as name
    from
...
INSERT INTO ntss.sys_data_set (sql_cd,"sql",db_class,detail,can_repeat,use_application,report_class,memo,reg_date,up_date,pre_sql_info) VALUES
	...
	where
		...
		and mst_medicine_class.class_name = ''手術・麻酔''
	UNION
	ALL
    --通常薬剤の治療情報.実績：愁訴処置情報
	select
