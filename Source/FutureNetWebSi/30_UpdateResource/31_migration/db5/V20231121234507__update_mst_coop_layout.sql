...
WHERE ctl_no IN (-4030001,-4030002,-4030003,-4030005,-4060001,-4060002,-4060003,-4070001,-4070004,-4090001,-4090002,-4100001,-4100002,-4100003,-4170001,-4170002)
;
...
</root>', '{}'::jsonb, '1', '0', -1, '2020-01-21 08:29:41.740', CURRENT_TIMESTAMP, '');
;
...
</root>', '{"key": {"shori_kbn": {"MDT0": "cre"}}, "dataset": {"sqlGroup1": [{"crud": "S", "kind": "0", "judge": "", "table": "pat_personal_main", "ctl_no": "1", "sqlCode": 1101, "@hospPatId": "$journal.pat_personal_main.hosp_pat_id", "ExceptionMessage": "患者[@hospPatId]の個人情報に複数のデータが存在する。", "ExceptionCondition": "=N"}, {"crud": "C", "kind": "0", "judge": "$journal.pat_personal_main.hosp_pat_id#=#123", "table": "pat_personal_main", "ctl_no": "2", "@patSex": "$journal.pat_personal_main.pat_sex", "sqlCode": -303101, "@hospPatId": "$journal.pat_personal_main.hosp_pat_id", "@patBirthday": "$journal.pat_personal_main.pat_birthday", "@patLastName": "$journal.pat_personal_main.pat_last_name", "@patLastNmKana": "$journal.pat_personal_main.pat_last_name_kana", "@patContactInfo.tel1": "$journal.pat_personal_main.pat_contact_info.tel1", "@patContactInfo.zipCd": "$journal.pat_personal_main.pat_contact_info.zip_cd", "@patContactInfo.address1": "$journal.pat_personal_main.pat_contact_info.address1", "@patContactInfo.address2": "$journal.pat_personal_main.pat_contact_info.address2", "@patContactInfo.tel2": "$journal.pat_personal_main.pat_contact_info.tel2"}, {"crud": "U", "kind": "0", "judge": "", "table": "pat_personal_main", "ctl_no": "3", "@patSex": "$journal.pat_personal_main.pat_sex", "sqlCode": -303201, "@hospPatId": "$journal.pat_personal_main.hosp_pat_id", "@patBirthday": "$journal.pat_personal_main.pat_birthday", "@patLastName": "$journal.pat_personal_main.pat_last_name", "@patLastNmKana": "$journal.pat_personal_main.pat_last_name_kana", "@patContactInfo.tel1": "$journal.pat_personal_main.pat_contact_info.tel1", "@patContactInfo.zipCd": "$journal.pat_personal_main.pat_contact_info.zip_cd", "@patContactInfo.address1": "$journal.pat_personal_main.pat_contact_info.address1", "@patContactInfo.address2": "$journal.pat_personal_main.pat_contact_info.address2", "@patContactInfo.tel2": "$journal.pat_personal_main.pat_contact_info.tel2"}], "sqlGroup2": [{"crud": "S", "kind": "0", "judge": "", "table": "pat_main", "ctl_no": "1", "sqlCode": -303002, "insertResult": "{@patId:'''',@facilityCd:'''',@patMemoInfoValue:''[]'',@additionInfoValue:''[]''}"}, {"crud": "C", "kind": "0", "judge": "", "table": "pat_main", "ctl_no": "2", "sqlCode": -303102}], "sqlGroup3": [{"crud": "S", "kind": "0", "judge": "", "table": "pat_unique", "ctl_no": "1", "sqlCode": 1601, "insertResult": "{@patId:'''', @facilityCd:'''', @medicalHstInfoValue:''[]'', @inOutVisitHistoryInfoValue:''[]'', @physicalInfoFlg:'''', @physicalInfoValue:''[]''}"}, {"crud": "C", "kind": "0", "judge": "", "table": "pat_unique", "ctl_no": "2", "sqlCode": 1602}], "sqlGroup4": [{"No1": "登録・更新", "crud": "S", "kind": "0", "judge": "", "table": "pat_coop_detail", "ctl_no": "1", "sqlCode": -303004, "@save2.insuSetNo": "$journal.pat_coop_detail.save_2.insu_set_no", "@save2.insuNo": "$journal.pat_coop_detail.save_2.insu_no", "@save2.insuName": "$journal.pat_coop_detail.save_2.insu_name"}, {"crud": "C", "kind": "0", "judge": "", "table": "pat_coop_detail", "ctl_no": "2", "sqlCode": -303103, "@save2.insuSetNo": "$journal.pat_coop_detail.save_2.insu_set_no", "@save2.insuNo": "$journal.pat_coop_detail.save_2.insu_no", "@save2.insuName": "$journal.pat_coop_detail.save_2.insu_name"}]}}'::jsonb, '1', '0', -1, '2019-12-13 05:44:54.000', CURRENT_TIMESTAMP, '');
...
VALUES(-4030002, 'P_hosp', 'profile', '', 'R', 'cre', 'text', 'パナソニック 患者プロファイル', 'Medicom', '患者プロファイル', '1', '<root name="患者情報">
    ...
    <item  name="予備" len="1" type="string"/>
    <item  name="ETX" len="1" type="string"/>
</root>', '{}'::jsonb, '1', '0', -1, '2019-12-13 05:44:54.000', CURRENT_TIMESTAMP, '');
...
INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-4030005, 'P_hosp', 'profile', 'send_time', 'S', 'cre', 'text', '定時一括送信機能（パナソニック  患者プロファイル用）', 'Medicom', '患者プロファイル(定時)', '1', '<rootnode></rootnode>', '{"dataset": [{"sqlCode": -2400, "facilityCd": "facilityCd", "PreSqlInfoItem": ["@ord_no", "@pat_id"]}]}'::jsonb, '1', '0', -1, '2020-01-21 08:29:41.740', CURRENT_TIMESTAMP, '');
...
', '{"dataset": [{"patId": "patId", "sqlCode": -300001}, {"patId": "patId", "sqlCode": -455}, {"ordNo": "ordNo", "sqlCode": -456, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -457, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -1001}], "dumpFileName": {"patId": "patId", "sqlCode": -99998}}'::jsonb, '1', '0', -1, '2020-03-17 16:25:14.394', CURRENT_TIMESTAMP, '');
...
', '{"dataset": [{"patId": "patId", "sqlCode": -310004}, {"patId": "patId", "sqlCode": -310003, "facilityCd": "facilityCd"}, {"sqlCode": -310002, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310005, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -310010, "facilityCd": "facilityCd", "is_zero_end": "true"}, {"ordNo": "ordNo", "sqlCode": -310011, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -310006, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310008, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310009, "facilityCd": "facilityCd"}, {"sqlCode": -310001, "facilityCd": "facilityCd"}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -310007, "facilityCd": "facilityCd"}}'::jsonb, '1', '0', -1, '2020-05-13 18:35:00.661', CURRENT_TIMESTAMP, '');
...
', '{"dataset": [{"ordNo": "ordNo", "sqlCode": -310012, "facilityCd": "facilityCd", "is_zero_end": "true"}, {"patId": "patId", "sqlCode": -310004}, {"patId": "patId", "sqlCode": -310003, "facilityCd": "facilityCd"}, {"sqlCode": -310002, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310005, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -310010, "facilityCd": "facilityCd", "is_zero_end": "true"}, {"ordNo": "ordNo", "sqlCode": -310011, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -310006, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310008, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310009, "facilityCd": "facilityCd"}, {"sqlCode": -310001, "facilityCd": "facilityCd"}], "dumpFileName": {"ctlNo": "ctlNo", "sqlCode": -310007, "facilityCd": "facilityCd"}}'::jsonb, '1', '0', -1, '2020-05-13 18:35:00.661', CURRENT_TIMESTAMP, '');
...
', '{"dataset": [{"sqlCode": -310013, "is_zero_end": "true"}, {"patId": "patId", "sqlCode": -310004}, {"patId": "patId", "sqlCode": -310003, "facilityCd": "facilityCd"}, {"sqlCode": -310002, "facilityCd": "facilityCd"}, {"sqlCode": -310005, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -310010, "facilityCd": "facilityCd", "is_zero_end": "true"}, {"ordNo": "ordNo", "sqlCode": -310011, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -310006, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310008, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -310009, "facilityCd": "facilityCd"}, {"sqlCode": -310001, "facilityCd": "facilityCd"}], "dumpFileName": {"sqlCode": -310007, "facilityCd": "facilityCd"}}'::jsonb, '1', '0', -1, '2020-05-13 18:35:00.661', CURRENT_TIMESTAMP, '');
...
VALUES(-4170001, 'P_hosp', 'karte_ord', '', 'S', 'cre', 'xml', 'カルテ記載(透析経過データ連携)', 'medicom', 'Medicomのカルテ記載(透析経過データ連携)', '1', '<MCSSData ver="Ver.03.02 2010-01-20">
  ...
  <Content>
    ...
    <Row RowCount="17" MasterID="101" detail="造設日"/>
    <Row RowCount="18" MasterID="102" detail="透析導入日">
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-417">dataset:-417.e01</INPUTDATA>
    </Row>
    <Row RowCount="19" MasterID="103" detail="感染症情報">
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-418">dataset:-418.e01</INPUTDATA>
    </Row>
    <Row RowCount="20" MasterID="104" detail="血液">
      <INPUTDATA SeqNo="1">dataset:-317116.abo</INPUTDATA>
      <INPUTDATA SeqNo="2">dataset:-317116.rh</INPUTDATA>
    </Row>
    <Row RowCount="21" MasterID="105" detail="透析困難コメント">
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-421">dataset:-421.e01</INPUTDATA>
    </Row>
    <Row RowCount="22" MasterID="124" detail="SOAP"/>
    -- FAQ(No74回答待ち)
    <Row RowCount="23" MasterID="125" detail="看護メモ">
      -- FAQ(No74回答待ち)
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317122">dataset:-317122.e01</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317122">dataset:-317122.up_date</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317122">dataset:-317122.reg_staff_name</INPUTDATA>
    </Row>
    <Row RowCount="24" MasterID="126" detail="問診記録">
      -- FAQ(No74回答待ち)
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317123">dataset:-317123.e01</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317123">dataset:-317123.up_date</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317123">dataset:-317123.reg_staff_name</INPUTDATA>
    </Row>
    <Row RowCount="25" MasterID="122" detail="Ｄｒ">
    ...
    <Row RowCount="26" MasterID="123" detail="担当Ｎｓ">
    ...
    <Row RowCount="27" MasterID="110" detail="体重管理">
    ...
    <Row RowCount="28" MasterID="111" detail="除水">
    ...
    <Row RowCount="29" MasterID="112" detail="前・脈・血圧">
    ...
    <Row RowCount="30" MasterID="113" detail="後・脈・血圧">
    ...
    <Row RowCount="31" MasterID="114" detail="抗凝固剤">
...
VALUES(-4170002, 'P_hosp', 'karte_ord', '', 'S', 'upd', 'xml', 'カルテ記載(透析経過データ連携)', 'medicom', 'Medicomのカルテ記載(透析経過データ連携)', '1', '<MCSSData ver="Ver.03.02 2010-01-20">
  ...
  <Content>
    ...
    <Row RowCount="22" MasterID="124" detail="SOAP"></Row>-- FAQ(No74回答待ち)
    <Row RowCount="23" MasterID="125" detail="看護メモ">-- FAQ(No74回答待ち)
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317122">dataset:-317122.e01</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317122">dataset:-317122.up_date</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317122">dataset:-317122.reg_staff_name</INPUTDATA>
    </Row>
    <Row RowCount="24" MasterID="126" detail="問診記録">-- FAQ(No74回答待ち)
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317123">dataset:-317123.e01</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317123">dataset:-317123.up_date</INPUTDATA>
      <INPUTDATA SeqNo="$COUNT" _sqlCode="-317123">dataset:-317123.reg_staff_name</INPUTDATA>
    </Row>
...
</MCSSData>', '{"dataset": [{"key0": "key0", "ordNo": "ordNo", "sqlCode": -11, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -14}, {"patId": "patId", "sqlCode": -417}, {"patId": "patId", "sqlCode": -418}, {"patId": "patId", "sqlCode": -421}, {"ordNo": "ordNo", "sqlCode": -426}, {"ordNo": "ordNo", "sqlCode": -427}, {"patId": "patId", "sqlCode": -317102}, {"ordNo": "ordNo", "sqlCode": -317104, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -317105}, {"ordNo": "ordNo", "sqlCode": -317107}, {"ordNo": "ordNo", "sqlCode": -317108}, {"ctlNo": "ctlNo", "ordNo": "ordNo", "patId": "patId", "sqlCode": -317111, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -317112, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -317113, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -317114, "facilityCd": "facilityCd"}, {"patId": "patId", "sqlCode": -317115}, {"sqlCode": -317116, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -317118, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -317120, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -317121, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -317122, "facilityCd": "facilityCd"}, {"ordNo": "ordNo", "sqlCode": -317123, "facilityCd": "facilityCd"}, {"sqlCode": -317124, "facilityCd": "facilityCd"}, {"sqlCode": -317019, "is_zero_end": "true"}, {"patId": "patId", "sqlCode": -317141, "facilityCd": "facilityCd", "is_zero_end": "true"}], "dumpFileName": {"sqlCode": -317106, "facilityCd": "facilityCd"}}'::jsonb, '1', '0', -1, '2020-03-31 14:33:42.641', CURRENT_TIMESTAMP, '');
...
VALUES(-4090002, 'P_hosp', 'exam_rst', '', 'R', '検査結果', 'text', 'パナソニック 検査結果', 'Medicom', '検査結果受信（新版）', '1', '<root name="検査結果（新版）" multi="true:CRLF/LFCR/CR/LF">
    ...
    <item  name="空白" len="2" type="string"/>
</root>', '{}'::jsonb, '1', '0', -1, '2020-05-26 11:07:45.331', CURRENT_TIMESTAMP, '');



INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-4070001, 'P_hosp', 'rst_dial', '', 'S', 'cre', 'xml', 'パナソニック 透析実績(処方薬剤連携)', 'Medicom', '透析実績(処方薬剤連携)', '1', '<Consultation_Datas S_Version="1.00">
    <SystemInfo>
    ...
    <Consultation_Data>
        ...
        <Consultation>
            <Basic_Info Consultation_DataID="$JOURNAL.coop_ord_no">
                ...
                <Consultation_Doctor DoctorID="dataset:-307002.staff_cd">dataset:-307003.staff_name</Consultation_Doctor>
            ...
            <Order_Info>
                <Order_Category Category="投薬">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="内服"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="medicine" _sqlCode="-307008">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="頓服"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="medicine" _sqlCode="-307010">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="外用"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="medicine" _sqlCode="-307012">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="自己注射"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="medicine" _sqlCode="-307014">
                    </Order_Units>
                </Order_Category>
                <Order_Category Category="注射">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="静注"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="injection" _sqlCode="-307016">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="筋注"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="injection" _sqlCode="-307018">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="皮内注"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="injection" _sqlCode="-307020">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="皮下注"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="injection" _sqlCode="-307022">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="点滴"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="injection" _sqlCode="-307024">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id" Application="特注"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="injection" _sqlCode="-307026">
                    </Order_Units>
                </Order_Category>
                <Order_Category Category="処置">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307028">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307030">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307032">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307035">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307037">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307039">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307041">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307043">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307045">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307047">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307049">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307051">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307053">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307055">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307057">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307059">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307061">
                    </Order_Units>
                </Order_Category>
                <Order_Category Category="処置">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        ...
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307063">
                    </Order_Units>
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307065">
                    </Order_Units>
                </Order_Category>
                <Order_Category Category="夜間・休日加算カテゴリ">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                ...
                <Order_Category Category="処置">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="処置"
                        ...
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307067">
                    </Order_Units>
                </Order_Category>
                <Order_Category Category="診察">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="診察"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307069">
                    </Order_Units>
                </Order_Category>
                <Order_Category Category="手術・麻酔">
                    <Order_Units Order_UnitsID="dataset:-307005.order_units_id  " Application="手術・麻酔"
                        InputUserCode="dataset:-307007.staff_cd"
                        InputUserName="dataset:-307007.staff_name"
                        InputTime="dataset:-459.rst_start_date"
                        LastUpdateTime="dataset:-459.up_date"
                        _detail="treatment" _sqlCode="-307071">
                    </Order_Units>
                </Order_Category>
                <Order_Category Category="検査" _detail="treatment" _sqlCode="-307073">
                </Order_Category>
            </Order_Info>
        </Consultation>
    </Consultation_Data>
</Consultation_Datas>', '{"dataset": [{"patId": "patId", "sqlCode": -300001}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -458}, {"ctlNo": "ctlNo", "ordNo": "ordNo", "sqlCode": -459}, {"ordNo": "ordNo", "sqlCode": -460}, {"ordNo": "ordNo", "sqlCode": -461}, {"ordNo": "ordNo", "sqlCode": -462}, {"ordNo": "ordNo", "sqlCode": -463}, {"ordNo": "ordNo", "sqlCode": -464}, {"ordNo": "ordNo", "sqlCode": -465}, {"ordNo": "ordNo", "sqlCode": -466}, {"ordNo": "ordNo", "sqlCode": -467}, {"ordNo": "ordNo", "sqlCode": -468}, {"ordNo": "ordNo", "sqlCode": -469}, {"ordNo": "ordNo", "sqlCode": -470}, {"ordNo": "ordNo", "sqlCode": -471}, {"ordNo": "ordNo", "sqlCode": -472}, {"ordNo": "ordNo", "sqlCode": -473}, {"ordNo": "ordNo", "sqlCode": -474}, {"ordNo": "ordNo", "sqlCode": -475}, {"ordNo": "ordNo", "sqlCode": -476}, {"ordNo": "ordNo", "sqlCode": -477}, {"ordNo": "ordNo", "sqlCode": -478}, {"ordNo": "ordNo", "sqlCode": -479}, {"ordNo": "ordNo", "sqlCode": -480}, {"ordNo": "ordNo", "sqlCode": -481}, {"ordNo": "ordNo", "sqlCode": -482}, {"ordNo": "ordNo", "sqlCode": -483}, {"ordNo": "ordNo", "sqlCode": -484}, {"ordNo": "ordNo", "sqlCode": -485}, {"ordNo": "ordNo", "sqlCode": -486}, {"ordNo": "ordNo", "sqlCode": -487}, {"ordNo": "ordNo", "sqlCode": -488}, {"ordNo": "ordNo", "sqlCode": -489}, {"ordNo": "ordNo", "sqlCode": -490}, {"ordNo": "ordNo", "sqlCode": -491}, {"ordNo": "ordNo", "sqlCode": -492}, {"ordNo": "ordNo", "sqlCode": -493}, {"ordNo": "ordNo", "sqlCode": -307001}, {"ordNo": "ordNo", "sqlCode": -307004}, {"ordNo": "ordNo", "patId": "patId", "sqlCode": -307005}, {"sqlCode": -307008}, {"ordNo": "ordNo", "sqlCode": -307009}, {"sqlCode": -307010}, {"ordNo": "ordNo", "sqlCode": -307011}, {"sqlCode": -307012}, {"ordNo": "ordNo", "sqlCode": -307013}, {"sqlCode": -307014}, {"ordNo": "ordNo", "sqlCode": -307015}, {"sqlCode": -307016}, {"ordNo": "ordNo", "sqlCode": -307017}, {"sqlCode": -307018}, {"ordNo": "ordNo", "sqlCode": -307019}, {"sqlCode": -307020}, {"ordNo": "ordNo", "sqlCode": -307021}, {"sqlCode": -307022}, {"ordNo": "ordNo", "sqlCode": -307023}, {"sqlCode": -307024}, {"ordNo": "ordNo", "sqlCode": -307025}, {"sqlCode": -307026}, {"ordNo": "ordNo", "sqlCode": -307027}, {"sqlCode": -307028}, {"ordNo": "ordNo", "sqlCode": -307029}, {"sqlCode": -307030}, {"ordNo": "ordNo", "sqlCode": -307031}, {"sqlCode": -307032}, {"patId": "patId", "sqlCode": -307033}, {"sqlCode": -307035}, {"ordNo": "ordNo", "sqlCode": -307036}, {"sqlCode": -307037}, {"ordNo": "ordNo", "sqlCode": -307038}, {"sqlCode": -307039}, {"ordNo": "ordNo", "sqlCode": -307040}, {"sqlCode": -307041}, {"ordNo": "ordNo", "sqlCode": -307042}, {"sqlCode": -307043}, {"ordNo": "ordNo", "sqlCode": -307044}, {"sqlCode": -307045}, {"ordNo": "ordNo", "sqlCode": -307046}, {"sqlCode": -307047}, {"ordNo": "ordNo", "sqlCode": -307048}, {"sqlCode": -307049}, {"ordNo": "ordNo", "sqlCode": -307050}, {"sqlCode": -307051}, {"ordNo": "ordNo", "sqlCode": -307052}, {"sqlCode": -307053}, {"ordNo": "ordNo", "sqlCode": -307054}, {"sqlCode": -307055}, {"ordNo": "ordNo", "sqlCode": -307056}, {"sqlCode": -307057}, {"ordNo": "ordNo", "sqlCode": -307058}, {"sqlCode": -307059}, {"ordNo": "ordNo", "sqlCode": -307060}, {"sqlCode": -307061}, {"ordNo": "ordNo", "sqlCode": -307062}, {"sqlCode": -307063}, {"ordNo": "ordNo", "sqlCode": -307064}, {"sqlCode": -307065}, {"ordNo": "ordNo", "sqlCode": -307066}, {"sqlCode": -307067}, {"ordNo": "ordNo", "sqlCode": -307068}, {"sqlCode": -307069}, {"ordNo": "ordNo", "sqlCode": -307070}, {"sqlCode": -307071}, {"ordNo": "ordNo", "sqlCode": -307072}], "dumpFileName": {"ordNo": "ordNo", "patId": "patId", "sqlCode": -99997}}'::jsonb, '1', '0', -1, '2020-06-05 11:34:51.616', CURRENT_TIMESTAMP, '');


INSERT INTO ntss.mst_coop_layout
(ctl_no, facility_cd, coop_cd, coop_cd_index, direction, coop_cd_sub, coop_format, coop_name, coop_vender, description, is_editable, coop_setting, coop_ext_setting, is_disp, is_del, user_id, reg_date, up_date, coop_version)
VALUES(-4070004, 'P_hosp', 'rst_dial', '', 'S', 'upd', 'xml', 'パナソニック 透析実績(処方薬剤連携)', 'Medicom', '透析実績(処方薬剤連携)', '1', '<Consultation_Datas S_Version="1.00">
    <SystemInfo>
        <SystemName>FUTURENET</SystemName>
    </SystemInfo>
    <Consultation_Data>
