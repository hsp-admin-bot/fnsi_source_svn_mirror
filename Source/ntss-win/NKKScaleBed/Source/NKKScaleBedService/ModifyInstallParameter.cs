    ...
    public partial class ModifyInstallParameter : Form
    {
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                xmlDoc.Load(filePath + "NKKScaleBed.config");
                ...
                // アプリ番号
                TdcLib.TdcLib.SetXmlTagWithPath(ref xns, new Queue<string>(new[] { "ScaleBed", "WeightNo" }), txtWeightNo.Text);

                // バージョンアップ時刻
                TdcLib.TdcLib.SetXmlTagWithPath(ref xns, new Queue<string>(new[] { "ScaleBed", "UpdateTime" }),
                ...
                using (TextWriter tw = new StreamWriter(filePath + "NKKScaleBed.config", false, utf8WithoutBom))
                {
                    xmlDoc.Save(tw);
                }
