...
namespace NKK.FN3.Common.Library.TcpSocket
{
    ...
    public class BaseServerConnect : BaseConnect
    {
        ...
        /// <summary>
        /// BaseServerConnectクラスのコンストラクタ
        /// </summary>
        /// <remarks>
        /// BaseServerConnectクラスのインスタンスの作成を行う。
        /// </remarks>
        ...
        public bool StartListener()
        {
            ...
            if (m_svrPortNo != -1)
            {
                if (m_thread == null)
                {
                    ...
                    m_thread.Start();
                    ret = true;
                    // #11987 2026.1.20 mod ログコード削除 TDC石井 start
                    // TraceWrite("0640030011", "サーバー接続待ち開始");
                    
                    TraceWrite("サーバー接続待ち開始", System.Diagnostics.Process.GetCurrentProcess().ProcessName);
                    // #11987 2025.12.02 mod ログコード削除 TDC石井 end
                }
            }
        ...
        public void EndListener()
        {
            ...
            if (m_thread != null)
            {
                ...
                TraceWrite("サーバー接続待ち終了", System.Diagnostics.Process.GetCurrentProcess().ProcessName);
                // #11987 2025.12.02 mod ログコード削除 TDC石井 end
            }
        }
