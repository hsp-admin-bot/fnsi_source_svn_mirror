    ...
    public partial class ModifyInstallParameter : Form
    {
        ...
        private void GetConfig()
        {
            try
            {
                ...
                xmlDoc.Load(filePath + "NKKAccessCard.config");
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //TextWriter tw = new StreamWriter(filePath + "NKKAccessCard.config", false, utf8WithoutBom);
                using (TextWriter tw = new StreamWriter(filePath + "NKKAccessCard.config", false, utf8WithoutBom))
                {
                    xmlDoc.Save(tw);
                }
