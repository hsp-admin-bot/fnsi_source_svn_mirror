    ...
    public partial class ModifyInstallParameter : Form
    {
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                xmlDoc.Load(filePath + "NKKPrint.config");
                ...
                // アプリ番号
                TdcLib.TdcLib.SetXmlTagWithPath(ref xns, new Queue<string>(new[] { "Application", "AppNo" }), txtAppNo.Text);

                // バージョンアップ時刻
                TdcLib.TdcLib.SetXmlTagWithPath(ref xns, new Queue<string>(new[] { "Application", "UpdateTime" }),
                ...
                //TextWriter tw = new StreamWriter(filePath + "NKKPrint.config", false, utf8WithoutBom);
                using (TextWriter tw = new StreamWriter(filePath + "NKKPrint.config", false, utf8WithoutBom))
                {
                    xmlDoc.Save(tw);
                }
